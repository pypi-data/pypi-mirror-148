...
class AlvinAirflowLineageBackendComposer(AlvinAirflowLineageBackend):
    ...
    def copy_alvin_plugin(self):
        ...
        print(f'Plugin copied successfully to: {GOOGLE_COMPOSER_BUCKET}/plugins/alvin_plugin.py')

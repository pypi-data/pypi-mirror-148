...
class Mdif():
    ...
    def to_mdif(self, networkset: NetworkSet, output_file: str,
                values=None, datatypes=None, comments=[]):
        """
        Convert a NetworkSet to an Generated MDIF file.
        ...
        networkset : NetworkSet
            NetworkSet object to convert into a .mdif file.
        output_file : str
            MDIF file path
        values : TYPE, optional
            DESCRIPTION. The default is None.
        datatypes : TYPE, optional
            DESCRIPTION. The default is None.
        comments : list, optional
            Comments to store in the file. The default is [].
    ...
    def __create_optionstring(self, nports):
        """
        Generate the string

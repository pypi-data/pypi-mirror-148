...
class AMLBlueprint(Blueprint):
    ...
    swagger2 = False
    swagger3 = False
    swagger2_spec_path = os.path.join(AML_APP_ROOT, "swagger2.json")
    swagger3_spec_path = os.path.join(AML_APP_ROOT, "swagger3.json")
    ...
    def _init_headers_generator(self, app):
        try:
            self.logger.info("Starting up request id generator")
            app.wsgi_app = HeadersWrapper(app.wsgi_app)
        except:
            self.logger.error(
    ...
    def register(self, app, options, first_registration=False):
        ...
        self._init_headers_generator(app)

    ...
    """
{
    ...
    "package_data": {
        "certbot._jsii": [
            "cdk-library-certbot@1.1.78.jsii.tgz"
        ],
        "certbot": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-events-targets>=1.154.0, <2.0.0",
        "aws-cdk.aws-events>=1.154.0, <2.0.0",
        "aws-cdk.aws-iam>=1.154.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.154.0, <2.0.0",
        "aws-cdk.aws-route53>=1.154.0, <2.0.0",
        "aws-cdk.aws-s3>=1.154.0, <2.0.0",
        "aws-cdk.aws-sns-subscriptions>=1.154.0, <2.0.0",
        "aws-cdk.aws-sns>=1.154.0, <2.0.0",
        "aws-cdk.core>=1.154.0, <2.0.0",

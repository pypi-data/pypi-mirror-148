...
class UavsarCollection():
    ...
    Args:
        ...
        clean (bool): Do you want to erase binary files after completion [Default = True]
    ...
    def __init__(self, collection, work_dir, overwrite = False, clean = False, debug = False, pols = None, dates = None, low_ram = True):
    ...
    def results_to_tiffs(self):
        for result in self.results:
            ...
            scene.url_to_tiffs()
            d1 = result.properties['startTime']
            d2 = result.properties['stopTime']

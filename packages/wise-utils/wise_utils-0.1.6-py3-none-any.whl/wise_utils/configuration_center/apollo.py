...
class ApolloClient(object):
    ...
    def __init__(self, config_url, app_id, cluster='default', secret='', change_listener=None, log_file_path=None):
        self.logger = get_logger(name=__name__, path=log_file_path, log_level=logging.ERROR)

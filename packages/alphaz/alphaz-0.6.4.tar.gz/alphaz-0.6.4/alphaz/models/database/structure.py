...
def default_return(results, default=None, columns:dict=None):
...
class AlphaDatabase(AlphaDatabaseCore):
    ...
    def select_query(
        ...
        if count:
            ...
            return default_return(results, default=default, columns=columns)
        ...
        if not json:
            ...
            return default_return(results if page is None else (results, full_count), default=default, columns=columns)
        ...
        return default_return(results_json if page is None else (results_json, full_count), default=default, columns=columns)

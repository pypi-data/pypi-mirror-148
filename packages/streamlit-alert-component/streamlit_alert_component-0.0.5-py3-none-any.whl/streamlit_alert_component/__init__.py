...
def streamlit_alert(message, severity="info", title=None, variant="standard", snackbar=False, is_first_snackbar=False, padding_from_top=500):
...
streamlit_pagination
    ...
    component_value = _component_func(message=message, severity=severity, title=title, variant=variant, snackbar=snackbar,is_first_snackbar=is_first_snackbar,  padding_from_top=padding_from_top)
...
if not _RELEASE:
    ...
    with st.sidebar:
        ...
        streamlit_alert("This is an error alert", "error", variant="filled", snackbar=True, is_first_snackbar=True, padding_from_top=100)
        streamlit_alert("This is an error alert", "success", variant="outlined", snackbar=True, is_first_snackbar=False)

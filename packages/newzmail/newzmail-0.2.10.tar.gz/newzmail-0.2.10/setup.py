...
setup(
    ...
    author='kwong',
    author_email='jiangyanhao1991@gmail.com',

    description='Zmail makes it easier to send and retrieve emails in python3.Forked from hangyunhao116/zmail',
    ...
    url='https://github.com/CoderKwong/zmail',
    license="MIT Licence",

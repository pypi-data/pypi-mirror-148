...
class FWv4BaseDataSource(BaseDataSource):
    @property
...
class BatchDataSource(FWv4BaseDataSource):
    """
...
class StreamDataSource(FWv4BaseDataSource):
    """
        ...
        *,
        ...
        .. code-block:: python
         ...
         import pyspark
            ...
            # Declare a StreamDataSource with both a batch_config and a stream_config as parameters
...
def prepare_ds_args(
    *,
    ...
    batch_config: BaseBatchDSConfig,

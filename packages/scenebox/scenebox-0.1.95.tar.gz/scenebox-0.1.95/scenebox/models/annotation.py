...
class Connection:
    """
    Used in the context of pose annotations only.
    Used to identify the indices of the starting and ending points of a connection
    in the keypoints list.
    """
    start_index: int
    end_index: int
    confidence: Optional[float] = None
...
class AnnotationEntity(object):
    ...
    def __init__(self,
        ...
        """ initialize an annotation object (a single annotation such as tire,
            ...
            -----------
            keypoints:
                A list of Point objects. Used to define key points of interest under one
                composition.
            connections:
                A list of Connection objects. Used to define directed connections
                between points in the keypoints list.
        """
        # annotation label
        self.label = label

...
class GetUserSamlResult:
    ...
    """
    def __init__(__self__, adfs_claim=None, cert=None, clock_tolerance=None, digest_method=None, entity_id=None, group_claim_type=None, group_name=None, id=None, idp_cert=None, idp_entity_id=None, idp_single_logout_url=None, idp_single_sign_on_url=None, limit_relaystate=None, name=None, single_logout_url=None, single_sign_on_url=None, user_claim_type=None, user_name=None, vdomparam=None):

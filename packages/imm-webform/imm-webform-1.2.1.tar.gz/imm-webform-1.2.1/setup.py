...
setup(
    ...
    install_requires=["imm-case-model", "imm-source"],
    # Here are the keywords of my library.
    keywords="Canada, Immigration,Case, Programs, APIs, web,form,programtically filling",
    ...
    entry_points={"console_scripts": ["prd=webform.prdata:main"]},
)

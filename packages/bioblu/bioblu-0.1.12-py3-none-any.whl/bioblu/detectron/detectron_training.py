...
if __name__ == "__main__":
    ...
    ds_convert.cvt_yolo_to_detectron(yolo_ds_root_dir, bioblu_dir, materials_dict)

    img_dir_train: str = os.path.join(bioblu_dir, "coco", "train2017")
    img_dir_valid: str = os.path.join(bioblu_dir, "coco", "val2017")
    # img_dir_test: str = os.path.join(bioblu_dir, "test2017")

    # Extract image dict lists from jsons
    fpath_json_train = os.path.join(bioblu_dir, "annotations", "instances_train2017.json")
    fpath_json_valid = os.path.join(bioblu_dir, "annotations", "instances_val2017.json")
    fpath_json_test = os.path.join(bioblu_dir, "annotations", "instances_test2017.json")

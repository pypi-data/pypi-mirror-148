...
if __name__ == "__main__":
    ...
    coco_dir = os.path.join(bioblu_dir, "coco")

    ds_convert.cvt_yolo_to_detectron(yolo_ds_root_dir, coco_dir, materials_dict)

    img_dir_train: str = os.path.join(coco_dir, "train2017")
    img_dir_valid: str = os.path.join(coco_dir, "val2017")

    # Extract image dict lists from jsons
    fpath_json_train = os.path.join(coco_dir, "annotations", "instances_train2017.json")
    fpath_json_valid = os.path.join(coco_dir, "annotations", "instances_val2017.json")
    fpath_json_test = os.path.join(coco_dir, "annotations", "instances_test2017.json")

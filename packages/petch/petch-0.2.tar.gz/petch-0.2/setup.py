...
setup(
  ...
  download_url = 'https://github.com/PetchGit/petch/archive/refs/tags/v_02.tar.gz',    # I explain this later on
  keywords = ['Functional Programming', 'Shortcuts', 'Logging'],   # Keywords that define your package best

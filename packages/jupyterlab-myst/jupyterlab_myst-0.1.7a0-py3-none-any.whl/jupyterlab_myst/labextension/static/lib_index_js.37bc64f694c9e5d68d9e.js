...
/* harmony import */ var _agoose77_jupyterlab_markup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @agoose77/jupyterlab-markup */ "webpack/sharing/consume/default/@agoose77/jupyterlab-markup");
/* harmony import */ var _agoose77_jupyterlab_markup__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_agoose77_jupyterlab_markup__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var katex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! katex */ "webpack/sharing/consume/default/katex/katex");
...
function wrapDocutilsPlugin(docutilsPlugin) {
    return function (md, options) {
        ...
        md.renderer.rules["math_block"] = (tokens, idx) => {
            ...
            const rendered = katex__WEBPACK_IMPORTED_MODULE_1___default().renderToString(content, {
                displayMode: true,
                throwOnError: false,
 ...
 */
const docutils = (0,_agoose77_jupyterlab_markup__WEBPACK_IMPORTED_MODULE_0__.simpleMarkdownItPlugin)(_tokens__WEBPACK_IMPORTED_MODULE_2__.PACKAGE_NS, {
...
const mystExtras = (0,_agoose77_jupyterlab_markup__WEBPACK_IMPORTED_MODULE_0__.simpleMarkdownItPlugin)(_tokens__WEBPACK_IMPORTED_MODULE_1__.PACKAGE_NS, {
    ...
    plugin: async () => {
        const mystExtrasPlugins = await __webpack_require__.e(/*! import() | markdown-it-myst-extras */ "markdown-it-myst-extras").then(__webpack_require__.t.bind(__webpack_require__, /*! markdown-it-myst-extras */ "webpack/sharing/consume/default/markdown-it-myst-extras/markdown-it-myst-extras", 23));
        function plugin(md, options) {
...
//# sourceMappingURL=lib_index_js.37bc64f694c9e5d68d9e.js.map
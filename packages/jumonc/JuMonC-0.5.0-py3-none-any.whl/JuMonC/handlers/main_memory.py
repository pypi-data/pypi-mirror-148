...
def registerStatusLinks(version: int) -> Dict[str, Union[bool, str, List[Dict[str, str]]]]:
    ...
    if pluginInformation.memory_is_working:
        ...
        def returnMemoryStatus(version: int, datatype:str) -> Response:
            ...
            cache_id = cache.add_cache_entry("/v" + str(version) + "/main_memory/status/" + datatype)
            if duration >0:

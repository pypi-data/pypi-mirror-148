...
class ConfigurationWrapper:
    ...
    def _get_all_endpoints_by(self,
        ...
        self.__debug_message(f'_get_all_endpoints_by: BEGIN')

        self.__debug_message(f'_get_all_endpoints_by: FROM: {self.endpoints}')

        self.__debug_message(f'_get_all_endpoints_by: FILTER: adapter_type => {adapter_type}')
        self.__debug_message(f'_get_all_endpoints_by: FILTER: service_types => {service_types}')
        self.__debug_message(f'_get_all_endpoints_by: FILTER: endpoint_id => {endpoint_id}')

        endpoints = []

        for endpoint in self.endpoints:
            self.__debug_message(f'_get_all_endpoints_by: E/{endpoint.id}: {endpoint}')
        ...
        self.__debug_message(f'_get_all_endpoints_by: EXIT with {endpoints}')
    ...
    def get_endpoint(self,
        ...
        self.__debug_message(f'get_endpoint: BEGIN')
        self.__debug_message(f'get_endpoint: adapter_type => {adapter_type}')
        self.__debug_message(f'get_endpoint: service_types => {service_types}')
        self.__debug_message(f'get_endpoint: endpoint_id => {endpoint_id}')
        ...
        if endpoint is None:
            if create_if_missing:
                self.__debug_message(f'get_endpoint: Creating a missing (default) endpoint...')
                ...
                self.__debug_message(f'get_endpoint: ERROR')
                raise MissingEndpointError(f'The "{adapter_type}" endpoint #{endpoint_id or "?"} is not defined.')

        self.__debug_message(f'get_endpoint: EXIT with endpoint => {endpoint}')
        return endpoint

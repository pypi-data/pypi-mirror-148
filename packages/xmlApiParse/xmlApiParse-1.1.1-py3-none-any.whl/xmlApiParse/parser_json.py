...
from xmlApiParse.repository import (
    ...
    MenuDTO, MenuItemsDTO, EmployeeDTO
)
...
class RKXMLRequest(XMLRequest):
    ...
    def send_request(self, body: str = None):
        if self.chech_connection() is True:
            try:
        ...
        try:
            ...
            for employee in parsed_employees_list:
                ...
                if name_filter is None:
                    ...
                    employee_dto = EmployeeDTO(name=name, altname=altname, gen_san_date=gen_san_date,
                                            gen_tax_payer_id_num=gen_tax_payer_id_num, ident=ident)

...
if 'milestone_3_p2.txt' in os.listdir('.'):
    ...
    if ('test_computer_choice_presence' in errors) or ('test_user_choice_presence' in errors) or ('test_user_choice_input' in errors) or ('test_ask_while' in errors):
        ...
        if 'test_ask_while' in errors:
            print(errors['test_ask_while'])

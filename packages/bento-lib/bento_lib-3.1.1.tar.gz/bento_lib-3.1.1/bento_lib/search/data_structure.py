...
from operator import and_, or_, lt, le, eq, gt, ge, contains, is_not
...
def _is_null(args: q.Args, *rest) -> bool:
    """
    Returns whether an expression is None.
    :param args: Arguments (should be a single expression) for the #is_null function.
    :return: Whether the evaluated single argument is None.
    """
    return evaluate_no_validate(args[0], *rest) is None
...
QUERY_CHECK_SWITCH: Dict[
    ...
    q.FUNCTION_NOT: lambda args, *rest: not evaluate_no_validate(args[0], *rest),

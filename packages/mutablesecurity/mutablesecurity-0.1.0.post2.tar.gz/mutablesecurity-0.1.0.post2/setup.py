...
package_data = \
{'': ['*'], 'mutablesecurity.modules.solutions_manager': ['files/*']}
...
setup_kwargs = {
    ...
    'version': '0.1.0.post2',
    'description': 'Seamlessly management of cybersecurity solutions',
    ...
    'author_email': 'hello@mutablesecurity.ro',
    'maintainer': None,
    'maintainer_email': None,
    'url': 'https://www.mutablesecurity.ro',
    'packages': packages,

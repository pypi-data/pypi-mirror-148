...
class QuantumMachine(object):
    ...
    def get_digital_delay(self, element, digital_input):
        """
        Gets the delay of the digital input of the quantum element
    ...
    def set_digital_delay(self, element, digital_input, delay):
        """
        Sets the delay of the digital input of the quantum element
    ...
    def get_digital_buffer(self, element, digital_input):
        """
        Gets the buffer for digital input of the quantum element
    ...
    def set_digital_buffer(self, element, digital_input, buffer):
        """
        Sets the buffer for digital input of the quantum element
    ...
    def get_time_of_flight(self, element):
        """
        Gets the *time of flight*, associated with a measurement quantum element.
    ...
    def get_smearing(self, element):
        """
        Gets the *smearing* associated with a measurement quantum element.

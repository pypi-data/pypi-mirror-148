...
from bigeye_sdk.generated.com.torodata.models.generated import TimeIntervalType, TimeInterval, MetricParameter, \
    MetricConfiguration, LookbackType, Threshold
...
class SimpleMetricTemplate:
    ...
    def build_upsert_request_object(self,
                                    warehouse_id: int,
                                    table: dict,  # TODO: Consider ways to switch to Table object or other object.
        ...
        metric_time_exists = table_has_metric_time(table)

        ifm = is_freshness_metric(self.metric_name)

        if ifm:
            # Enforce correct metric name for field type.
            new_metric.metric_type = get_freshness_metric_name_for_field(table, column_name)

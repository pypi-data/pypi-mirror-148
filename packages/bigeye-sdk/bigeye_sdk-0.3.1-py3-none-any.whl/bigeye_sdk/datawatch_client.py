...
class DatawatchClient(abc.ABC):
    ...
    def get_table_ids(self,
        ...
        return [t.id for t in self.get_tables(warehouse_id, schemas, table_name, ids, schema_id).tables]
    ...
    def get_existing_metric(self,
                            warehouse_id: int, table: dict, column_name: str,
        ...
        """
        metrics = self.search_metric_configuration(warehouse_ids=[warehouse_id], table_ids=table.get("id"))
    ...
    def run_a_delta(self, delta_id: int):

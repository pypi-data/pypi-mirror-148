...
class ABCClassificationModel(ABCTaskModel, ABC):
    ...
    def compile_model(self,
        ...
        Examples:
            ...
            optimizer='rsm', metrics = ['accuracy'])
        ...
        with langma.utils.custom_object_scope():
            ...
            if self.multi_label:
                ...
                res = multi_label_binarizer.inverse_transform(
                    pred, threshold=multi_label_threshold, keep_prob=keep_prob)
            else:
                lengths = [len(sen) for sen in x_data]
                res = self.label_processor.inverse_transform(
                    pred, lengths=lengths, keep_prob=keep_prob)

...
datafilename = """{
	'username'	 : 'root',
	'password'	 : '',
	'api_key' 	 : '5b50f623ddc14b6c91573722222404',
	'development': 0,
	'google'  	 : [""],
	'bing'    	 : [""],
	'duck'    	 : [""],
	'yahoo'		 : ["ol .searchCenterMiddle", "h3 .title", ".compText"]
}
"""
...
if os.path.isfile(file_names):
	...
	with open(file_names, 'w+', encoding='utf8') as fp:
		fp.write(datafilename)
try:
	from NetMet.myipfakes import ClassA as IPCall_A, ClassB as IPCall_B, Topologhy
	from NetMet.encrypt import Encrypt
	#from NetMet.requests_html.requests_html import *
	from NetMet.requests_html import from_Google as Google, from_Yahoo as Yahoo, from_Bing as Bing, from_Duck as Duckduckgo, Remove_tags_js_css as Remove_tags, header as select_header
	...
	try:
		from .myipfakes import ClassA as IPCall_A, ClassB as IPCall_B, Topologhy
		from .encrypt import Encrypt
		#from .requests_html.requests_html import *
		from .requests_html import from_Google as Google, from_Yahoo as Yahoo, from_Bing as Bing, from_Duck as Duckduckgo, Remove_tags_js_css as Remove_tags, header as select_header

...
class Raster(tu.titan.Titan):
    ...
    def merge_rasters(self, remove_source_images=False):
        """
        ...
        if len(source_paths) > 0:
            tu.data_io.gdal_merge(source_paths, merged_raster)
        else:
            _ = tu.data_io.copy_file(source_paths[0], merged_raster)

...
from efsm.api_shell.core import Efsm, StateMeta
...
use this to create efsm:
efsm = StateMachine(start, end=None, on_end=None)

use this to create StateSet
StateSet(*keynames, fn=None, data=None)

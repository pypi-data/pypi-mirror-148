...
class StateRequest(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'chaos': {'type': 'StateRequestChaos'},
    } # type: Dict[str, str]
    ...
    @property
    def chaos(self):
        # type: () -> StateRequestChaos
        """chaos getter

        

        Returns: StateRequestChaos
        """
        return self._get_property('chaos', StateRequestChaos)


class StateRequestChaos(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'drop_frames': {'type': 'StateRequestChaosDropFrames'},
        'background_traffic': {'type': 'StateRequestChaosBackgroundTraffic'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None):
        super(StateRequestChaos, self).__init__()
        self._parent = parent

    @property
    def drop_frames(self):
        # type: () -> StateRequestChaosDropFrames
        """drop_frames getter

        

        Returns: StateRequestChaosDropFrames
        """
        return self._get_property('drop_frames', StateRequestChaosDropFrames)

    @property
    def background_traffic(self):
        # type: () -> StateRequestChaosBackgroundTraffic
        """background_traffic getter

        

        Returns: StateRequestChaosBackgroundTraffic
        """
        return self._get_property('background_traffic', StateRequestChaosBackgroundTraffic)


class StateRequestChaosDropFrames(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, config_names=None, state=None):
        super(StateRequestChaosDropFrames, self).__init__()
        self._parent = parent
    ...
    def config_names(self):
        ...
        The names of the drop frams configs to which the transmit state will be applied to. If the list is empty or null the state will be applied to all drop frames entries.. . x-constraint:. - ../chaos/chaos.yaml/components/schemas/DropFrames/properties/name. 
...
class StateRequestChaosBackgroundTraffic(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, flow_names=None, state=None):
        super(StateRequestChaosBackgroundTraffic, self).__init__()
        self._parent = parent
    ...
    def flow_names(self):
        ...
        The names of flows to which the transmit state will be applied to. If the list of flow_names is empty or null the state will be applied to all configured flows.. . x-constraint:. - ../chaos/background_traffic.yaml/components/schemas/Flow/properties/name. 
...
class StateResponse(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'chaos': {'type': 'StateResponseChaos'},
    } # type: Dict[str, str]
    ...
    @property
    def chaos(self):
        # type: () -> StateResponseChaos
        """chaos getter

        

        Returns: StateResponseChaos
        """
        return self._get_property('chaos', StateResponseChaos)


class StateResponseChaos(OpenApiObject):
    __slots__ = ('_parent')

    _TYPES = {
        'drop_frames': {'type': 'StateResponseChaosDropFrames'},
        'background_traffic': {'type': 'StateResponseChaosBackgroundTraffic'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None):
        super(StateResponseChaos, self).__init__()
        self._parent = parent

    @property
    def drop_frames(self):
        # type: () -> StateResponseChaosDropFrames
        """drop_frames getter

        

        Returns: StateResponseChaosDropFrames
        """
        return self._get_property('drop_frames', StateResponseChaosDropFrames)

    @property
    def background_traffic(self):
        # type: () -> StateResponseChaosBackgroundTraffic
        """background_traffic getter

        

        Returns: StateResponseChaosBackgroundTraffic
        """
        return self._get_property('background_traffic', StateResponseChaosBackgroundTraffic)


class StateResponseChaosDropFrames(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, started=None, stopped=None):
        super(StateResponseChaosDropFrames, self).__init__()
        self._parent = parent
        self._set_property('started', started)
        self._set_property('stopped', stopped)
    ...
    def started(self):
        ...
        The names of the started drop frames experiments.. . x-constraint:. - ../chaos/chaos.yaml/components/schemas/DropFrames/properties/name. 
    ...
    def started(self, value):
        ...
        value: List[str]
        """
        self._set_property('started', value)
    ...
    def stopped(self):
        ...
        The names of the stopped drop frames experiments.. . x-constraint:. - ../chaos/chaos.yaml/components/schemas/DropFrames/properties/name. 

        Returns: List[str]
        """
        return self._get_property('stopped')
    ...
    def stopped(self, value):
        ...
        value: List[str]
        """
        self._set_property('stopped', value)


class StateResponseChaosBackgroundTraffic(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None, started=None, stopped=None):
        super(StateResponseChaosBackgroundTraffic, self).__init__()
        self._parent = parent
        self._set_property('started', started)
        self._set_property('stopped', stopped)
    ...
    def started(self):
        ...
        The names of the started flows.. . x-constraint:. - ../chaos/background_traffic.yaml/components/schemas/Flow/properties/name. 
    ...
    def stopped(self):
        ...
        The names of the stopped flows.. . x-constraint:. - ../chaos/background_traffic.yaml/components/schemas/Flow/properties/name. 
...
class Api(object):
    ...
    def staterequest(self):
        """Factory method that creates an instance of StateRequest

        Return: StateRequest
        """
        return StateRequest()

    def stateresponse(self):
        """Factory method that creates an instance of StateResponse
...
class HttpApi(Api):
    ...
    def get_state(self):
        ...
        return self._transport.send_recv(
            ...
            "/onex/api/v1/fabric/state",
            payload=None,
            return_object=self.stateresponse(),
        )

...
from nawah.utils import call, test_call_arg


async def _auth(env, doc, args):
    ...
    if not test_call_arg(args=args, arg='skip_status_check', value=True):

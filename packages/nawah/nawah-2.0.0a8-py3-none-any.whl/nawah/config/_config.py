...
class Config:
    ...
    user_attrs: MutableMapping[str, 'Attr'] = {}
    user_settings: MutableMapping[str, 'UserSetting'] = {}
    user_doc_settings: MutableSequence[str] = []
    ...
    gateways: MutableMapping[str, Callable] = {}

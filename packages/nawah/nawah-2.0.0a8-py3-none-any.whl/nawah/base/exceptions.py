...
class UtilityModuleDataCallException(Exception):
    ...
    def format_msg(*, module_name, func_name):
        ...
        return f'Nawah Function \'{func_name}\' can\'t be called on Nawah Utility module \'{module_name}\''
...
class FailedDeleteLockException(Exception):
    '''Raised if 'obtain_lock' call failed to deleted obtaiend lock'''
    ...
    def format_msg(*, module_name, lock_id):
        ...
        return f'Failed to delete failed lock \'{lock_id}\' for \'{module_name}\'. Delete manually now'
...
class UpdateMultiUniqueException(Exception):
    ...
    def format_msg():
        ...
        return 'Update call query has more than one doc as results. This would result in duplication'

    ...
    *,
    ...
    if attr_type.type == AttrType.ANY:
        ...
        if type(attr_val) == dict:
            # [TODO] Find approach to enable following import
        ...
        try:
            ...
            file_type_check = (
                ...
                and isinstance(attr_val['name'], str)
                and isinstance(attr_val['type'], str)
                and isinstance(attr_val['lastModified'], int)
                and isinstance(attr_val['size'], int)
                and isinstance(attr_val['content'], (binary.Binary, bytes))
            )

...
def filter_dict_to_vue(filter_dict):
    ...
    with open(os.path.join(current_path, 'vue', 'templates', 'list_filter_template.vue'), 'r', encoding='utf-8') as f:
...
def ser_dict_to_vue(table_name, ser_dict):
    ...
    with open(os.path.join(current_path, 'vue', 'templates', 'detail_template.vue'), 'r', encoding='utf-8') as f:

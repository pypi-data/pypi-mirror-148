...
from tensorflow_probability.substrates.numpy.experimental.distributions import MultivariateNormalPrecisionFactorLinearOperator
...
#   `tensorflow_probability/substrates/numpy/experimental/sts_gibbs/spike_and_slab.py`

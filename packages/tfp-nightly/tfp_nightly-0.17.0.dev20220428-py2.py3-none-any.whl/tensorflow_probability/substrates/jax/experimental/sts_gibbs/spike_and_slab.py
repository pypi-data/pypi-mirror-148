...
from tensorflow_probability.substrates.jax.experimental.distributions import MultivariateNormalPrecisionFactorLinearOperator
...
#   `tensorflow_probability/substrates/jax/experimental/sts_gibbs/spike_and_slab.py`

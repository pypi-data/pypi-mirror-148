...
class HandlerRedis:
    def __init__(self, tag=None):
        if not tag:
            ...
            self.config = {
                'host': apollo_reader.get_value('redis.{tag}.host'),
                'port': int(apollo_reader.get_value('redis.{tag}.port')),
                'password': apollo_reader.get_value('redis.{tag}.password'),
                'db': apollo_reader.get_value('redis.{tag}.db'),
                'decode_responses': True,
            }

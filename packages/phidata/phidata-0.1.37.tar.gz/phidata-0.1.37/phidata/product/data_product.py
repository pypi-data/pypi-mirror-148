...
class DataProduct(PhidataBase):
    ...
    def create_airflow_dag(
        ...
        for workflow in self.workflows:
            workflow.add_start_task = self.add_start_task
            workflow.add_end_task = self.add_end_task
        ...
        # TODO:Update workflow dependencies
        # if self.graph is not None:
        #     # logger.info("Updating dependencies")
        #     for downstream_workflow, upstream_workflow_list in self.graph.items():
        #         logger.info(f"Workflow: {downstream_workflow.workflow_id}")
        #         downstream_workflow = airflow_workflows[downstream_workflow.workflow_id]
        #         upstream_airflow_workflow_list = [
        #             airflow_workflows[workflow.workflow_id] for workflow in upstream_workflow_list
        #         ]
        #         downstream_airflow_workflow.set_upstream(upstream_airflow_workflow_list)
        #         # logger.info(
        #         #     f"Upstream workflows: {downstream_airflow_workflow.upstream_task_ids}"
        #         # )

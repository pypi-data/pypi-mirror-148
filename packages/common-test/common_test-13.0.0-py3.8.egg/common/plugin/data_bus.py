...
class DataBus(object):
    ...
    @classmethod
    def get_data(cls, _template, data = None, _no_content = 0):
        """
        清洗字符串数据
        ...
        :return:
        """
        return DataProcess.handle_data_fromat(_template, data, _no_content)
    ...
    def run_info(cls):
        ...
        print_databus_info(Constant.ISSUE_KEY, "用例路径")

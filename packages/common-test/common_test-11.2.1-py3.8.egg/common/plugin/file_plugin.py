...
class FilePlugin(object):
    ...
    def excel_to_dict(self, file_name, sheet: str='Sheet1', _replace: bool=True, file_path: str=TEST_DATA_PATH,
                      _functionName=None, _suitName=None, _storyId=None, _title=None, _report: bool=True):
        """
    ...
    @classmethod
    def excel_to_list(cls, testData_path, sheet_name: str = '', _replace: bool=True, _report: bool=True):
        """

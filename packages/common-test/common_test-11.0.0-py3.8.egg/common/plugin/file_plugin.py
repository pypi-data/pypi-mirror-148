...
class FilePlugin(object):
    @classmethod
    def excel_to_dict(self, file_name, sheet, _replace: bool=True, file_path: str=TEST_DATA_PATH, _functionName=None, _suitName=None, _storyId=None, _title=None):
        """
    ...
    @classmethod
    def dict_contain(self,_data,_temp):
        _flag = True

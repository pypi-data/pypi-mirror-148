...
class AggFontType(_object):
    ...
    __swig_setmethods__["face_index"] = _agg.AggFontType_face_index_set
    __swig_getmethods__["face_index"] = _agg.AggFontType_face_index_get
    if _newclass:
        face_index = _swig_property(_agg.AggFontType_face_index_get, _agg.AggFontType_face_index_set)

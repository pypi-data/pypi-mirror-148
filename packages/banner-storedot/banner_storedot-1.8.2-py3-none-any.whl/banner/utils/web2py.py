...
COLUMN_TO_LABEL = {
    ...
    'average_voltage_003c': '0.033C Average voltage [V]',
    'average_voltage_003c_delta': '0.033C Average voltage delta [V]',
    'average_voltage_01c': '0.1C Average voltage [V]',
    'average_voltage_01cp': '0.1C++ Average voltage [V]',
    'average_voltage_10c': '10C Average voltage [V]',
    'average_voltage_10c_test': '10C Average voltage (trial run) [V]',
    'average_voltage_delta_003c': '0.033C Average voltage delta [V]',
    'average_voltage_eol_01c': 'EoL 0.1C Average voltage [V]',
    'average_voltage_eol_full_01c': 'EoL Full range 0.1C Average voltage [V]',
    ...
    'c_rate1_cap_last_to_01cp': 'C-rate #1 Last Cap. / 0.1C++ dchg [%]',
    ...
    'c_rate2_cap_last_to_01cp': 'C-rate #2 Last Cap. / 0.1C++ dchg [%]',
    ...
    'c_rate3_cap_last_to_01cp': 'C-rate #3 Last Cap. / 0.1C++ dchg [%]',
    ...
    'c_rate4_cap_last_to_01cp': 'C-rate #4 Last Cap. / 0.1C++ dchg [%]',
    ...
    'ca_last_dchg_01c': '0.1C Cap/area last discharge [mAh/cm2]',
    ...
    'cap_1st_chg_003c': '0.033C Capacity 1st charge [mAh]',
    'cap_1st_dchg_003c': '0.033C Capacity 1st discharge [mAh]',
    'cap_1st_dchg_10c': '10C Capacity 1st Discharge [mAh]',
    'cap_1st_dchg_10c_test': '10C Capacity 1st Discharge (trial run) [mAh]',
    'cap_1st_dchg_1c': '1C Capacity 1st Discharge [mAh]',
    'cap_1st_dchg_5c': '5C Capacity 1st Discharge [mAh]',
    'cap_chg': 'Cap Chg',
    'cap_cutoff_003c': '0.033C Capacity cut-off [%]',
    'cap_cutoff_01c': '0.1C Capacity cut-off [%]',
    'cap_cutoff_10c': '10C Capacity cut-off [%]',
    'cap_dchg': 'Cap Dchg',
    'cap_dchg_eol_01c': 'EoL 0.1C Cap discharge [mAh]',
    'cap_dchg_eol_full_01c': 'EoL Full range 0.1C Cap discharge [mAh]',
    'cap_evaluation': 'Use for capacity eval.',
    'cap_last_dchg_01c': '0.1C Capacity last discharge [mAh]',
    'cap_last_dchg_01c_calc': '0.1C Capacity last discharge CALC [mAh]',
    'cap_last_dchg_01c_calc4': '0.1C Capacity last discharge CALC4 [mAh]',
    'cap_last_dchg_01c_calc_lowca': '0.1C Capacity last discharge CALC (low C:A) [mAh]',
    'cap_last_dchg_01cp': '0.1C++ Capacity last discharge [mAh]',
    'cap_last_dchg_01cp_calc': '0.1C++ Capacity last dchg CALC [mAh]',
    'cap_last_dchg_01cp_calc2': '0.1C++ Capacity last dchg CALC2 [mAh]',
    'cap_last_dchg_01cp_calc3': '0.1C++ Capacity last dchg CALC3 [mAh]',
    'cap_last_dchg_01cp_calc_ratio': '0.1C++ Capacity last dchg CALC ratio [%]',
    'cap_per_a_load_01cp': '0.1C++ Cap per anode_load [mAh/mg*cm2]',
    'cap_per_a_load_10c': '10C Cap per anode_load [mAh/mg*cm2]',
    'cap_type': 'Cap type',
    'capacity': 'Capacity',
    'case_type': 'Case type',
    ...
    'cc_ratio': 'Cc Ratio',
    'cc_ratio_01c': '0.1C CC ratio [%]',
    'cc_ratio_01c_first': '0.1C CC ratio (first) [%]',
    'cc_ratio_01cp': '0.1C++ CC ratio [%]',
    'ce': 'C.E. Last [%]',
    'ce_003c': '0.033C F.C.E. [%]',
    'ce_01c': '0.1C L.C.E [%]',
    'ce_01cp': '0.1C++ L.C.E [%]',
    'ce_10c': '10C C.E. [%]',
    'ce_1c': '1C C.E. [%]',
    'ce_5c': '5C C.E. [%]',
    'ce_eol_01c': 'EoL 0.1C C.E [%]',
    'ce_eol_full_01c': 'EoL Full range 0.1C C.E [%]',
    'cell': 'Cell',
    'cell_1c': 'Cell 1C [mAh]',
    'cell_id': 'Group',
    ...
    'cg_1st_chg_003c': '0.033C Cap/gA 1st charge [mAh/g]',
    'cg_1st_dchg_003c': '0.033C Cap/gA 1st discharge [mAh/g]',
    'cg_last_dchg_01c': '0.1C Cap/gA last discharge [mAh/g]',
    'cg_theoretic': 'Theoretic batch capacity [mAh/g]',
    'cgc_1st_chg_003c': '0.033C Cap/gC 1st charge [mAh/g]',
    'cgc_1st_dchg_003c': '0.033C Cap/gC 1st discharge [mAh/g]',
    'cgc_last_dchg_01c': '0.1C Cap/gC last discharge [mAh/g]',
    'channel': 'Channel',
    ...
    'check_id': 'Check ID',
    'chg': 'Chg',
    'chg_003c_per_ag': '0.033C 1st chg Cap/g anode [mAh/g]',
    'chg_003c_per_cg': '0.033C 1st chg Cap/g cathode [mAh/g]',
    'chg_003c_to_calc': '0.033C 1st charge / calc. capacity [%]',
    'chg_003c_to_el_cap': '0.033C 1st charge / calc. capacity [%]',
    'chg_01c_to_003c': '0.1C charge / 0.033C discharge [%]',
    ...
    'current_003c': '0.033C actual current [C]',
    'current_01c': '0.1C actual current [C]',
    'current_01cp': '0.1C++ actual current [C]',
    ...
    'dchg': 'Dchg',
    'dchg_003c_per_ag': '0.033C 1st dchg Cap/g anode [mAh/g]',
    'dchg_003c_per_cg': '0.033C 1st dchg Cap/g cathode [mAh/g]',
    'dchg_003c_to_el_cap': '0.033C 1st discharge / calc. capacity [%]',
    'dchg_01c_to_003c': '0.1C discharge / 0.033C discharge [%]',
    'dchg_01c_to_2nd': '0.1C discharge / 2nd cycle discharge [%]',
    'dchg_01c_to_calc': '0.1C discharge / calc. capacity [%]',
    'dchg_01c_to_hc': 'highC discharge / 0.1C discharge [%]',
    'dchg_01cp_to_01c': '0.1C++ discharge / 0.1C discharge [%]',
    'dchg_01cp_to_calc': '0.1C++ discharge / calc. capacity [%]',
    'dchg_10c_delta_a': '10C Cap Δ anode [%]',
    'dchg_10c_delta_c': '10C Cap Δ cathode [%]',
    'dchg_10c_per_ag': '10C Cap/g anode [mAh/g]',
    'dchg_10c_per_cg': '10C Cap/g cathode [mAh/g]',
    'dchg_10c_per_el': '10C Capacity per electrode [mAh]',
    'dchg_10c_to_01c': '10C discharge / 0.1C discharge [%]',
    'dchg_10c_to_01cp': '10C discharge / 0.1C++ discharge [%]',
    'dchg_10c_to_1c': '10C discharge / 1C discharge [%]',
    'dchg_10c_to_calc': '10C discharge / calc. capacity [%]',
    'dchg_capacity': 'Dcgh capacity from coins [mAh/gr]',
    'dchg_eol_to_01c': 'EoL discharge / 0.1C discharge [%]',
    'dchg_eol_to_calc': 'EoL discharge / calc. capacity [%]',
    'defect': 'Defect',
    ...
    'duration_1st_chg_003c': '0.033C 1st charge duration [hours]',
    ...
    'eg_003c': '0.033C Energy/gA [Wh/g]',
    'eg_01c': '0.1C Energy/gA [Wh/g]',
    'egc_003c': '0.033C Energy/gC [Wh/g]',
    'egc_01c': '0.1C Energy/gC [Wh/g]',
    ...
    'engy_01cp_to_01c': '0.1C++ Energy / 0.1C Energy [%]',
    'engy_10c_per_el': '10C Energy per electrode [mWh]',
    'engy_1st_dchg_003c': '0.033C Energy 1st discharge [mWh]',
    'engy_1st_dchg_10c': '10C Energy 1st discharge [mWh]',
    'engy_1st_dchg_10c_test': '10C Energy 1st discharge (trial run) [mWh]',
    'engy_1st_dchg_1c': '1C Energy 1st discharge [mWh]',
    'engy_1st_dchg_5c': '5C Energy 1st discharge [mWh]',
    'engy_chg': 'Engy Chg',
    'engy_dchg': 'Engy Dchg',
    'engy_dchg_eol_01c': 'EoL 0.1C Energy discharge [mWh]',
    'engy_dchg_eol_full_01c': 'EoL Full range 0.1C Energy discharge [mWh]',
    'engy_eff_003c': '0.033C Energy efficiency [%]',
    'engy_eff_01c': '0.1C Energy efficiency [%]',
    'engy_eff_01cp': '0.1C++ Energy efficiency [%]',
    'engy_eff_10c': '10C Energy efficiency [%]',
    'engy_eff_10c_test': '10C Energy efficiency (trial run) [%]',
    'engy_eff_1c': '1C Energy efficiency [%]',
    'engy_eff_5c': '5C Energy efficiency [%]',
    'engy_eff_eol_01c': 'EoL 0.1C Energy efficiency [%]',
    'engy_eff_eol_full_01c': 'EoL Full range 0.1C Energy efficiency [%]',
    'engy_gravimetric_01c': '0.1C Grav. Energy density [Wh/kg]',
    'engy_gravimetric_01c_ff1': '0.1C Grav. Energy density FF1 [Wh/kg]',
    'engy_gravimetric_01c_ff2': '0.1C Grav. Energy density FF2 [Wh/kg]',
    'engy_gravimetric_01cp_ff1': '0.1C++ Grav. Energy density FF1 [Wh/kg]',
    'engy_gravimetric_01cp_ff2': '0.1C++ Grav. Energy density FF2 [Wh/kg]',
    'engy_gravimetric_10c': '10C Grav. Energy density [Wh/kg]',
    'engy_gravimetric_10c_ff1': '10C Grav. Energy density FF1 [Wh/kg]',
    'engy_gravimetric_10c_ff1_interfaces': '10C Grav. Energy density FF1 interfaces',
    'engy_gravimetric_10c_ff1_test': '10C Grav. Energy density FF1 (trial run) [Wh/kg]',
    'engy_gravimetric_10c_ff2': '10C Grav. Energy density FF2 [Wh/kg]',
    'engy_gravimetric_10c_ff2_test': '10C Grav. Energy density FF2 (trial run) [Wh/kg]',
    'engy_gravimetric_eol_01c_ff1': 'EoL 0.1C Grav. Energy density FF1 [Wh/kg]',
    'engy_gravimetric_eol_full_01c_ff1': 'EoL Full range 0.1C Grav. Energy density FF1 [Wh/kg]',
    'engy_last_dchg_01c': '0.1C Energy last discharge [mWh]',
    'engy_last_dchg_01cp': '0.1C++ Energy last discharge [mWh]',
    'engy_volumetric_01c': '0.1C Volumetric Energy density [Wh/L]',
    'engy_volumetric_01cp': '0.1C++ Volumetric Energy density [Wh/L]',
    'engy_volumetric_10c': '10C Volumetric Energy density [Wh/L]',
    ...
    'first_formation_duration': '1st formation duration [hours]',
    'first_formation_procedure': '1st formation procedure',
    ...
    'form2_cap': 'Formation 2nd cycle capacity [mAh]',
    'form2_ce': 'Formation 2nd cycle C.E. [%]',
    'form3_cap': 'Formation 3rd cycle capacity [mAh]',
    'form3_ce': 'Formation 3rd cycle C.E. [%]',
    'form4_cap': 'Formation 4th cycle capacity [mAh]',
    'form4_ce': 'Formation 4th cycle C.E. [%]',
    'form_factor': 'Form factor',
    'formation_last_voltage1': 'Formation last voltage1 [V]',
    'formation_last_voltage2': 'Formation last voltage2 [V]',
    ...
    'hc_80_cap_cycles': 'highC 80%+ retention cycles',
    'hc_86_cap_cycles': 'highC 86% retention cycles',
    'hc_average_voltage': 'highC Average voltage [V]',
    'hc_average_voltage_test': 'highC Average voltage (trial run) [V]',
    'hc_avg_ref_cycle': 'highC last cycle for average',
    'hc_cap_1st_dchg': 'highC Capacity 1st Discharge [mAh]',
    'hc_cap_1st_dchg_test': 'highC Capacity 1st Discharge (trial run) [mAh]',
    'hc_cap_cutoff': 'highC Capacity cut-off [%]',
    'hc_cap_last_dchg': 'highC Capacity last discharge [mAh]',
    'hc_cap_not_80': 'highC retention percent',
    'hc_cap_per_a_load': 'highC Cap per anode_load [mAh/mg*cm2]',
    'hc_cc_ratio_70cap': 'highC CC cap ratio 70% [cycles]',
    'hc_cc_ratio_avg': 'highC CC Ratio average [%]',
    'hc_cc_ratio_cap_avg': 'highC CC cap Ratio (average) [%]',
    'hc_cc_ratio_cap_drop': 'highC CC cap Ratio drop [%/100cyc]',
    'hc_cc_ratio_cap_init': 'highC CC cap Ratio (initial) [%]',
    'hc_cc_ratio_cap_last': 'highC CC cap Ratio (last) [%]',
    'hc_cc_ratio_drop': 'highC CC Ratio drop [%/100cyc]',
    'hc_cc_ratio_init': 'highC CC Ratio initial [%]',
    'hc_cc_ratio_last': 'highC CC Ratio last [%]',
    'hc_ce_10cycle_slope': 'highC C.E. last 10 cycle slope [%]',
    'hc_ce_3cycle_drop': 'highC C.E. last 3 cycle drop [%]',
    'hc_ce_avg': 'highC C.E. average [%]',
    'hc_ce_drop': 'highC C.E. drop [%/100cyc]',
    'hc_ce_init': 'highC C.E. (initial) [%]',
    'hc_ce_last': 'highC C.E. last [%]',
    'hc_ce_min': 'highC C.E. minimal [%]',
    'hc_cg_1st_dchg': 'highC Cap/g 1st discharge [mAh/g]',
    'hc_cumulative_cap': 'highC IF Cumulative Dchg capacity [Ah]',
    'hc_cumulative_cap_per_a': 'highC IF Cumulative per Anode [Ah]',
    'hc_curr_cycle': 'highC current cycle (>0 if running)',
    'hc_current': 'highC CHG current [C]',
    'hc_current_a': 'highC CHG current [mA]',
    'hc_current_dchg': 'highC DCHG current [C]',
    'hc_current_dchg_a': 'highC DCHG current [mA]',
    'hc_current_per_ga': 'HighC CHG current/gA [mA/g]',
    'hc_current_per_ga_eff': 'HighC CHG current/gA (effective) [mA/g]',
    'hc_current_per_gc': 'HighC CHG current/gC [mA/g]',
    'hc_current_per_gc_eff': 'HighC CHG current/gC (effective) [mA/g]',
    'hc_dchg_per_ag': 'highC Capacity/gA [mAh/g]',
    'hc_dchg_per_area': 'highC Cap/area 1st discharge [mAh/cm2]',
    'hc_dchg_per_cg': 'highC Capacity/gC [mAh/g]',
    'hc_dchg_to_003c': 'highC discharge / 0.033C charge [%]',
    'hc_dchg_to_01c': 'highC discharge / 0.1C discharge [%]',
    'hc_dchg_to_01cp': 'highC discharge / 0.1C++ discharge [%]',
    'hc_dchg_to_calc': 'highC discharge / calc. capacity [%]',
    'hc_degassing_cycle': 'highC degassing cycle',
    'hc_eg': 'highC Energy/g [Wh/g]',
    'hc_engy_1st_dchg': 'highC Energy 1st discharge [mWh]',
    'hc_engy_1st_dchg_test': 'high C Energy 1st discharge (trial run) [mWh]',
    'hc_engy_chg_drop': 'highC Energy Chg drop [%/100cyc]',
    'hc_engy_chg_last': 'highC Energy Chg last [mWh]',
    'hc_engy_dchg_drop': 'highC Energy Dchg drop [%/100cyc]',
    'hc_engy_dchg_last': 'highC Energy Dchg last [mWh]',
    'hc_engy_eff': 'highC Energy efficiency [%]',
    'hc_engy_eff_drop': 'highC Energy efficiency drop [%/100cyc]',
    'hc_engy_eff_test': 'highC Energy efficiency (trial run) [%]',
    'hc_engy_gravimetric': 'highC Grav. Energy density [Wh/kg]',
    'hc_engy_gravimetric_ff1': 'highC Grav. Energy density FF1 [Wh/kg]',
    'hc_engy_gravimetric_ff1_interfaces': 'highC Grav. Energy density FF1 interfaces',
    'hc_engy_gravimetric_ff1_test': 'highC Grav. Energy density FF1 (trial run) [Wh/kg]',
    'hc_engy_gravimetric_ff2': 'highC Grav. Energy density FF2 [Wh/kg]',
    'hc_engy_gravimetric_ff2_test': 'highC Grav. Energy density FF2 (trial run) [Wh/kg]',
    'hc_first_test_id': 'highC first test id',
    'hc_last_dchg_to_01cp': 'highC capacity last dchg / 0.1C++ discharge [%]',
    'hc_max_temp': 'highC max temperature [°C]',
    'hc_max_voltage': 'highC max V [V]',
    'hc_max_voltage_1st': 'highC max V 1st cycle [V]',
    'hc_max_voltage_diff': 'highC max V difference [%]',
    'hc_min_voltage': 'highC min V [V]',
    'hc_min_voltage_1st': 'highC min V 1st cycle [V]',
    'hc_min_voltage_diff': 'highC min V difference [%]',
    'hc_overriden': 'highC overriden',
    'hc_r_chg_avg': 'highC DCR Chg average [Ohm]',
    'hc_r_chg_drop': 'highC DCR Chg drop [%/100cyc]',
    'hc_r_chg_init': 'highC DCR Chg initial [Ohm]',
    'hc_r_chg_last': 'highC DCR Chg last [Ohm]',
    'hc_r_dchg_avg': 'highC DCR Dchg average [Ohm]',
    'hc_r_dchg_drop': 'highC DCR Dchg drop [%/100cyc]',
    'hc_r_dchg_init': 'highC DCR Dchg initial [Ohm]',
    'hc_r_dchg_last': 'highC DCR Dchg last [Ohm]',
    'hc_ref_cycle': 'highC reference cycle',
    'hc_slope_init': 'highC initial slope [%drop/cycle]',
    'hc_test_1c': 'highC (from test) 1C capacity [mAh]',
    'hc_test_average_v': 'highC (from test) Target Average voltage [V]',
    'hc_test_c_ratio': 'highC (from test) Ratio for 1C [%]',
    'hc_test_grav_engy': 'highC (from test) Target Grav. energy [Wh/kg]',
    'hc_test_grav_ff': 'highC (from test) Grav. energy form-factor',
    'hc_total_cycles': 'highC total cycles',
    ...
    'initial_formation_voltage': 'OCV before formation [V]',
    'initial_hc_voltage': 'OCV before HC [V]',
    ...
    'last_dchg_to_el_cap_01c': '0.1C last discharge / calc. capacity [%]',
    'last_dchg_to_el_cap_01cp': '0.1C++ last discharge / calc. capacity [%]',
    ...
    'min_voltage_003c': '0.033C Min voltage [V]',
    ...
    'ocv_drop_chg_003c': '0.033C delithiation end OCV drop [V]',
    ...
    'rest_time': 'Rest time [min]',
    'rest_voltage_rise_003c': '0.033C voltage rise after rest [V]',
    'result': 'Results',
    'retention': 'Retention [%]',
    ...
    'voltage_after_rest': 'Voltage after rest [V]',
    'voltage_before_rest': 'Voltage before rest (after 1st cycle) [V]',
    'volume': 'Volume [ml]',
...
LABEL_TO_COLUMN = {
    ...
    '0.033C Average voltage [V]': 'average_voltage_003c',
    '0.033C Average voltage delta [V]': 'average_voltage_003c_delta',
    '0.1C Average voltage [V]': 'average_voltage_01c',
    '0.1C++ Average voltage [V]': 'average_voltage_01cp',
    '10C Average voltage [V]': 'average_voltage_10c',
    '10C Average voltage (trial run) [V]': 'average_voltage_10c_test',
    '0.033C Average voltage delta [V]': 'average_voltage_delta_003c',
    'EoL 0.1C Average voltage [V]': 'average_voltage_eol_01c',
    'EoL Full range 0.1C Average voltage [V]': 'average_voltage_eol_full_01c',
    ...
    'C-rate #1 Last Cap. / 0.1C++ dchg [%]': 'c_rate1_cap_last_to_01cp',
    ...
    'C-rate #2 Last Cap. / 0.1C++ dchg [%]': 'c_rate2_cap_last_to_01cp',
    ...
    'C-rate #3 Last Cap. / 0.1C++ dchg [%]': 'c_rate3_cap_last_to_01cp',
    ...
    'C-rate #4 Last Cap. / 0.1C++ dchg [%]': 'c_rate4_cap_last_to_01cp',
    ...
    '0.1C Cap/area last discharge [mAh/cm2]': 'ca_last_dchg_01c',
    ...
    '0.033C Capacity 1st charge [mAh]': 'cap_1st_chg_003c',
    '0.033C Capacity 1st discharge [mAh]': 'cap_1st_dchg_003c',
    '10C Capacity 1st Discharge [mAh]': 'cap_1st_dchg_10c',
    '10C Capacity 1st Discharge (trial run) [mAh]': 'cap_1st_dchg_10c_test',
    '1C Capacity 1st Discharge [mAh]': 'cap_1st_dchg_1c',
    '5C Capacity 1st Discharge [mAh]': 'cap_1st_dchg_5c',
    'Cap Chg': 'cap_chg',
    '0.033C Capacity cut-off [%]': 'cap_cutoff_003c',
    '0.1C Capacity cut-off [%]': 'cap_cutoff_01c',
    '10C Capacity cut-off [%]': 'cap_cutoff_10c',
    'Cap Dchg': 'cap_dchg',
    'EoL 0.1C Cap discharge [mAh]': 'cap_dchg_eol_01c',
    'EoL Full range 0.1C Cap discharge [mAh]': 'cap_dchg_eol_full_01c',
    'Use for capacity eval.': 'cap_evaluation',
    '0.1C Capacity last discharge [mAh]': 'cap_last_dchg_01c',
    '0.1C Capacity last discharge CALC [mAh]': 'cap_last_dchg_01c_calc',
    '0.1C Capacity last discharge CALC4 [mAh]': 'cap_last_dchg_01c_calc4',
    '0.1C Capacity last discharge CALC (low C:A) [mAh]': 'cap_last_dchg_01c_calc_lowca',
    '0.1C++ Capacity last discharge [mAh]': 'cap_last_dchg_01cp',
    '0.1C++ Capacity last dchg CALC [mAh]': 'cap_last_dchg_01cp_calc',
    '0.1C++ Capacity last dchg CALC2 [mAh]': 'cap_last_dchg_01cp_calc2',
    '0.1C++ Capacity last dchg CALC3 [mAh]': 'cap_last_dchg_01cp_calc3',
    '0.1C++ Capacity last dchg CALC ratio [%]': 'cap_last_dchg_01cp_calc_ratio',
    '0.1C++ Cap per anode_load [mAh/mg*cm2]': 'cap_per_a_load_01cp',
    '10C Cap per anode_load [mAh/mg*cm2]': 'cap_per_a_load_10c',
    'Cap type': 'cap_type',
    'Capacity': 'capacity',
    'Case type': 'case_type',
    ...
    'Cc Ratio': 'cc_ratio',
    '0.1C CC ratio [%]': 'cc_ratio_01c',
    '0.1C CC ratio (first) [%]': 'cc_ratio_01c_first',
    '0.1C++ CC ratio [%]': 'cc_ratio_01cp',
    'C.E. Last [%]': 'ce',
    '0.033C F.C.E. [%]': 'ce_003c',
    '0.1C L.C.E [%]': 'ce_01c',
    '0.1C++ L.C.E [%]': 'ce_01cp',
    '10C C.E. [%]': 'ce_10c',
    '1C C.E. [%]': 'ce_1c',
    '5C C.E. [%]': 'ce_5c',
    'EoL 0.1C C.E [%]': 'ce_eol_01c',
    'EoL Full range 0.1C C.E [%]': 'ce_eol_full_01c',
    'Cell': 'cell',
    'Cell 1C [mAh]': 'cell_1c',
    'Group': 'cell_id',
    ...
    '0.033C Cap/gA 1st charge [mAh/g]': 'cg_1st_chg_003c',
    '0.033C Cap/gA 1st discharge [mAh/g]': 'cg_1st_dchg_003c',
    '0.1C Cap/gA last discharge [mAh/g]': 'cg_last_dchg_01c',
    'Theoretic batch capacity [mAh/g]': 'cg_theoretic',
    '0.033C Cap/gC 1st charge [mAh/g]': 'cgc_1st_chg_003c',
    '0.033C Cap/gC 1st discharge [mAh/g]': 'cgc_1st_dchg_003c',
    '0.1C Cap/gC last discharge [mAh/g]': 'cgc_last_dchg_01c',
    'Channel': 'channel',
    ...
    'Check ID': 'check_id',
    'Chg': 'chg',
    '0.033C 1st chg Cap/g anode [mAh/g]': 'chg_003c_per_ag',
    '0.033C 1st chg Cap/g cathode [mAh/g]': 'chg_003c_per_cg',
    '0.033C 1st charge / calc. capacity [%]': 'chg_003c_to_calc',
    '0.033C 1st charge / calc. capacity [%]': 'chg_003c_to_el_cap',
    '0.1C charge / 0.033C discharge [%]': 'chg_01c_to_003c',
    ...
    '0.033C actual current [C]': 'current_003c',
    '0.1C actual current [C]': 'current_01c',
    '0.1C++ actual current [C]': 'current_01cp',
    ...
    'Dchg': 'dchg',
    '0.033C 1st dchg Cap/g anode [mAh/g]': 'dchg_003c_per_ag',
    '0.033C 1st dchg Cap/g cathode [mAh/g]': 'dchg_003c_per_cg',
    '0.033C 1st discharge / calc. capacity [%]': 'dchg_003c_to_el_cap',
    '0.1C discharge / 0.033C discharge [%]': 'dchg_01c_to_003c',
    '0.1C discharge / 2nd cycle discharge [%]': 'dchg_01c_to_2nd',
    '0.1C discharge / calc. capacity [%]': 'dchg_01c_to_calc',
    'highC discharge / 0.1C discharge [%]': 'dchg_01c_to_hc',
    '0.1C++ discharge / 0.1C discharge [%]': 'dchg_01cp_to_01c',
    '0.1C++ discharge / calc. capacity [%]': 'dchg_01cp_to_calc',
    '10C Cap Δ anode [%]': 'dchg_10c_delta_a',
    '10C Cap Δ cathode [%]': 'dchg_10c_delta_c',
    '10C Cap/g anode [mAh/g]': 'dchg_10c_per_ag',
    '10C Cap/g cathode [mAh/g]': 'dchg_10c_per_cg',
    '10C Capacity per electrode [mAh]': 'dchg_10c_per_el',
    '10C discharge / 0.1C discharge [%]': 'dchg_10c_to_01c',
    '10C discharge / 0.1C++ discharge [%]': 'dchg_10c_to_01cp',
    '10C discharge / 1C discharge [%]': 'dchg_10c_to_1c',
    '10C discharge / calc. capacity [%]': 'dchg_10c_to_calc',
    'Dcgh capacity from coins [mAh/gr]': 'dchg_capacity',
    'EoL discharge / 0.1C discharge [%]': 'dchg_eol_to_01c',
    'EoL discharge / calc. capacity [%]': 'dchg_eol_to_calc',
    'Defect': 'defect',
    ...
    '0.033C 1st charge duration [hours]': 'duration_1st_chg_003c',
    ...
    '0.033C Energy/gA [Wh/g]': 'eg_003c',
    '0.1C Energy/gA [Wh/g]': 'eg_01c',
    '0.033C Energy/gC [Wh/g]': 'egc_003c',
    '0.1C Energy/gC [Wh/g]': 'egc_01c',
    ...
    '0.1C++ Energy / 0.1C Energy [%]': 'engy_01cp_to_01c',
    '10C Energy per electrode [mWh]': 'engy_10c_per_el',
    '0.033C Energy 1st discharge [mWh]': 'engy_1st_dchg_003c',
    '10C Energy 1st discharge [mWh]': 'engy_1st_dchg_10c',
    '10C Energy 1st discharge (trial run) [mWh]': 'engy_1st_dchg_10c_test',
    '1C Energy 1st discharge [mWh]': 'engy_1st_dchg_1c',
    '5C Energy 1st discharge [mWh]': 'engy_1st_dchg_5c',
    'Engy Chg': 'engy_chg',
    'Engy Dchg': 'engy_dchg',
    'EoL 0.1C Energy discharge [mWh]': 'engy_dchg_eol_01c',
    'EoL Full range 0.1C Energy discharge [mWh]': 'engy_dchg_eol_full_01c',
    '0.033C Energy efficiency [%]': 'engy_eff_003c',
    '0.1C Energy efficiency [%]': 'engy_eff_01c',
    '0.1C++ Energy efficiency [%]': 'engy_eff_01cp',
    '10C Energy efficiency [%]': 'engy_eff_10c',
    '10C Energy efficiency (trial run) [%]': 'engy_eff_10c_test',
    '1C Energy efficiency [%]': 'engy_eff_1c',
    '5C Energy efficiency [%]': 'engy_eff_5c',
    'EoL 0.1C Energy efficiency [%]': 'engy_eff_eol_01c',
    'EoL Full range 0.1C Energy efficiency [%]': 'engy_eff_eol_full_01c',
    '0.1C Grav. Energy density [Wh/kg]': 'engy_gravimetric_01c',
    '0.1C Grav. Energy density FF1 [Wh/kg]': 'engy_gravimetric_01c_ff1',
    '0.1C Grav. Energy density FF2 [Wh/kg]': 'engy_gravimetric_01c_ff2',
    '0.1C++ Grav. Energy density FF1 [Wh/kg]': 'engy_gravimetric_01cp_ff1',
    '0.1C++ Grav. Energy density FF2 [Wh/kg]': 'engy_gravimetric_01cp_ff2',
    '10C Grav. Energy density [Wh/kg]': 'engy_gravimetric_10c',
    '10C Grav. Energy density FF1 [Wh/kg]': 'engy_gravimetric_10c_ff1',
    '10C Grav. Energy density FF1 interfaces': 'engy_gravimetric_10c_ff1_interfaces',
    '10C Grav. Energy density FF1 (trial run) [Wh/kg]': 'engy_gravimetric_10c_ff1_test',
    '10C Grav. Energy density FF2 [Wh/kg]': 'engy_gravimetric_10c_ff2',
    '10C Grav. Energy density FF2 (trial run) [Wh/kg]': 'engy_gravimetric_10c_ff2_test',
    'EoL 0.1C Grav. Energy density FF1 [Wh/kg]': 'engy_gravimetric_eol_01c_ff1',
    'EoL Full range 0.1C Grav. Energy density FF1 [Wh/kg]': 'engy_gravimetric_eol_full_01c_ff1',
    '0.1C Energy last discharge [mWh]': 'engy_last_dchg_01c',
    '0.1C++ Energy last discharge [mWh]': 'engy_last_dchg_01cp',
    '0.1C Volumetric Energy density [Wh/L]': 'engy_volumetric_01c',
    '0.1C++ Volumetric Energy density [Wh/L]': 'engy_volumetric_01cp',
    '10C Volumetric Energy density [Wh/L]': 'engy_volumetric_10c',
    ...
    '1st formation duration [hours]': 'first_formation_duration',
    '1st formation procedure': 'first_formation_procedure',
    ...
    'Formation 2nd cycle capacity [mAh]': 'form2_cap',
    'Formation 2nd cycle C.E. [%]': 'form2_ce',
    'Formation 3rd cycle capacity [mAh]': 'form3_cap',
    'Formation 3rd cycle C.E. [%]': 'form3_ce',
    'Formation 4th cycle capacity [mAh]': 'form4_cap',
    'Formation 4th cycle C.E. [%]': 'form4_ce',
    'Form factor': 'form_factor',
    'Formation last voltage1 [V]': 'formation_last_voltage1',
    'Formation last voltage2 [V]': 'formation_last_voltage2',
    ...
    'highC 80%+ retention cycles': 'hc_80_cap_cycles',
    'highC 86% retention cycles': 'hc_86_cap_cycles',
    'highC Average voltage [V]': 'hc_average_voltage',
    'highC Average voltage (trial run) [V]': 'hc_average_voltage_test',
    'highC last cycle for average': 'hc_avg_ref_cycle',
    'highC Capacity 1st Discharge [mAh]': 'hc_cap_1st_dchg',
    'highC Capacity 1st Discharge (trial run) [mAh]': 'hc_cap_1st_dchg_test',
    'highC Capacity cut-off [%]': 'hc_cap_cutoff',
    'highC Capacity last discharge [mAh]': 'hc_cap_last_dchg',
    'highC retention percent': 'hc_cap_not_80',
    'highC Cap per anode_load [mAh/mg*cm2]': 'hc_cap_per_a_load',
    'highC CC cap ratio 70% [cycles]': 'hc_cc_ratio_70cap',
    'highC CC Ratio average [%]': 'hc_cc_ratio_avg',
    'highC CC cap Ratio (average) [%]': 'hc_cc_ratio_cap_avg',
    'highC CC cap Ratio drop [%/100cyc]': 'hc_cc_ratio_cap_drop',
    'highC CC cap Ratio (initial) [%]': 'hc_cc_ratio_cap_init',
    'highC CC cap Ratio (last) [%]': 'hc_cc_ratio_cap_last',
    'highC CC Ratio drop [%/100cyc]': 'hc_cc_ratio_drop',
    'highC CC Ratio initial [%]': 'hc_cc_ratio_init',
    'highC CC Ratio last [%]': 'hc_cc_ratio_last',
    'highC C.E. last 10 cycle slope [%]': 'hc_ce_10cycle_slope',
    'highC C.E. last 3 cycle drop [%]': 'hc_ce_3cycle_drop',
    'highC C.E. average [%]': 'hc_ce_avg',
    'highC C.E. drop [%/100cyc]': 'hc_ce_drop',
    'highC C.E. (initial) [%]': 'hc_ce_init',
    'highC C.E. last [%]': 'hc_ce_last',
    'highC C.E. minimal [%]': 'hc_ce_min',
    'highC Cap/g 1st discharge [mAh/g]': 'hc_cg_1st_dchg',
    'highC IF Cumulative Dchg capacity [Ah]': 'hc_cumulative_cap',
    'highC IF Cumulative per Anode [Ah]': 'hc_cumulative_cap_per_a',
    'highC current cycle (>0 if running)': 'hc_curr_cycle',
    'highC CHG current [C]': 'hc_current',
    'highC CHG current [mA]': 'hc_current_a',
    'highC DCHG current [C]': 'hc_current_dchg',
    'highC DCHG current [mA]': 'hc_current_dchg_a',
    'HighC CHG current/gA [mA/g]': 'hc_current_per_ga',
    'HighC CHG current/gA (effective) [mA/g]': 'hc_current_per_ga_eff',
    'HighC CHG current/gC [mA/g]': 'hc_current_per_gc',
    'HighC CHG current/gC (effective) [mA/g]': 'hc_current_per_gc_eff',
    'highC Capacity/gA [mAh/g]': 'hc_dchg_per_ag',
    'highC Cap/area 1st discharge [mAh/cm2]': 'hc_dchg_per_area',
    'highC Capacity/gC [mAh/g]': 'hc_dchg_per_cg',
    'highC discharge / 0.033C charge [%]': 'hc_dchg_to_003c',
    'highC discharge / 0.1C discharge [%]': 'hc_dchg_to_01c',
    'highC discharge / 0.1C++ discharge [%]': 'hc_dchg_to_01cp',
    'highC discharge / calc. capacity [%]': 'hc_dchg_to_calc',
    'highC degassing cycle': 'hc_degassing_cycle',
    'highC Energy/g [Wh/g]': 'hc_eg',
    'highC Energy 1st discharge [mWh]': 'hc_engy_1st_dchg',
    'high C Energy 1st discharge (trial run) [mWh]': 'hc_engy_1st_dchg_test',
    'highC Energy Chg drop [%/100cyc]': 'hc_engy_chg_drop',
    'highC Energy Chg last [mWh]': 'hc_engy_chg_last',
    'highC Energy Dchg drop [%/100cyc]': 'hc_engy_dchg_drop',
    'highC Energy Dchg last [mWh]': 'hc_engy_dchg_last',
    'highC Energy efficiency [%]': 'hc_engy_eff',
    'highC Energy efficiency drop [%/100cyc]': 'hc_engy_eff_drop',
    'highC Energy efficiency (trial run) [%]': 'hc_engy_eff_test',
    'highC Grav. Energy density [Wh/kg]': 'hc_engy_gravimetric',
    'highC Grav. Energy density FF1 [Wh/kg]': 'hc_engy_gravimetric_ff1',
    'highC Grav. Energy density FF1 interfaces': 'hc_engy_gravimetric_ff1_interfaces',
    'highC Grav. Energy density FF1 (trial run) [Wh/kg]': 'hc_engy_gravimetric_ff1_test',
    'highC Grav. Energy density FF2 [Wh/kg]': 'hc_engy_gravimetric_ff2',
    'highC Grav. Energy density FF2 (trial run) [Wh/kg]': 'hc_engy_gravimetric_ff2_test',
    'highC first test id': 'hc_first_test_id',
    'highC capacity last dchg / 0.1C++ discharge [%]': 'hc_last_dchg_to_01cp',
    'highC max temperature [°C]': 'hc_max_temp',
    'highC max V [V]': 'hc_max_voltage',
    'highC max V 1st cycle [V]': 'hc_max_voltage_1st',
    'highC max V difference [%]': 'hc_max_voltage_diff',
    'highC min V [V]': 'hc_min_voltage',
    'highC min V 1st cycle [V]': 'hc_min_voltage_1st',
    'highC min V difference [%]': 'hc_min_voltage_diff',
    'highC overriden': 'hc_overriden',
    'highC DCR Chg average [Ohm]': 'hc_r_chg_avg',
    'highC DCR Chg drop [%/100cyc]': 'hc_r_chg_drop',
    'highC DCR Chg initial [Ohm]': 'hc_r_chg_init',
    'highC DCR Chg last [Ohm]': 'hc_r_chg_last',
    'highC DCR Dchg average [Ohm]': 'hc_r_dchg_avg',
    'highC DCR Dchg drop [%/100cyc]': 'hc_r_dchg_drop',
    'highC DCR Dchg initial [Ohm]': 'hc_r_dchg_init',
    'highC DCR Dchg last [Ohm]': 'hc_r_dchg_last',
    'highC reference cycle': 'hc_ref_cycle',
    'highC initial slope [%drop/cycle]': 'hc_slope_init',
    'highC (from test) 1C capacity [mAh]': 'hc_test_1c',
    'highC (from test) Target Average voltage [V]': 'hc_test_average_v',
    'highC (from test) Ratio for 1C [%]': 'hc_test_c_ratio',
    'highC (from test) Target Grav. energy [Wh/kg]': 'hc_test_grav_engy',
    'highC (from test) Grav. energy form-factor': 'hc_test_grav_ff',
    'highC total cycles': 'hc_total_cycles',
    ...
    'Impeller': 'impeller',
    'Ingredients': 'ingredients',
    'OCV before formation [V]': 'initial_formation_voltage',
    'OCV before HC [V]': 'initial_hc_voltage',
    ...
    '0.1C last discharge / calc. capacity [%]': 'last_dchg_to_el_cap_01c',
    '0.1C++ last discharge / calc. capacity [%]': 'last_dchg_to_el_cap_01cp',
    ...
    '0.033C Min voltage [V]': 'min_voltage_003c',
    ...
    '0.033C delithiation end OCV drop [V]': 'ocv_drop_chg_003c',
    ...
    'Rest time [min]': 'rest_time',
    '0.033C voltage rise after rest [V]': 'rest_voltage_rise_003c',
    'Results': 'result',
    'Retention [%]': 'retention',
    ...
    'Voltage after rest [V]': 'voltage_after_rest',
    'Voltage before rest (after 1st cycle) [V]': 'voltage_before_rest',
    'Volume [ml]': 'volume',

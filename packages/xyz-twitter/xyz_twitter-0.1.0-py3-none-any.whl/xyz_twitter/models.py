...
class User(models.Model):
    ...
    screen_name = models.CharField("帐号名称", max_length=255, blank=False, unique=True)
    tid = models.PositiveBigIntegerField('推特编号', blank=True, default=0)
...
class Tweet(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name=User._meta.verbose_name, related_name="tweets",
                             on_delete=models.PROTECT)
    tid = models.PositiveBigIntegerField("推特编号")
    full_text = models.CharField("名称", max_length=255, blank=False, unique=True)

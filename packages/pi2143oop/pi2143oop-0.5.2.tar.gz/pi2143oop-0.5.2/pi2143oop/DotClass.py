...
class Dot():
    def __init__(self, x: int = 0, y: int = 0):
        self.size = Main.canvas.size
        self.default_symbol = Main.canvas.default_symbol
    ...
    def check_values(self, *args):
        ...
        if len(args) == 0:
            ...
            Main.check_input(x, self.size)
            Main.check_input(y, self.size)
    ...
    def draw_c(self, symbol: str = '', *args):
        ...
        Main.canvas.draw_dot(symbol, *dots)
    ...
    def print_c(self, symbol: str = ''):
        ...
        Main.to_print(self.Board, symbol[0])

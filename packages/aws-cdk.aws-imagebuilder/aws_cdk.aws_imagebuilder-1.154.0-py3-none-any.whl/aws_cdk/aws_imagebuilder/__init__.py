...
class CfnContainerRecipe(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        components: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, "CfnContainerRecipe.ComponentConfigurationProperty"]]],

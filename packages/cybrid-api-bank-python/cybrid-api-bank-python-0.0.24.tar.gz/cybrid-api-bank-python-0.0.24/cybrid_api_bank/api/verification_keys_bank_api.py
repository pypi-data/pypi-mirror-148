...
class VerificationKeysBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_verification_key_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/banks/{bank_guid}/verification_keys',
        ...
        self.get_verification_key_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/banks/{bank_guid}/verification_keys/{verification_key_guid}',
    ...
    def create_verification_key(
        ...
        **kwargs
        ...
        >>> thread = api.create_verification_key(bank_guid, post_verification_key, async_req=True)
        >>> result = thread.get()
    ...
    def get_verification_key(
        ...
        **kwargs
        ...
        >>> thread = api.get_verification_key(bank_guid, verification_key_guid, async_req=True)
        >>> result = thread.get()

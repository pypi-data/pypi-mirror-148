...
class NptAggregateRow(WellsBaseModel):
    ...
    count: Optional[int] = Field(None, description="Number of NPT events that matches this group")
...
class DeleteTimeMeasurementSources(WellsBaseModel):
    ...
    items: List[TimeMeasurementExternalId] = Field(..., max_items=1000, min_items=1)
...
class HoleSectionGroupsIngestionItems(WellsBaseModel):
    ...
    items: List[HoleSectionGroup] = Field(..., max_items=1000, min_items=1)

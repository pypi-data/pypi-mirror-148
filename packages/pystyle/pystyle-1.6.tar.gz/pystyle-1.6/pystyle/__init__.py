...
def credits():
    System.Clear()
    text = "Join discord.gg/plague for more Python Tools!"
    System.Title(text)
    Anime.Fade(Center.Center(text), Colors.blue_to_red, Colorate.Horizontal, time=3)
    website("https://discord.gg/plague")
    System.Clear()

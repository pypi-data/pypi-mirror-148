...
def process_function(sso_detection, backend_info: BackendInformation, analysis_run_id: int,
    ...
    try:
        ...
        screen = png_helper.draw_circle_at_position(screen, element_x, element_y)
        ...
        try:
            ...
            rest_client.update_progress_of_analysis_using_sso_detection(analysis_run_id, sso_detection_index, 50,
        ...
        if element_width is not None and element_height is not None:
            ...
            rest_client.update_progress_of_analysis_using_sso_detection(analysis_run_id, sso_detection_index, 55,
                                                                        "Pressing element's center")
            chromedriver.get(finding_url)
            sleep(10)
            newx = element_x + element_width / 2
            newy = element_y + element_height / 2
            screen = png_helper.draw_circle_at_position(screen, newx, newy, color="orange")

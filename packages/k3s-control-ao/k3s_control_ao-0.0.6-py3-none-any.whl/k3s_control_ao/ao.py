...
repo_info = \
{
    "K3SController":{
        "add_node_label":{
            "args":[["node_infos", True, "node_info", None, True], ["key", False], ["value", False]],
        ...
        "delete_nodes":{
            "args":[["node_infos", True, "node_info", None, True]]
        },
        ...
        "upload_to_oss_from_pod":{
            "args":[["pod_oss_operation_info", True, "PodOSSOperationInfo"]]
        }
    }
}

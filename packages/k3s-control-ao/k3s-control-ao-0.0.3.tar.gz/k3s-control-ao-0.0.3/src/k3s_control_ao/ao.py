...
repo_info = \
{
    "K3SController":{
        "add_node_label":{
            "args":["node_infos", "key", "value"],
            "ret":["command_result", True, None, None, True, True]
        },
        "check_connection":{
            "args":[],
            "ret":["bool", True, None, None, False, True]
        },
        "create_config_maps":{
            "args":["cluster_name", "config_map_user_settings"]
        },
        "create_namespace":{
            "args":["cluster_name", "namespace_name"]
        },
        "create_node":{
        ...
        "create_resource_from_oss":{
            "args":["cluster_name", "target_paths"]
        },
        "create_secrets":{
            "args":["cluster_name", "secret_user_settings"]
        },
        "delete_nodes":{
            "args":["node_infos"]
        },

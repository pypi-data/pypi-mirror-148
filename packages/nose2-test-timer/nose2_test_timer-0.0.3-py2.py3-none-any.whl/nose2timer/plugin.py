...
class TimerPlugin(Plugin):
    ...
    def set_timer_filter(self, value):
        self.timer_filter = value[0]

    def set_threshold(self, value):
        self.threshold = int(value[0])

    def set_timer_warning(self, value):
        self.timer_warning = int(value[0])

    def set_timer_ok(self, value):
        self.timer_ok = int(value[0])
    ...
    def setTestOutcome(self, event):
        ...
        time_taken = self._time_taken()
        if self.threshold is not None and time_taken * 1000.0 > self.threshold:
    ...
    def options(self, env=os.environ):
        ...
        # timer filter
        self.addArgument(
            callback=self.set_timer_filter,
            short_opt='',
        ...
        self.addArgument(
            ...
            short_opt='',
            long_opt="threshold",
            help_text="Fail tests that exceed a threshold seconds",
        )

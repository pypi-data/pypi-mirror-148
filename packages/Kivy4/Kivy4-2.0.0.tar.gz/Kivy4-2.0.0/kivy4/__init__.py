...
class Kivy4(MDApp):
    ...
    def __init__(self, string: str = '', app_name: str = '', dict_of_files: dict = None,
                 ...
                 custom_classes: bool = True, disable_x: bool = False, pre_string: str = '', **kwargs):
        ...
        self.builder_string = pre_string
    ...
    def x_y(x_y):
        ...
        return f"{tabs}pos_hint: {{'center_x': {x}, 'center_y': {y}}}"
    ...
    def snack(text, button_text=None, func=None):
        ...
        if func and button_text:
            snack.buttons = [MDFlatButton(text=f"[color=#1aaaba]{button_text}[/color]",
                                          on_release=func, ), ]

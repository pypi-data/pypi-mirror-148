...
class BodyTerminateAlarmMonitorServicesServiceStagesStageAlarmsAlarmUuidTerminatePost(
    DictSchema
):
    ...
    @classmethod
    @property
    def terminate(cls) -> typing.Type['AlarmTerminate']:
        return AlarmTerminate

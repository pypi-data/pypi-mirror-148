...
class BodyAttachPaymentToProjectBillingAttachPaymentToProjectPost(
    DictSchema
):
    ...
    @classmethod
    @property
    def attachment_details(cls) -> typing.Type['AttachPaymentToProject']:
        return AttachPaymentToProject

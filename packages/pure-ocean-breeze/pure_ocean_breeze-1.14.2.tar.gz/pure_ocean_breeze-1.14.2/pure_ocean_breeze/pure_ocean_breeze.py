...
def indus_name(df,col_name=None):
    names=pd.DataFrame({
        ...
        '801180.SI','801040.SI','801740.SI','801890.SI','801770.SI','801960.SI','801200.SI','801120.SI','801170.SI',
        ...
        '通信','石油石化','商贸零售','食品饮料','交通运输','建筑装饰','汽车','计算机','有色金属','非银金融','医药生物','美容护理',

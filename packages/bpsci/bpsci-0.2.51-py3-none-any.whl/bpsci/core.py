...
class init_anim:
    ...
    Arguments:
    ----------
        :param: `t` :type: `np.ndarray`, contains the time information that corresponds with the six degrees of freedom data 
        :param: `speed_up` :type: `float`, the "real time speed up" or the ratio of the duration of the data to the duration of the animation 
        :param: ` scale` :type: `float`, global physical scale factor of the animation, i.e., .1 will reduce everything to be 1/10th its original size
    """
...
class ref_frame:
    ...
    Arguments:
        :param: `name` :type: `str`, the Blender object name of the reference frame
        :param: `parent` :type: `bpy.data.object`, the Blender object parent of this reference frame 
    ...
    def static_6DOF(self, quat, x, y, z):
        ...
        Arguments:
        ----------
            :param: `quat` :type: `np.ndarray`, an numpy array of one quaternion
            :param: `x` :type: `float`, the x position 
            :param: `y` :type: `float`, the y position 
            :param: `z` :type: `float`, the z position 
    ...
    def dynamic_6DOF(self, quat, x_list, y_list, z_list):
        ...
        Arguments:
        ----------
            :param: `quat` :type: `np.ndarray`, an numpy array of quaternions over time
            :param: `x` :type: `np.ndarray`, the x position over time
            :param: `y` :type: `np.ndarray`, the y position over time
            :param: `z` :type: `np.ndarray`, the z position over time
...
class dyn_obj:
    ...
    Arguments:
    ----------
        :param: `obj: :type` `bpy.data.object`, the Blender object that will be animated
        :param: `pa: :type` `np.ndarray`, the offset of the principal axes specified by the :param: ` euler_type:
        :param: `euler_type` :type: `str`. the Euler angle order (i.e. 'xyz' for 1,2,3 or 'zxz' for 3,1,3)
        :param: `parent` :type: `bpy.data.object`, the Blender object parent of the original object 
        :param: `anim` :class: `bpsci.core.init_anim`, class object that was used to initialize the animation
    ...
    def apply_animation(self, x_list, y_list, z_list, quat_list):
        ...
        Arguments:
            :param: `x_list` :type: `np.ndarray`, a numpy array of the x position over time
            :param: `y_list` :type: `np.ndarray`, a numpy array of the y position over time
            :param: `z_list` :type: `np.ndarray`. a numpy array of the z position over time
            :param: `quat_list` :type: `np.ndarray` or None, a numpy array of the rotational quaternion over time. Can be passed None if rotation is ignored.
            """
    ...
    def apply_streamline(self, staticity, int_x, int_y, int_z, thickness):
        ...
        Arguments:
        ----------
            :param: `staticity` :type: `str`, a string (either 'static' or 'dynamic') that specifies whether the the streamline is animated over time
            :param: `int_x` :type: `np.ndarray`, a numpy array of the x position over time
            :param: `int_y` :type: `np.ndarray`, a numpy array of the y position over time
            :param: `int_z` :type: `np.ndarray`, a numpy array of the z position over time
...
class dyn_vec:
    ...
    Arguments:
    ----------
        :param: `parent` :type: `bpy.data.object`, the Blender object the vector is associated with
        :param: `name` :type: `str`, the Blender object name of the vector ('_vector' will be appended to this name)
        :param: `scale_mag` :type: `float`, the scaling factor of the vector's magnitude axis (purely aesthetic)
        :param: `scale_off` :type: `float`, the scaling factor of the vector's off-axes (purely aesthetic)
        :param: `offset` :type: `tuple`, offset of vector from the parent object (purely aesthetic)
        :param: `anim` :class:`bpsci.core.init_anim`, class object that was used to initialize the animation
    ...
    def animate(self, x, y, z):
        ...
        Arguments:
        ----------
            :param: `x` :type: `np.ndarray`, a numpy array of the x component over time
            :param: `y` :type: `np.ndarray`,  a numpy array of the y component over time
            :param: `z` :type: `np.ndarray`, a numpy array of the z component over time
...
class anim_text:
    ...
    Arguments:
    ----------
        :param: `name` :type: `str`, the Blender object name of the text ('_text' will be appended to this name)
        :param: `parent` :type: `bpy.data.object`, the Blender object parent of this text 
        :param: `anim` :class:`bpsci.core.init_anim`, class object that was used to initialize the animation
        :param: `data` :type: `np.ndarray`, the data to be displayed (same length as the number of animated frames)
        :param: `label` :type: `str`, a label to append to the text (if no label is desired, pass '')

...
from serializers.validation_service import DynamicRequestFieldService
from serializers.validators import CheckConstraintValidator, UniqueTogetherConstraintValidator, \
...
class BaseModelSerializer(EnumSupportSerializerMixin, serializers.ModelSerializer):
    """
            ...
            Also adds dynamic fields to model object, while calling method .save()

            In serializer Meta class specify 'dynamic_request_fields' field, if you want to get
    ...
    def __init__(self, instance=None, data=empty, **kwargs):
        ...
        self.dynamic_request_fields = getattr(self.Meta, 'dynamic_request_fields', {})
    ...
    def save(self, **kwargs):
        ...
        service = DynamicRequestFieldService(self.request, self.dynamic_request_fields)
        for dynamic_request_field in self.dynamic_request_fields:
            kwargs[dynamic_request_field] = service.get_value(dynamic_request_field)
        return super().save(**kwargs)

    def get_validators(self):
        validators = super().get_validators()
        return self.get_constraint_validators() + self.get_request_fields_unique_together_validators() + validators
    ...
    def get_request_fields_unique_together_validators(self):
        """

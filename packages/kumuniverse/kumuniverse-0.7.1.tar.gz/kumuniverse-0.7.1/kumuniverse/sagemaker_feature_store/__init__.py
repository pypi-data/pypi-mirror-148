...
class SagemakerFeatureStore:
    ...
    def create_feature_group(
        ...
        # Set value of enable online store to False if dynamodb not in online store sources list
        if (
            "dynamodb" not in online_store_sources
            and "redis" in online_store_sources
            and enable_online_store
        ):
            enable_online_store_aws = False
        ...
        feature_group.create(
            ...
            role_arn=self.role,
            enable_online_store=enable_online_store_aws,
        )

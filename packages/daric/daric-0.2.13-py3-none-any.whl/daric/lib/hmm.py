...
def runhmm(
    ...
    stateMeans.to_csv(outDir+"/Model_HMM="+str(nStates)+".emission.txt", sep='\t')
    ...
    plt.savefig(outDir+"/"+"Model_HMM="+str(nStates)+"_states.emission.png", dpi=300, bbox_inches = "tight")
    plt.savefig(outDir+"/"+"Model_HMM="+str(nStates)+"_states.emission.svg", dpi=300, bbox_inches = "tight")
    ...
    print(TransMat)
    TransMat.to_csv(outDir+"/Model_states_HMM="+str(nStates)+".transition.txt", sep='\t')
    ...
    plt.savefig(outDir+"/Model_HMM="+str(nStates)+"_states.transition.png", dpi=300, bbox_inches = "tight")
    plt.savefig(outDir+"/Model_HMM="+str(nStates)+"_states.transition.svg", dpi=300, bbox_inches = "tight")
    ...
    for sample in samples:
        ...
        if not os.path.exists(pvalueTrack):
            ...
            command = "cp "+name+"_HMM="+str(nStates)+".Strong+.bed >"+outDir
            os.system(command)
            command = "cp "+name+"_HMM="+str(nStates)+".Strong-.bed >"+outDir
            os.system(command)

    ...
    def dump(self):
        ...
        if "</s>" in xml:
            ...
            for raw_voice_elem in voice_elems:
                ...
                raw_s_elem = raw_s_elem and raw_s_elem.group(1)
                processed_s_elem = raw_s_elem.replace("<s>", "").replace("</s>", "")
                processed_voice_elem = raw_voice_elem.replace(raw_s_elem, processed_s_elem)

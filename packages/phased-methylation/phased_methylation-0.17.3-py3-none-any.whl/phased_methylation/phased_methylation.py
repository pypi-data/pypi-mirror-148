...
from phased_methylation.mean import calculate_mean
...
def parse_arguments():
    ...
    parser_mean = subparsers.add_parser('mean',
        help='calculate average methylation across chromosomes')
    ...
    parser_mean.add_argument('--chromosomes', metavar='<X>', nargs='+',

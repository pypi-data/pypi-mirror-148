...
from statute_serial_number import StatuteID
...
from statute_matcher_regex.__main__ import IndeterminateStatute, StatuteLabel
...
class NamedLaw(NamedTuple):
    ...
    serial: StatuteLabel
    aliases: list[str] = []
    max_year: Optional[int] = None  # TODO possible to limit application dates?
...
class Base(Enum):
    ...
    rules = r"Rules\s+of\s+Court"  # can refer to 2

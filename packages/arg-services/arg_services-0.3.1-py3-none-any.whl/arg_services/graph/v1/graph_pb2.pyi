...
class _SupportEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Support.ValueType], builtins.type):
    ...
    SUPPORT_EVIDENCE_TO_A_HYPOTHESIS: _Support.ValueType  # 32
...
SUPPORT_EVIDENCE_TO_A_HYPOTHESIS: Support.ValueType  # 32
...
class _RephraseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Rephrase.ValueType], builtins.type):
    ...
    REPHRASE_GENERALIZATION: _Rephrase.ValueType  # 1
    REPHRASE_SPECIALIZATION: _Rephrase.ValueType  # 2
...
REPHRASE_GENERALIZATION: Rephrase.ValueType  # 1
REPHRASE_SPECIALIZATION: Rephrase.ValueType  # 2
...
class Graph(google.protobuf.message.Message):
    ...
    class AnalystsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key: typing.Text = ...,
            value: typing.Optional[global___Analyst] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    @property
    def analysts(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Analyst]: ...
    ...
    def __init__(self,
        *,
        ...
        analysts: typing.Optional[typing.Mapping[typing.Text, global___Analyst]] = ...,
        major_claim: typing.Text = ...,
        version: typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analysts",b"analysts","data",b"data","edges",b"edges","major_claim",b"major_claim","meta",b"meta","nodes",b"nodes","participants",b"participants","resources",b"resources","version",b"version"]) -> None: ...
...
class Meta(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analyst",b"analyst","created",b"created","updated",b"updated"]) -> None: ...
global___Meta = Meta
...
class Resource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data","meta",b"meta","timestamp",b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","meta",b"meta","source",b"source","text",b"text","timestamp",b"timestamp","title",b"title"]) -> None: ...
...
class Participant(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data","meta",b"meta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","description",b"description","email",b"email","location",b"location","meta",b"meta","name",b"name","url",b"url","username",b"username"]) -> None: ...
...
class Analyst(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data","meta",b"meta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","email",b"email","meta",b"meta","name",b"name"]) -> None: ...
...
class Edge(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data","meta",b"meta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","meta",b"meta","source",b"source","target",b"target"]) -> None: ...
global___Edge = Edge
...
class Node(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        atom: typing.Optional[global___Atom] = ...,
        scheme: typing.Optional[global___Scheme] = ...,
        meta: typing.Optional[global___Meta] = ...,
        data: typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["atom",b"atom","data",b"data","meta",b"meta","scheme",b"scheme","type",b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["atom",b"atom","data",b"data","meta",b"meta","scheme",b"scheme","type",b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type",b"type"]) -> typing.Optional[typing_extensions.Literal["atom","scheme"]]: ...
global___Node = Node
...
class Scheme(google.protobuf.message.Message):
    ...
    @property
    def premise_descriptors(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        ...
        preference: global___Preference.ValueType = ...,
        rephrase: global___Rephrase.ValueType = ...,
        premise_descriptors: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type",b"type"]) -> typing.Optional[typing_extensions.Literal["support","attack","preference","rephrase"]]: ...

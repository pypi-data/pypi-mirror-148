...
class RetrieveResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["fac_ranking",b"fac_ranking","mac_ranking",b"mac_ranking","ranking",b"ranking"]) -> None: ...

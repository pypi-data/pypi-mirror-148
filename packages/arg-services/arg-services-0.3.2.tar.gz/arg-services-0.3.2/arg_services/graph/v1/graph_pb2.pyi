...
class Graph(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analysts",b"analysts","edges",b"edges","major_claim",b"major_claim","metadata",b"metadata","nodes",b"nodes","participants",b"participants","resources",b"resources","userdata",b"userdata","version",b"version"]) -> None: ...
...
class Analyst(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata",b"metadata","userdata",b"userdata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["email",b"email","metadata",b"metadata","name",b"name","userdata",b"userdata"]) -> None: ...

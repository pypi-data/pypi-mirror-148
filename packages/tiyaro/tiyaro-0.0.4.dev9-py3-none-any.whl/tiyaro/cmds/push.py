...
from ..common.utils import (failed, get_model_endpoint, get_tiyaro_token,
                            success, warn, delete_test_venv)
from ..handler.cli_state import get_model_name_with_suffix
from ..handler.tiyaro_test_state import get_test_state
from ..handler.utils import validate_handler_exists
from ..handler.model_manifest import get_pretrained_file_or_url
...
# before pushing, clear unwanted tiyaro generated artifacts


def clear_tiyaro_generated(is_verbose):
    delete_test_venv(is_verbose)


def do_push(is_verbose):
    clear_tiyaro_generated(is_verbose)

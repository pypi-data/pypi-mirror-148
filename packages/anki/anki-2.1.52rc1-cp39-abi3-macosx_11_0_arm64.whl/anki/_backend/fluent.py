...
class LegacyTranslationEnum:
    ...
    CUSTOM_STUDY_NEW_CARDS_ONLY = (9, 14)
    CUSTOM_STUDY_NO_CARDS_MATCHED_THE_CRITERIA_YOU = (9, 15)
    CUSTOM_STUDY_OK = (9, 16)
    CUSTOM_STUDY_PREVIEW_NEW_CARDS = (9, 17)
    CUSTOM_STUDY_PREVIEW_NEW_CARDS_ADDED_IN_THE = (9, 18)
    CUSTOM_STUDY_REQUIRE_ONE_OR_MORE_OF_THESE = (9, 19)
    CUSTOM_STUDY_REVIEW_AHEAD = (9, 20)
    CUSTOM_STUDY_REVIEW_AHEAD_BY = (9, 21)
    CUSTOM_STUDY_REVIEW_CARDS_FORGOTTEN_IN_LAST = (9, 22)
    CUSTOM_STUDY_REVIEW_FORGOTTEN_CARDS = (9, 23)

        ...
        def get_changelist_instance(self, request):
            ...
            try:
                ...
                if get_filters_result:
                    ...
                    logger.error(f"django_power_admin.enable_list_filter_extra_media.get_changelist_instance.get_filters got NONE filters")
                    filter_specs = []
            except Exception as error:
                logger.exception(f"django_power_admin.enable_list_filter_extra_media.get_changelist_instance.get_filters failed: {error}")
                filter_specs = []

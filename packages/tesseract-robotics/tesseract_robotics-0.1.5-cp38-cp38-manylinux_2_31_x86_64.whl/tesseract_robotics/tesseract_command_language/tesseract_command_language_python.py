...
class Serialization(object, metaclass=_SwigNonDynamicMeta):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    __repr__ = _swig_repr

    def __init__(self):
        _tesseract_command_language_python.Serialization_swiginit(self, _tesseract_command_language_python.new_Serialization())
    __swig_destroy__ = _tesseract_command_language_python.delete_Serialization

# Register Serialization in _tesseract_command_language_python:
_tesseract_command_language_python.Serialization_swigregister(Serialization)
...
def isAnalogInstruction(instruction: "Instruction") -> "bool":
    return _tesseract_command_language_python.isAnalogInstruction(instruction)

def isIOInstruction(instruction: "Instruction") -> "bool":
    return _tesseract_command_language_python.isIOInstruction(instruction)
...
class PlanInstruction(object, metaclass=_SwigNonDynamicMeta):
    ...
    def __init__(self, *args):
        ...
        *Overload 1:*
        ...
        :type manipulator_info: :py:class:`ManipulatorInfo`
...
def getFirstInstruction(*args) -> "tesseract_planning::Instruction *":
    ...
    *Overload 1:*
    ...
    :type locate_filter: tesseract_planning::locateFilterFn
    :param locate_filter: The filter to indicate if an instruction should be considered
    :type process_child_composites: boolean
...
def flatten(*args) -> "std::vector< std::reference_wrapper< tesseract_planning::Instruction const >,std::allocator< std::reference_wrapper< tesseract_planning::Instruction const > > >":
    ...
    *Overload 1:*
    ...
    :type filter: tesseract_planning::flattenFilterFn

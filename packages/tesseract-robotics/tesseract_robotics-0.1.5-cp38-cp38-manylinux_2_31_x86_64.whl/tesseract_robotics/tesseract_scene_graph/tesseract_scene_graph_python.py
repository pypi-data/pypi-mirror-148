...
class Joint(object, metaclass=_SwigNonDynamicMeta):
    ...
    axis = property(_tesseract_scene_graph_python.Joint_axis_get, _tesseract_scene_graph_python.Joint_axis_set, doc=r""" type_       meaning of axis_ ------------------------------------------------------            UNKNOWN     unknown type            REVOLUTE    rotation axis            PRISMATIC   translation axis            FLOATING    N/A            PLANAR      plane normal axis            FIXED       N/A""")
    child_link_name = property(_tesseract_scene_graph_python.Joint_child_link_name_get, _tesseract_scene_graph_python.Joint_child_link_name_set, doc=r""" child Link element   child link frame is the same as the Joint frame""")
    parent_link_name = property(_tesseract_scene_graph_python.Joint_parent_link_name_get, _tesseract_scene_graph_python.Joint_parent_link_name_set, doc=r""" parent Link element   origin specifies the transform from Parent Link to Joint Frame""")

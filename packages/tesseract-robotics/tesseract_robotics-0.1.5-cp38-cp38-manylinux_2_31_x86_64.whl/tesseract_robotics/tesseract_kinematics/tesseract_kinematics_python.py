...
class KinematicsPluginFactory(object, metaclass=_SwigNonDynamicMeta):
    ...
    @staticmethod
    def setGlobalCreateFwdKinFactoryCallback(fn: "tesseract_kinematics::CreateFwdKinFactoryCallbackFn const &") -> "void":
        r"""
        Set a global FwdKin factory create callback

        Callback function is called before plugins to allow explicit
        factory allocation

        :type fn: tesseract_kinematics::CreateFwdKinFactoryCallbackFn
        :param fn: FwdKin create callback function
        """
        return _tesseract_kinematics_python.KinematicsPluginFactory_setGlobalCreateFwdKinFactoryCallback(fn)

    @staticmethod
    def clearGlobalCreateFwdKinFactoryCallback() -> "void":
        r"""Clear the global FwdKin factory create callback"""
        return _tesseract_kinematics_python.KinematicsPluginFactory_clearGlobalCreateFwdKinFactoryCallback()

    @staticmethod
    def setGlobalCreateInvKinFactoryCallback(fn: "tesseract_kinematics::CreateInvKinFactoryCallbackFn const &") -> "void":
        r"""
        Set a global InvKin factory create callback

        Callback function is called before plugins to allow explicit
        factory allocation

        :type fn: tesseract_kinematics::CreateInvKinFactoryCallbackFn
        :param fn: InvKin factory create callback function
        """
        return _tesseract_kinematics_python.KinematicsPluginFactory_setGlobalCreateInvKinFactoryCallback(fn)

    @staticmethod
    def clearGlobalCreateInvKinFactoryCallback() -> "void":
        r"""Clear the global InvKin create callback"""
        return _tesseract_kinematics_python.KinematicsPluginFactory_clearGlobalCreateInvKinFactoryCallback()
...
def KinematicsPluginFactory_setGlobalCreateFwdKinFactoryCallback(fn: "tesseract_kinematics::CreateFwdKinFactoryCallbackFn const &") -> "void":
    r"""
    Set a global FwdKin factory create callback
...
def KinematicsPluginFactory_clearGlobalCreateFwdKinFactoryCallback() -> "void":
    r"""Clear the global FwdKin factory create callback"""
    return _tesseract_kinematics_python.KinematicsPluginFactory_clearGlobalCreateFwdKinFactoryCallback()

def KinematicsPluginFactory_setGlobalCreateInvKinFactoryCallback(fn: "tesseract_kinematics::CreateInvKinFactoryCallbackFn const &") -> "void":
    r"""
    Set a global InvKin factory create callback
...
def KinematicsPluginFactory_clearGlobalCreateInvKinFactoryCallback() -> "void":
    r"""Clear the global InvKin create callback"""
    return _tesseract_kinematics_python.KinematicsPluginFactory_clearGlobalCreateInvKinFactoryCallback()

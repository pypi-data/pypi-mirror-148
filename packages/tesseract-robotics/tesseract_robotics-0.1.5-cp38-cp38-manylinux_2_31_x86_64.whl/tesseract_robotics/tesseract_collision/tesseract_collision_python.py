...
class ContactManagersPluginFactory(object, metaclass=_SwigNonDynamicMeta):
    ...
    @staticmethod
    def setGlobalCreateDiscreteContactManagerFactoryCallback(fn: "tesseract_collision::CreateDiscreteContactManagerFactoryCallbackFn const &") -> "void":
        r"""
        Set a global discrete contact manager factory create callback

        Callback function is called before plugins to allow explicit
        allocation of contact manager factory

        :type fn: tesseract_collision::CreateDiscreteContactManagerFactoryCallbackFn
        :param fn: Contact manager factory create callback function
        """
        return _tesseract_collision_python.ContactManagersPluginFactory_setGlobalCreateDiscreteContactManagerFactoryCallback(fn)

    @staticmethod
    def clearGlobalCreateDiscreteContactManagerFactoryCallback() -> "void":
        r"""Clear the global discrete contact manager factory create callback"""
        return _tesseract_collision_python.ContactManagersPluginFactory_clearGlobalCreateDiscreteContactManagerFactoryCallback()

    @staticmethod
    def setGlobalCreateContinuousContactManagerFactoryCallback(fn: "tesseract_collision::CreateContinuousContactManagerFactoryCallbackFn const &") -> "void":
        r"""
        Set a global continuous contact manager factory create callback

        Callback function is called before plugins to allow explicit
        allocation of contact manager factory

        :type fn: tesseract_collision::CreateContinuousContactManagerFactoryCallbackFn
        :param fn: Contact manager create factory callback function
        """
        return _tesseract_collision_python.ContactManagersPluginFactory_setGlobalCreateContinuousContactManagerFactoryCallback(fn)

    @staticmethod
    def clearGlobalCreateContinuousContactManagerFactoryCallback() -> "void":
        r"""Clear the global continuous contact manager create factory callback"""
        return _tesseract_collision_python.ContactManagersPluginFactory_clearGlobalCreateContinuousContactManagerFactoryCallback()
...
def ContactManagersPluginFactory_setGlobalCreateDiscreteContactManagerFactoryCallback(fn: "tesseract_collision::CreateDiscreteContactManagerFactoryCallbackFn const &") -> "void":
    r"""
    Set a global discrete contact manager factory create callback
...
def ContactManagersPluginFactory_clearGlobalCreateDiscreteContactManagerFactoryCallback() -> "void":
    r"""Clear the global discrete contact manager factory create callback"""
    return _tesseract_collision_python.ContactManagersPluginFactory_clearGlobalCreateDiscreteContactManagerFactoryCallback()

def ContactManagersPluginFactory_setGlobalCreateContinuousContactManagerFactoryCallback(fn: "tesseract_collision::CreateContinuousContactManagerFactoryCallbackFn const &") -> "void":
    r"""
    Set a global continuous contact manager factory create callback
...
def ContactManagersPluginFactory_clearGlobalCreateContinuousContactManagerFactoryCallback() -> "void":
    r"""Clear the global continuous contact manager create factory callback"""
    return _tesseract_collision_python.ContactManagersPluginFactory_clearGlobalCreateContinuousContactManagerFactoryCallback()

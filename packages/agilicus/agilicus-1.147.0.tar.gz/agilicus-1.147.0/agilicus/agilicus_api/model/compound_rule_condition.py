...
class CompoundRuleCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition_list, list_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            condition_type (str): The discriminator for the condition. defaults to "compound_rule_condition"  # noqa: E501
        ...
        condition_type = kwargs.get('condition_type', "compound_rule_condition")
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition_list, list_type, *args, **kwargs):  # noqa: E501
        """CompoundRuleCondition - a model defined in OpenAPI

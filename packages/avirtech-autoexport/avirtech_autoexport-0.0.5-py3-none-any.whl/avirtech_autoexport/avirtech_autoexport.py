...
class autoexport:
    ...
    def run_process():
        location = "C:\\Users\\Dell\\Documents\\Avirtech\\Avirkey"
        ...
        if os.path.isdir(location):
            for file in os.listdir(location):
                if file.find(substring) != -1:
                    ...
                    config.read("C:\\Users\\Dell\\Documents\\Avirtech\\Avirkey\\avirkey.ini")
                    ...
                    Metashape.app.messageBox("Cannot Run The Script, Please install avirkey first, then generate your serial number and then run this script again")
        else:
            Metashape.app.messageBox("Cannot Run The Script, Please install avirkey first, then generate your serial number and then run this script again")
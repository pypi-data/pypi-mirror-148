...
class autoexport:
    ...
    def run_process():
        location = os.path.expanduser('~/Documents/Avirtech/Avirkey')
        substring = "Avirkey.ini"
            ...
            if len(os.listdir(location) ) == 1:
                for file in os.listdir(location):
                    if file.find(substring) != -1:
                        ...
                        Metashape.app.messageBox("Please register your serial number on avirkey first!")

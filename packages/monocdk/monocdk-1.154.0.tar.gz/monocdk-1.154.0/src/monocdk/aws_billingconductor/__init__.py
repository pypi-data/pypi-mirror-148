...
class CfnBillingGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        account_grouping: typing.Union["CfnBillingGroup.AccountGroupingProperty", _IResolvable_a771d0ef],
        computation_preference: typing.Union["CfnBillingGroup.ComputationPreferenceProperty", _IResolvable_a771d0ef],
        name: builtins.str,
...
class CfnCustomLineItem(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        billing_period_range: typing.Optional[typing.Union["CfnCustomLineItem.BillingPeriodRangeProperty", _IResolvable_a771d0ef]] = None,
        custom_line_item_charge_details: typing.Optional[typing.Union["CfnCustomLineItem.CustomLineItemChargeDetailsProperty", _IResolvable_a771d0ef]] = None,
        description: typing.Optional[builtins.str] = None,
    ) -> None:
    ...
    class CustomLineItemChargeDetailsProperty:
        def __init__(
            ...
            *,
            type: builtins.str,
            flat: typing.Optional[typing.Union["CfnCustomLineItem.CustomLineItemFlatChargeDetailsProperty", _IResolvable_a771d0ef]] = None,
            percentage: typing.Optional[typing.Union["CfnCustomLineItem.CustomLineItemPercentageChargeDetailsProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''

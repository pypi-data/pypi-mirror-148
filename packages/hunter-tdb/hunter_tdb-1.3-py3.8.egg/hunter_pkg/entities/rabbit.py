...
class Rabbit(base_entity.IntelligentEntity):
    def __init__(self, engine, x: int, y: int):
        ...
        self.alive = True
        self.asleep = False
        self.max_health = stats.get("rabbit.max-health")
        self.curr_health = stats.get("rabbit.starting-health")
        self.nutritional_value = stats.get("rabbit.nutritional-value")
        self.vision_distance = stats.get("rabbit.vision-distance")
        self.recent_actions = []
        self.burrow = None
        self.hidden = False

    def is_hungry(self):
        return rng.rand() < stats.get("rabbit.hunger-chance")
    ...
    def consume(self):
        ...
        self.engine.renderer.redraw_tile(self.x, self.y)
...
class RabbitAI():
    def __init__(self, rabbit):
        ...
        self.default_cooldown = stats.get("rabbit.action-cooldowns.default")
    ...
    def roam(self):
        ...
        dist = stats.get("rabbit.roam-distance")
...
class MovementAction():
    def __init__(self, rabbit, dest, path=None, final_action=None):
        ...
        self.cooldown = stats.get("rabbit.action-cooldowns.movement-action")
...
class GrazeAction():
    def __init__(self, rabbit):
        self.rabbit = rabbit
        self.cooldown = stats.get("rabbit.action-cooldowns.graze-action")
...
class SleepAction():
    ...
    def perform(self):
        sleep_in = rng.rand() < stats.get("rabbit.sleep-in-chance")

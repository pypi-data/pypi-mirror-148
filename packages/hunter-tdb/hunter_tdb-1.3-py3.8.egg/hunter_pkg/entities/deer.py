...
class Deer(base_entity.IntelligentEntity):
    def __init__(self, engine, x: int, y: int):
        ...
        self.alive = True
        self.asleep = False
        self.max_health = stats.get("deer.max-health")
        self.curr_health = stats.get("deer.starting-health")
        self.nutritional_value = stats.get("deer.nutritional-value")
        self.vision_distance = stats.get("deer.vision-distance")
        self.roam_distance = stats.get("deer.roam-distance")
        self.attack_damage = stats.get("deer.attack-damage")
        self.stop_pursuit_chance = stats.get("deer.stop-pursuit-chance")
        self.attacked = None
        self.recent_actions = []
        self.hidden = False

    def is_hungry(self):
        return rng.rand() < stats.get("deer.hunger-chance")
...
class Buck(Deer):
    def __init__(self, engine, x, y):
        ...
        self.aggro_chance = stats.get("deer.aggro-chance")
        self.herd_aggro_chance = stats.get("deer.herd-aggro-chance")
...
class Doe(Deer):
    def __init__(self, engine, x, y, buck):
        ...
        self.roam_distance = stats.get("doe.roam-distance")
        self.attack_damage = stats.get("doe.attack-damage")
        self.aggro_chance = stats.get("doe.aggro-chance")
...
class DeerAI():
    def __init__(self, deer):
        ...
        self.default_cooldown = stats.get("deer.action-cooldowns.default")
...
class DoeAI(DeerAI):
    def __init__(self, doe, buck):
        self.doe = doe
        self.buck = buck
        self.leash = stats.get("doe.leash")
        super().__init__(doe)
...
class MovementAction():
    def __init__(self, deer, dest, path=None):
        ...
        self.dest = dest
        self.path = path
        self.cooldown = stats.get("deer.action-cooldowns.movement-action")
...
class PursueAction():
    def __init__(self, deer, target):
        self.deer = deer
        self.target = target
        self.cooldown = stats.get("deer.action-cooldowns.pursue-action")
...
class FleeAction():
    def __init__(self, deer, threat, path=None):
        ...
        self.threat = threat
        self.path = path
        self.cooldown = stats.get("deer.action-cooldowns.flee-action")
        self.flee_search_attempts = stats.get("deer.flee-search-attempts")
        self.flee_jitter_multiplier = stats.get("deer.flee-jitter-multiplier")
...
class ScanForThreatsAction(enta.SearchAreaActionBase):
    def __init__(self, deer, path=None):
        ...
        self.cooldown = stats.get("deer.action-cooldowns.scan-for-threats-action")
...
class AttackAction():
    def __init__(self, deer, target):
        self.deer = deer
        self.target = target
        self.cooldown = stats.get("deer.action-cooldowns.attack-action")
...
class GrazeAction():
    def __init__(self, deer):
        self.deer = deer
        self.cooldown = stats.get("deer.action-cooldowns.graze-action")
...
class SleepAction():
    ...
    def perform(self):
        sleep_in = rng.rand() < stats.get("deer.sleep-in-chance")

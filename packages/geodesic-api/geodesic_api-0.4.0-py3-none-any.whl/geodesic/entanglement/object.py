...
from geodesic.descriptors import DictDescr, GeometryDescr, RegexDescr, StringDescr, TypeConstrainedDescr
...
def delete_objects(objects_or_uids: list, project: Union[str, Project] = None):
    ...
    for obj in objects_or_uids:
        o = Object(**obj)
        objects_by_project[o.project.name].append(o.uid)
...
class Object(APIObject, metaclass=ObjectResolver):
    ...
    name = RegexDescr(regex=dataset_re, doc="the name of this object, unique to the project")
    object_class = RegexDescr(
        regex=text_re,
        doc="the class of this object (e.g. Observable, Entity, Dataset...)",
        dict_name="class")
    domain = RegexDescr(regex=text_re, default="*", doc="the domain of this object")
    category = RegexDescr(regex=text_re, default="*", doc="the category of this object")
    type = RegexDescr(regex=text_re, default="*", doc="the type of this object")
    ...
    def create(self):
        ...
        res = raise_on_error(self._client.post("objects", project=self.project.name, **body))
    ...
    def save(self):
        ...
        raise_on_error(self._client.post("objects", project=self.project.name, **body))
    ...
    def load(self, uid=None) -> Any:
        ...
        res = raise_on_error(self._client.get(f"objects/{uid}", project=self.project.name))
    ...
    def delete(self):
        ...
        raise_on_error(self._client.delete("objects", **{'uids': ','.join([uid]), 'project': self.project.name}))
...
class Predicate(APIObject):
    ...
    name = RegexDescr(regex=text_re, doc="the name of this predicate, describes the relationship very briefly")
    domain = RegexDescr(regex=text_re, doc="the domain of this predicate", default="*")
    category = RegexDescr(regex=text_re, doc="the category of this predicate", default="*")
    type = RegexDescr(regex=text_re, doc="the type of this predicate", default="*")
...
class Connection(APIObject):
    ...
    subject = TypeConstrainedDescr(Object, doc="the subject of this connection")
    predicate = TypeConstrainedDescr(Predicate, doc="the predicate of this connection")
    object = TypeConstrainedDescr(Object, doc="the object of this connection")

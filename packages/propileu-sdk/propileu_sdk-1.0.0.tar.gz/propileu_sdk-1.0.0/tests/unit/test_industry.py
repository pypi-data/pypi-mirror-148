...
class IndustryTest(TestCase):
    ...
    def test_get_a_industry(self):
        industry_mock = {
            ...
            "name": "JSM",
            "external_link": "www.juntossomosmais.com.br",
        }
        ...
        with requests_mock.Mocker() as m:
            ...
            self.assertEqual(industry.external_link, "www.juntossomosmais.com.br")
    ...
    def test_filter_products_industry(self):
        json_mock = {
            ...
            "results": [
                ...
                {"id": "158cf2e5-e7d4-43c2-8f6e-3de3baf6806f", "name": "Stam", "external_link": "www.stam.com.br"},
                {"id": "b7fe9637-6931-4b98-bdca-05739c50544a", "name": "Gerdau", "external_link": "www.gerdau.com.br"},
            ],
        }
        ...
        with requests_mock.Mocker() as m:
            ...
            self.assertEqual(model_rslt[0].external_link, "www.juntossomosmais.com.br")

            self.assertEqual(model_rslt[1].id, "158cf2e5-e7d4-43c2-8f6e-3de3baf6806f")
            self.assertEqual(model_rslt[1].name, "Stam")
            self.assertEqual(model_rslt[1].external_link, "www.stam.com.br")

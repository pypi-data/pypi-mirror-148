...
from predictionplatforms import CANDLE_GENIE_ADDRESS, CANDLE_GENIE_ABI
from predictionplatforms import DOGE_BETS_ABI, DOGE_BETS_ADDRESS
from predictionplatforms.abis import PANCAKE_ADDRESS, PANCAKESWAP_ABI

...
class CfnFirewall(
    ...
    def __init__(
        ...
        *,
        ...
        subnet_mappings: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union["CfnFirewall.SubnetMappingProperty", aws_cdk.core.IResolvable]]],
        vpc_id: builtins.str,
...
class CfnFirewallPolicy(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        firewall_policy: typing.Union[aws_cdk.core.IResolvable, "CfnFirewallPolicy.FirewallPolicyProperty"],

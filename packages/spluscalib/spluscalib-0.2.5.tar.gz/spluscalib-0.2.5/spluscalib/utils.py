...
def download_vizier_catalog_for_splus_field(vizier_catalog_id, columns,
                                            splus_image = None, fieldID_catalog = None,
                                            column_filters = None, pixscale = 0.55):
    """
...
def sexcatalog_apply_calibration(catalog_file, zp_file, save_file,
    ...
    if calibration_name is not None:
        ...
        cat.append(fits.Column(name=f"CALIB_STRATEGY",
                               format=f'{N_str}A',
...
def sexcatalog_detection(detection_file, save_file, field,
    ...
    # Add FLUX_RADIUS
    for j in range(det_cat.columns['FLUX_RADIUS'].array.shape[1]):
        cat.append(fits.Column(name=f'FLUX_RADIUS_id{j}',
                               format='1E',
    ...
    cat.append(fits.Column(name='s2n_AUTO_DET',
                           format='1E',
    ...
    cat.append(fits.Column(name='s2n_PETRO_DET',
                           format='1E',
    ...
    cat.append(fits.Column(name='s2n_ISO_DET',
                           format='1E',
    ...
    cat.append(fits.Column(name='s2n_APER_3_DET',
                           format='1E',
    ...
    cat.append(fits.Column(name='s2n_APER_6_DET',
                           format='1E',
                           array=col_s2n_aper_6))

    cat.append(fits.Column(name='s2n_PStotal_DET',
                           format='1E',
                           array=col_s2n_aper_3))
...
def sexcatalog_apply_calibration_aper(catalog_file, zp_file, save_file,
    ...
    # FIELD ID
    cat.append(phot_cat.columns[f'FIELD_ID'])
    cat.append(phot_cat.columns[f'FIELD_ID_RA'])
    cat.append(phot_cat.columns[f'FIELD_ID_DEC'])

...
try:
    ...
    since we rely on the package version as specified through poetry/pyproject.toml
    This should only occur during development where the build is not "installed"
    """
    __version__ = None

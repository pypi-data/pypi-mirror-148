...
def parser_input():
    ...
    parser.add_argument('-fsys', action="store", dest="f_sys",
                        help='Input PDB file of the system')
    parser.add_argument('-psys', action="store", dest="p_sys",
                        help='Topologie in gromacs format .top of the system')
    parser.add_argument('-fmol', action="store", dest="f_mol",
                        help='Input PDB file of the molecule to insert')
    parser.add_argument('-pmol', action="store", dest="p_mol",
                        help='Topologie in gromacs format .top of the '
                        'molecule to insert')
    parser.add_argument('-nmol', action="store", dest="num_mol",

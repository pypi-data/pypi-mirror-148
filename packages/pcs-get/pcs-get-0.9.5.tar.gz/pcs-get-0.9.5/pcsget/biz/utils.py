...
def detect_package():
    ...
    :rtype str
    """
    # /Users/garen/repo/bigolive_android/iHeima/pcsget/main/java/sg/bigo/base/ext
    path = os.path.abspath(".")
    sep = os.path.sep
    pattern = '''.*%ssrc%s.*%sjava%s(.*)''' % (sep, sep, sep, sep)
...
def save_code_file(path, name, source, package, extension):
    ...
    with open(f_name, 'w') as fp:
        fp.write(content)
    i(name + "." + extension + " update-to-date")

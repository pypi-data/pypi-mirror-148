...
function GetOciSubcommands_rover() {
    $ociSubcommands = @{
        'rover' = 'node shape standalone-cluster station-cluster'
...
function GetOciCommandsToLongParams_rover() {
    $ociCommandsToLongParams = @{
        ...
        'rover node create' = 'address1 address2 address3 address4 addressee care-of city-or-locality compartment-id country defined-tags display-name email enclosure-type freeform-tags from-json help lifecycle-state lifecycle-state-details master-key-id max-wait-seconds phone-number point-of-contact point-of-contact-phone-number setup-identity shape shipping-preference state-province-region system-tags time-return-window-ends time-return-window-starts wait-for-state wait-interval-seconds zip-postal-code'
        ...
        'rover standalone-cluster add-workload' = 'bucket-id bucket-name cluster-id compartment-id force from-json help image-id prefix range-end range-start type'
        'rover standalone-cluster change-compartment' = 'cluster-id compartment-id from-json help if-match'
        'rover standalone-cluster create' = 'address1 address2 address3 address4 addressee care-of city-or-locality cluster-size cluster-type compartment-id country defined-tags display-name email enclosure-type freeform-tags from-json help lifecycle-state lifecycle-state-details master-key-id max-wait-seconds phone-number point-of-contact point-of-contact-phone-number shipping-preference state-province-region subscription-id system-tags wait-for-state wait-interval-seconds zip-postal-code'
        ...
        'rover station-cluster add-workload' = 'bucket-id bucket-name cluster-id compartment-id force from-json help image-id prefix range-end range-start type'
...
function GetOciCommandsToShortParams_rover() {
    $ociCommandsToShortParams = @{
        ...
        'rover standalone-cluster add-workload' = '? c h'
        ...
        'rover station-cluster add-workload' = '? c h'

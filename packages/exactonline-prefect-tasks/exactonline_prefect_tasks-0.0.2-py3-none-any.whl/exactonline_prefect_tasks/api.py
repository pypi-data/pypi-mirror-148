...
class Api:
    ...
    def __init__(self):
        try:
            self.aws_config = read_config('/Users/carlospaiva/Development/Apora/exactonline_prefect_tasks/tests/'
                                          'config/.credentials/aws-configuration.ini')
            ...
            self.aws_secretsmanager_secret_name = os.getenv('AWS_SM_EXACT_ONLINE_SECRET_NAME') 'aplynk-prefect-core/gsd-trading/eol'

...
class Spherical(NoneAttribute):
    ...
    def set( self, radius, phi, theta ) -> 'Spherical':
        self.radius = radius
        self.phi = phi
        self.theta = theta
    ...
    def copy( self, other:'Spherical' ) -> 'Spherical':
    ...
    def setFromVector3(self, v: "three.Vector3") -> "Spherical":
        return self.setFromCartesianCoords(v.x, v.y, v.z)

    def setFromCartesianCoords(self, x: float, y: float, z: float) -> "Spherical":

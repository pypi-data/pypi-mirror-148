# * This will be a python's library to generate a spanish random name and surname

# We'll need import the library
# BEFORE pip3 install pandas
import pandas as pd
...
# print(getRandomFemaleName(2, True))
# print(getRandomSurname(1, True))

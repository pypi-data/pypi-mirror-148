...
CDR_ENDPOINT=os.environ.get('FC_ENDPOINT', 'https://dev.freeclimb.com/apiserver')
CDR_ACCOUNT_ID=os.environ.get('CDR_ACCOUNT_ID', None)
CDR_ACCOUNT_TOKEN=os.environ.get('CDR_ACCOUNT_TOKEN', None)
...
OPERATORS_IND = {RsiOperator.__name__: RsiOperator,
                 ...
                 HistoricalReturnOperator.__name__: HistoricalReturnOperator
                 # todo: not sure
                 # CandleStickOperators.__name__: CandleStickOperators
                 }

OPERATORS_RET = {HistoricalReturnOperator.__name__: HistoricalReturnOperator}

OPERATORS_FWD = {ForwardReturnOperator.__name__: ForwardReturnOperator,

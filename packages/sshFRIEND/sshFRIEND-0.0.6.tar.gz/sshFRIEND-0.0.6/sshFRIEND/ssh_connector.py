...
def send_cmd(cmd, channel, incoming_sleep_time=1, out_going_sleep_time=1):
...
def send_config_cmd(cmd, channel, incoming_sleep_time=1, out_going_sleep_time=1):
...
def send_cmds(list_of_commands, channel, incoming_sleep_time=1, out_going_sleep_time=1):
...
def send_config_cmds(list_of_commands, channel, incoming_sleep_time=1, out_going_sleep_time=1):

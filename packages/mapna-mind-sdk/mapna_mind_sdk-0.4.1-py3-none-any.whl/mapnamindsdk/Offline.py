...
class Offline(Mind):
    ...
    @staticmethod
    def getValue(plantName, signalNames, startDate, endDate, aggregation, interval, pageNumber=1, pageSize=100000000):
        jsonResult = None
        ...
        try:
            ...
            if interval == 'SECOND':
                ...
                body["signalNames"] = signal_str
                body["units"] = units_str
                path = '/data/getData'

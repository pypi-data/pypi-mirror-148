...
class HistoricalFeatures:
    """Compute historical features.
        ...
        ----------
        name : str
            The name of the features computed by HistoricalFeatures class.
        ...
        HistoricalFeatures as follows:

        >>> histFeats = HistoricalFeatures([('amount', 'amount_min_1D_userID')])

...
from .fe_base.historical_features import HistoricalFeatures
...
class DifferenceFeatTransformer(TransformerMixin, BaseEstimator):
    ...
    Please refer to the :class:`~preprocessing.fe_base.historical_features.HistoricalFeatures`
    class for basic examples.

    This is a Scikit-learn compatible Wrapper of the
    :class:`~preprocessing.fe_base.historical_features.HistoricalFeatures` class,
    ...
    def fit(self, X, y=None):
        ...
        self.histfeat_obj = HistoricalFeatures([(self.first_col, self.second_col)])
    ...
    def transform(self, X):
        ...
        df, new_cols_names = self.histfeat_obj.build_features(df)

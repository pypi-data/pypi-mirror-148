...
if __name__ == '__main__':     #enclosing required because of multiprocessing
    ...
    dict_Materials["ZrO2_mono"] = ["ZrO2_mono", [5.1471,  5.2125, 5.3129, 90, 99.23, 90], "14"]
    dict_Materials["ZrO2_tet"] = ["ZrO2_tet", [3.64,  3.64, 5.27, 90, 90, 90], "137"]
    dict_Materials["ZrO2_cub"] = ["ZrO2_cub", [4.625,  4.625, 4.625, 90, 90, 90], "225"]
    dict_Materials["Zr_alpha"] = ["Zr_alpha", [3.23,  3.23, 5.15, 90, 90, 120], "194"]
    dict_Materials["Zr_beta"] = ["Zr_beta", [3.62,  3.62, 3.62, 90, 90, 90], "229"]
    dict_Materials["Nb_beta"] = ["Nb_beta", [3.585,  3.585, 3.585, 90, 90, 90], "229"]
    dict_Materials["Zr_Nb_Fe"] = ["Zr_Nb_Fe", [4.879,  4.879, 7.992, 90, 90, 120], "194"]
    dict_Materials["Cr"] = ["Cr", [2.87,  2.87, 2.87, 90, 90, 90], "229"]
    dict_Materials["C14"] = ["C14", [5.05,  5.05, 8.24, 90, 90, 120], "194"]
    dict_Materials["C15"] = ["C15", [7.15,  7.15, 7.15, 90, 90, 90], "227"]
    
    extinction_json["14"] = "14"
    extinction_json["137"] = "137"
    extinction_json["225"] = "225"
    extinction_json["194"] = "194"
    ...
    ### Configuration for Guillou experiments
    ZrCr_irrad_wo_Nb = {
                        # =============================================================================
    ...
    try:
        from lauetoolsnn.utils_lauenn import generate_classHKL, generate_multimat_dataset, \
                                        ...
                                        array_generator, array_generator_verify, vali_array, LoggingCallback
    except:

...
- 如果您想在手机端或者3.7以下2.9以上版本使用该脚本，那么请下载0.0.42版本,如果下面的教程看不懂的话，可以点开下面的链接，链接里的就是各个操作系统测试时的截图
```
pip install get-music-lizhanqi==0.0.42    ##专门为移动端和python低版本的发行版
```
...
## 更新记录
- 2022-04-27 完成v0.0.42版，修复v0.0.28的搜索bug，支持python2.9版本及以上

...
class SmartDrift:
    ...
    def compile(
        ...
        self.historical_auc = self._histo_auc(datadrift_file=self.datadrift_file, date_compile_auc=date_compile_auc)
        self.data_modeldrift = None
    ...
    def _histo_auc(self, datadrift_file=None, date_compile_auc=None):
        """

...
class TestDriftReport(unittest.TestCase):
    ...
    def test_get_values_and_name_1(self):
        """
        test _get_values_and_name() method
        """
        report = self.report
        values, name = report._get_values_and_name(None, "target")
        assert values is None
        assert name is None

    def test_get_values_and_name_2(self):
        """
        test _get_values_and_name() method
        """
        report = self.report
        y = pd.DataFrame({"test": [1, 2, 1], "test_2": [1, 2, 1]})

        with self.assertRaises(AssertionError):
            report._get_values_and_name(y, "target")

    def test_get_values_and_name_3(self):
        """
        test _get_values_and_name() method
        """
        report = self.report
    ...
    def test_display_title_description_1(self):
        """
        Test display_title_description() method of DriftReport
        """
        self.report.display_title_description()

    def test_display_title_description_2(self):
        """
        Test display_title_description() method of DriftReport
        """
        report = self.report
        report.title_description = "Test"

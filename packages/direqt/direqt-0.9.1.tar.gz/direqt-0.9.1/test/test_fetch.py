    ...
    def custom_url_shortener(url):
        return 'https://ex.co/short/url'[
        {
            ...
            'response': {
                ...
                'properties': {
                    'follow_on_action': 'imihook:333',
                    'do_optout_check': 'false',
                    'preferredCardLocation': '1',
                    'offer_category': 'Category-1'
                }
            }
        },
        {
            ...
            'response': {
                'isTest': False,
                'payload': {
                    'mediaUrl': 'http://example.com/test2.jpg',
                ...
                'properties': {
                    'follow_on_action': 'imihook:333',
                    'do_optout_check': 'false',
                    'preferredCardLocation': '2',
                    'offer_category': 'Category-2'
                }
            }
        }
    ]

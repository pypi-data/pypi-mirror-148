...
SWITCHPORT_ALLOW_VLAN = CommandTemplate(
    "switchport [trunk allowed-vlan add{port_mode_trunk}] [access{port_mode_access} vlan] "  # noqa: E501
    "{vlan_range}",
    action_map=ACTION_MAP,
    error_map=ERROR_MAP_ALL,
)

SWITCHPORT_ALLOW_TRUNK_VLAN = CommandTemplate(
    "switchport [trunk allowed-vlan{port_mode_trunk}] [access{port_mode_access} vlan] "
    "{vlan_range}",
    action_map=ACTION_MAP,
    error_map=ERROR_MAP_ALL,
)

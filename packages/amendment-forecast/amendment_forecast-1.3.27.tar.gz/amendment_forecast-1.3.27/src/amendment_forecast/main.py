...
def run_forecast_ensemble(
    ...
    predicted_values_exist_mask = ~return_dataframe["predicted_values_Ensemble"].isnull()
    actual_values_exist_mask = ~return_dataframe["predicted_values_Ensemble"].isnull()
    ensemble_train_df = return_dataframe[predicted_values_exist_mask & actual_values_exist_mask]

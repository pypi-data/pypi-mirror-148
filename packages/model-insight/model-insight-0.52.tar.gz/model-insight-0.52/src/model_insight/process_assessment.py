...
def process_assess(file_path=False):
    ...
    description = {'姓名':'请输入学生的 \U0001F466 姓名 \U0001F467 \n',
               ...
               '写作':'写作内容的等级(10-基础学术论文, \n 3-通用建模论文, \n 5-特定模型论文(51评价、52优化、53变化、54预测、55解释、56模拟、57其他)) \n', 
               '合作':'合作人数 \n', 
               '分析内容':'简要描述 \U0001F440 分析内容 \U0001F400 \n', 
               '分析总成就':'分析总成就(0-5) \n',
    ...
    if file_path == False:
        ...
        try:
            data0 = pd.read_excel(file_path)
            data1 = data_0.append(df,ignore_index=True)
            return data1
        except:
            return df
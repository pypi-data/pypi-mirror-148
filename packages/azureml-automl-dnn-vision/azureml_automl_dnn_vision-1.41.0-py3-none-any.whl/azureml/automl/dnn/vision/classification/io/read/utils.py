...
def read_aml_dataset(dataset, validation_dataset, split_ratio, multilabel, output_dir, master_process,
                     ignore_data_errors):
    ...
    train_dataset_wrapper = AmlDatasetWrapper(dataset, multilabel=multilabel,

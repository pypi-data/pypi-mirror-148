...
from nlu_bf.core.training.dsl import UserUttered
from nlu_bf.core.training.dsl import ActionExecuted
from nlu_bf.core.constants import UTTER_PREFIX
import nlu_bf.core.training.story_conflict
from nlu_bf.constants import DOCS_URL_DOMAINS, DOCS_URL_ACTIONS
...
class Validator:
    ...
    def verify_story_structure(
        ...
        conflicts = nlu_bf.core.training.story_conflict.find_story_conflicts(

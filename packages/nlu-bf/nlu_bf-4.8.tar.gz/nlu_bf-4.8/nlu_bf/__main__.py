...
from nlu_bf.cli.arguments.default_arguments import add_logging_options
from nlu_bf.cli.utils import parse_last_positional_argument_as_model_path
from nlu_bf.utils.common import set_log_level
import nlu_bf.utils.tensorflow.environment as tf_env
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        "your own conversational assistants 🤖. The 'nlu_bf' command "
...
def main() -> None:
    ...
    if hasattr(cmdline_arguments, "func"):
        nlu_bf.utils.io.configure_colored_logging(log_level)

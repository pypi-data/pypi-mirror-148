...
from nlu_bf.cli.utils import print_success, create_output_path
...
async def model_fingerprint(file_importer: "TrainingDataImporter") -> Fingerprint:
    ...
    return {
        ...
        FINGERPRINT_RASA_VERSION_KEY: nlu_bf.__version__,
    }
...
def fingerprint_from_path(model_path: Text) -> Fingerprint:
    ...
    if os.path.isfile(fingerprint_path):
        return nlu_bf.utils.io.read_json_file(fingerprint_path)
    else:
        return {}
...
def persist_fingerprint(output_path: Text, fingerprint: Fingerprint):
    ...
    nlu_bf.utils.io.dump_obj_as_json_to_file(path, fingerprint)

...
from nlu_bf.core import events  # pytype: disable=pyi-error
from nlu_bf.core.actions.action import ACTION_LISTEN_NAME  # pytype: disable=pyi-error
from nlu_bf.core.conversation import Dialogue  # pytype: disable=pyi-error
from nlu_bf.core.events import (  # pytype: disable=pyi-error
    UserUttered,
    ActionExecuted,
    Event,
    SlotSet,
...
from nlu_bf.core.domain import Domain  # pytype: disable=pyi-error
...
class DialogueStateTracker:
    ...
    def export_stories(self, e2e: bool = False) -> Text:
        ...
        from nlu_bf.core.training.structures import Story
    ...
    def export_stories_to_file(self, export_path: Text = "debug.md") -> None:
        ...
        nlu_bf.utils.io.write_text_file(

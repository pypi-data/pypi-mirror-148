...
from nlu_bf.core.events import ActionExecuted, Event
from nlu_bf.core.featurizers import MaxHistoryTrackerFeaturizer
from nlu_bf.nlu.constants import INTENT
from nlu_bf.core.training.generator import TrackerWithCachedStates
    ...
    def _summarize_conflicting_actions(action: Text, stories: List[Text]) -> Text:
        ...
        if len(stories) > 3:
            ...
            raise ValueError(
                ...
                "Please file a bug report at https://github.com/RasaHQ/nlu_bf."
            )

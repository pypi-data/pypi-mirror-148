...
from nlu_bf.core.actions.action import ACTION_LISTEN_NAME
from nlu_bf.core.domain import PREV_PREFIX, Domain
from nlu_bf.core.events import ActionExecuted
from nlu_bf.core.trackers import DialogueStateTracker
from nlu_bf.core.training.data import DialogueTrainingData
from nlu_bf.utils.common import is_logging_disabled
...
class TrackerFeaturizer:
    ...
    def persist(self, path) -> None:
        ...
        nlu_bf.utils.io.create_directory_for_file(featurizer_file)

        # noinspection PyTypeChecker
        nlu_bf.utils.io.write_text_file(str(jsonpickle.encode(self)), featurizer_file)
    ...
    def load(path) -> Optional["TrackerFeaturizer"]:
        ...
        if os.path.isfile(featurizer_file):
            return jsonpickle.decode(nlu_bf.utils.io.read_file(featurizer_file))
        else:
            logger.error(

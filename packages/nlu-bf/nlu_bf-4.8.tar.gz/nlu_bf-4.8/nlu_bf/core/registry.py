...
def policy_from_module_path(module_path: Text) -> Type["Policy"]:
    ...
    from nlu_bf.utils.common import class_from_module_path

    try:
        return class_from_module_path(
            module_path, lookup_path="nlu_bf.core.policies.registry"
        )
    except ImportError:
...
def featurizer_from_module_path(module_path: Text) -> Type["TrackerFeaturizer"]:
    ...
    try:
        return class_from_module_path(module_path, lookup_path="nlu_bf.core.featurizers")
    except ImportError:

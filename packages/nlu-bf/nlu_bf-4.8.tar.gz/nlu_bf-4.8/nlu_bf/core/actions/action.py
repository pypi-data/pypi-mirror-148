...
from nlu_bf.core import events
...
from nlu_bf.utils.endpoints import EndpointConfig, ClientResponseError
...
if typing.TYPE_CHECKING:
    ...
    from nlu_bf.core.events import SlotSet
...
class Action:
    ...
    async def run(
        ...
        Returns:
            List[Event]: A list of :class:`nlu_bf.core.events.Event` instances
        """
...
class ActionRestart(ActionUtterTemplate):
    ...
    async def run(
        ...
        from nlu_bf.core.events import Restarted
...
class ActionSessionStart(Action):
    ...
    async def run(
        ...
        from nlu_bf.core.events import SessionStarted
...
class ActionDefaultFallback(ActionUtterTemplate):
    ...
    async def run(
        ...
        from nlu_bf.core.events import UserUtteranceReverted
...
class ActionDeactivateForm(Action):
    ...
    async def run(
        ...
        from nlu_bf.core.events import Form, SlotSet
...
class RemoteAction(Action):
    ...
    def _action_call_format(
        ...
        from nlu_bf.core.trackers import EventVerbosity
...
class ActionRevertFallbackEvents(Action):
    ...
    async def run(
        ...
        from nlu_bf.core.policies.two_stage_fallback import has_user_rephrased

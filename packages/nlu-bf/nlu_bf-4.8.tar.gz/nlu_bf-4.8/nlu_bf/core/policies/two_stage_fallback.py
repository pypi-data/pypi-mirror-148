...
from nlu_bf.core.events import UserUttered, ActionExecuted

from nlu_bf.core.constants import USER_INTENT_OUT_OF_SCOPE
from nlu_bf.core.domain import Domain, InvalidDomain
from nlu_bf.core.policies.fallback import FallbackPolicy
from nlu_bf.core.policies.policy import confidence_scores_for
from nlu_bf.core.trackers import DialogueStateTracker
from nlu_bf.core.constants import FALLBACK_POLICY_PRIORITY
...
class TwoStageFallbackPolicy(FallbackPolicy):
    ...
    def persist(self, path: Text) -> None:
        ...
        nlu_bf.utils.io.create_directory_for_file(config_file)
        nlu_bf.utils.io.dump_obj_as_json_to_file(config_file, meta)
    ...
    def load(cls, path: Text) -> "FallbackPolicy":
        ...
        if os.path.exists(path):
            ...
            if os.path.isfile(meta_path):
                meta = json.loads(nlu_bf.utils.io.read_file(meta_path))

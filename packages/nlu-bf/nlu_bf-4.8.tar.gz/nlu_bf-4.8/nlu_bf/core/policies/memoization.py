...
from nlu_bf.core.featurizers import TrackerFeaturizer, MaxHistoryTrackerFeaturizer
...
from nlu_bf.core.constants import MEMOIZATION_POLICY_PRIORITY
...
class MemoizationPolicy(Policy):
    ...
    def persist(self, path: Text) -> None:
        ...
        nlu_bf.utils.io.create_directory_for_file(memorized_file)
        nlu_bf.utils.io.dump_obj_as_json_to_file(memorized_file, data)
    ...
    def load(cls, path: Text) -> "MemoizationPolicy":
        ...
        if os.path.isfile(memorized_file):
            data = json.loads(nlu_bf.utils.io.read_file(memorized_file))
            return cls(

...
from nlu_bf.core.featurizers import MaxHistoryTrackerFeaturizer, TrackerFeaturizer
...
class SklearnPolicy(Policy):
    ...
    def persist(self, path: Text) -> None:
        ...
        if self.model:
            ...
            nlu_bf.utils.io.pickle_dump(filename, self._state)
        else:
            raise_warning(
    ...
    def load(cls, path: Text) -> Policy:
        ...
        state = nlu_bf.utils.io.pickle_load(filename)

...
from nlu_bf.core.featurizers import (
    MaxHistoryTrackerFeaturizer,
    BinarySingleStateFeaturizer,
)
from nlu_bf.core.featurizers import TrackerFeaturizer
from nlu_bf.core.trackers import DialogueStateTracker
from nlu_bf.core.training.data import DialogueTrainingData
from nlu_bf.core.constants import DEFAULT_POLICY_PRIORITY
...
class Policy:
    ...
    def _get_valid_params(func: Callable, **kwargs: Any) -> Dict:
        ...
        valid_keys = nlu_bf.utils.common.arguments_of(func)
    ...
    def featurize_for_training(
        ...
        **kwargs: Any,
        ...
        Args:
            training_trackers:
                the list of the :class:`nlu_bf.core.trackers.DialogueStateTracker`
            domain: the :class:`nlu_bf.core.domain.Domain`

        Returns:
            the :class:`nlu_bf.core.training.data.DialogueTrainingData`
        """
    ...
    def predict_action_probabilities(
        ...
        Args:
            tracker: the :class:`nlu_bf.core.trackers.DialogueStateTracker`
            domain: the :class:`nlu_bf.core.domain.Domain`

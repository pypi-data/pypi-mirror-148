...
from nlu_bf.core.conversation import Dialogue
from nlu_bf.core.domain import Domain
from nlu_bf.core.events import SessionStarted
from nlu_bf.core.trackers import ActionExecuted, DialogueStateTracker, EventVerbosity
from nlu_bf.utils.common import class_from_module_path, raise_warning, arguments_of
...
def _create_sequence(table_name: Text) -> Sequence:
    ...
    https://nlu_bf.com/docs/nlu_bf/api/tracker-stores/#sqltrackerstore
    Args:

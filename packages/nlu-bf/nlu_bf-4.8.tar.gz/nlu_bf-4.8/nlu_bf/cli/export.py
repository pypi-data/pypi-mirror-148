...
import nlu_bf.core.utils as rasa_core_utils
from nlu_bf.cli.arguments import export as arguments
from nlu_bf.constants import DOCS_URL_TRACKER_STORES, DOCS_URL_EVENT_BROKERS
from nlu_bf.exceptions import (
    PublishingError,
    RasaException,
)
...
if typing.TYPE_CHECKING:
    ...
    from nlu_bf.core.brokers.pika import PikaEventBroker, PikaProducer
    from nlu_bf.core.tracker_store import TrackerStore
    from nlu_bf.core.exporter import Exporter
...
def _get_continuation_command(exporter: "Exporter", timestamp: float) -> Text:
    """Build CLI command to continue 'nlu_bf export' where it was interrupted.

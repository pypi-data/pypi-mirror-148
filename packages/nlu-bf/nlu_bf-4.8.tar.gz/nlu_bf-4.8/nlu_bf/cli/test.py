...
from nlu_bf.cli.arguments import test as arguments
...
def test_core(args: argparse.Namespace) -> None:
    ...
    from nlu_bf.test import test_core_models_in_directory, test_core, test_core_models
...
def test_nlu(args: argparse.Namespace) -> None:
    from nlu_bf import data
    from nlu_bf.test import compare_nlu_models, perform_nlu_cross_validation, test_nlu

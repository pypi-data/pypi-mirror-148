...
from nlu_bf.cli.arguments import run as arguments
from nlu_bf.cli.utils import get_validated_path, print_error
...
def run(args: argparse.Namespace):
    ...
    print_error(
        ...
        "from.\n"
        "3. Train a model before running the server using `nlu_bf train` and "

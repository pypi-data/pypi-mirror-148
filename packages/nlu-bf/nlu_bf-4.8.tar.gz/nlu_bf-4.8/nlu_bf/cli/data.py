...
from nlu_bf.cli.arguments import data as arguments
import nlu_bf.cli.utils
from nlu_bf.constants import DEFAULT_DATA_PATH
from nlu_bf.validator import Validator
from nlu_bf.importers.nlu_bf import RasaFileImporter
...
def _add_data_convert_parsers(
    ...
    from nlu_bf.nlu import convert
...
def split_nlu_data(args: argparse.Namespace) -> None:
    from nlu_bf.nlu.training_data.loading import load_data
    from nlu_bf.nlu.training_data.util import get_file_format

    data_path = nlu_bf.cli.utils.get_validated_path(args.nlu, "nlu", DEFAULT_DATA_PATH)
...
def validate_files(args: argparse.Namespace, stories_only: bool = False) -> None:
    ...
    if not all_good:
        nlu_bf.cli.utils.print_error_and_exit("Project validation completed with errors.")

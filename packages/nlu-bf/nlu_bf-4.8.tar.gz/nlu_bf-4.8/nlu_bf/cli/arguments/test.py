...
from nlu_bf.constants import DEFAULT_MODELS_PATH, DEFAULT_RESULTS_PATH

from nlu_bf.cli.arguments.default_arguments import (
    add_stories_param,
    add_model_param,
    add_nlu_data_param,
    add_endpoint_param,
...
from nlu_bf.model import get_latest_model
...
def add_test_core_argument_group(
    ...
    parser.add_argument(
        ...
        "'nlu_bf train core --config <config-1> <config-2>'. "

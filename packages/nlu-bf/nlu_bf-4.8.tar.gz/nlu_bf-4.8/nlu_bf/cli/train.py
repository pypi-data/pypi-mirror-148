...
import nlu_bf.cli.arguments.train as train_arguments

from nlu_bf.cli.utils import get_validated_path, missing_config_keys, print_error
...
def train_core(
    ...
    from nlu_bf.train import train_core
    import asyncio
    ...
    if not isinstance(args.config, list) or len(args.config) == 1:
        ...
        from nlu_bf.core.train import do_compare_training

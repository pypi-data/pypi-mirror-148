...
from nlu_bf.constants import DEFAULT_MODELS_PATH, DEFAULT_CORE_SUBDIRECTORY_NAME
...
async def _train_nlu_with_validated_data(
    ...
    with ExitStack() as stack:
        ...
        _, nlu_model, _ = await nlu_bf.nlu.train(
            config,
            file_importer,
            _train_path,

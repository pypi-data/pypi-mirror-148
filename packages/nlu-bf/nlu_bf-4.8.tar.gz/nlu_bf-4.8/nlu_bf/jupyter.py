...
from nlu_bf.cli.utils import print_success, print_error
from nlu_bf.core.interpreter import NaturalLanguageInterpreter, RasaNLUInterpreter
...
def chat(
    ...
    if model_path:
        from nlu_bf.run import create_agent

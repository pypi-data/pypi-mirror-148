...
from nlu_bf.nlu import config
from nlu_bf.nlu.components import ComponentBuilder
from nlu_bf.nlu.config import RasaNLUModelConfig
from nlu_bf.nlu.model import Interpreter, Trainer
from nlu_bf.nlu.training_data import load_data
from nlu_bf.nlu.training_data.loading import load_data_from_endpoint
...
if __name__ == "__main__":
    raise RuntimeError(
        "Calling `nlu_bf.nlu.train` directly is no longer supported. Please use "
        "`nlu_bf train` to train a combined Core and NLU model or `nlu_bf train nlu` "

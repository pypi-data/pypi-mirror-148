...
import nlu_bf.utils.train_utils as train_utils
import numpy as np
...
class HFTransformersNLP(Component):
    ...
    def _load_model(self) -> None:
        ...
        from nlu_bf.nlu.utils.hugging_face.registry import (
            model_class_dict,
    ...
    def _lm_specific_token_cleanup(
        ...
        from nlu_bf.nlu.utils.hugging_face.registry import model_tokens_cleaners

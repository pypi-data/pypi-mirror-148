...
from nlu_bf.nlu.training_data.formats import markdown
from nlu_bf.nlu.training_data.formats.dialogflow import (
    DIALOGFLOW_AGENT,
    DIALOGFLOW_ENTITIES,
...
def _reader_factory(fformat: Text) -> Optional["TrainingDataReader"]:
    ...
    from nlu_bf.nlu.training_data.formats import (
        MarkdownReader,
        WitReader,
        LuisReader,
        RasaReader,

...
from nlu_bf.constants import DOCS_BASE_URL, DOCS_URL_TRAINING_DATA_NLU
...
class RasaReader(JsonTrainingDataReader):
    def read_from_json(self, js, **kwargs) -> "TrainingData":
        """Loads training data stored in the nlu_bf NLU data format."""
        from nlu_bf.nlu.training_data import Message, TrainingData
...
def validate_rasa_nlu_data(data: Dict[Text, Any]) -> None:
    """Validate nlu_bf training data format to ensure proper training.

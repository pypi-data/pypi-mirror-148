...
from nlu_bf.nlu.config import RasaNLUModelConfig
from nlu_bf.nlu.tokenizers.tokenizer_fr import Token, Tokenizer
from nlu_bf.nlu.training_data import Message, TrainingData
from custom_func.clean_data_eng import clean_data_eng
from custom_func.clean_data_eng_training import clean_data_eng_training
from custom_func.generateur_oncf_eng import generateur_oncf_eng
...
class WhitespaceTokenizer_oncf_eng_v2(Tokenizer):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        generateur_oncf_eng('data_oncf_eng_v2',)
    ...
    def tokenize(self, message: Message, attribute: Text) -> List[Token]:
        ...
        words2 =[]
        words2 = clean_data_eng_training(words)
...
#Remove punctuation !!
        ...
        words = text.split()
        print("zyw")
        with open("dictionaries/dict_oncf_eng.txt", 'r',encoding="utf8") as f:
        ...
        words2 = clean_data_eng(list,words)
        words2 = words
        text = "" 
        for w in words2 :
            text = text  +  w     

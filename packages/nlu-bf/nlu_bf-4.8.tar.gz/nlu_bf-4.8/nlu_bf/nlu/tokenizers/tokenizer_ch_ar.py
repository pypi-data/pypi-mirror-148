...
class WhitespaceTokenizer_ch_ar(Tokenizer, Component):
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(WhitespaceTokenizer_ch_ar, self).__init__(component_config)
    ...
    def tokenize(self, message: Message, attribute: Text) -> List[Token]:
        ...
        with open("dictionaries/dict_ch_ar.txt", 'r',encoding="utf8") as f:

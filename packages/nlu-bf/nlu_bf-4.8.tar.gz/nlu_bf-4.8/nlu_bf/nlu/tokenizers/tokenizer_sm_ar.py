...
from custom_func.clean_data_sm_ar import clean_data_ar 
...
from custom_func.generateur_sm_ar import generateur_sm_ar
...
class WhitespaceTokenizer_sm_ar(Tokenizer, Component):
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(WhitespaceTokenizer_sm_ar, self).__init__(component_config)
...
#replace indou arabic numbers
        ...
        words_corr = []
        word_cor = ''
        with open("dictionaries/dict_sm_ar.txt", 'r',encoding="utf8") as f:

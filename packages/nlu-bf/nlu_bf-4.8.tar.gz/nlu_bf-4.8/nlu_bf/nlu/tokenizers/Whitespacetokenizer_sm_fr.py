...
from custom_func.generateur_sm_fr import generateur_sm_fr
...
class WhitespaceTokenizer_sm_fr(Tokenizer):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        generateur_sm_fr('data_small_fr',)
...
#Remove punctuation !!
        ...
        words = text.split()
        print("zyw")
        with open("dictionaries/dict_sm_fr.txt", 'r',encoding="utf8") as f:

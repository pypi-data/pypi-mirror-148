...
from nlu_bf.constants import DOCS_URL_MIGRATION_GUIDE
from nlu_bf.nlu.config import RasaNLUModelConfig, override_defaults, InvalidConfigError
...
def validate_requirements(component_names: List[Text]) -> None:
    ...
    from nlu_bf.nlu import registry
...
def validate_empty_pipeline(pipeline: List["Component"]) -> None:
    ...
    Args:
        pipeline: the list of the :class:`nlu_bf.nlu.components.Component`.
    """
...
def validate_only_one_tokenizer_is_used(pipeline: List["Component"]) -> None:
    ...
    from nlu_bf.nlu.tokenizers.tokenizer import Tokenizer
...
def _check_deprecated_attributes(component: "Component") -> None:
    ...
    Args:
        component: The :class:`nlu_bf.nlu.components.Component`.
    """
...
def validate_required_components_from_data(
    ...
    Args:
        pipeline: The list of the :class:`nlu_bf.nlu.components.Component`.
        data: The :class:`nlu_bf.nlu.training_data.training_data.TrainingData`.
    """
...
class Component(metaclass=ComponentMetaclass):
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            model_metadata: The model's :class:`nlu_bf.nlu.model.Metadata`.
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        by a call to :meth:`nlu_bf.nlu.components.Component.create`
        of ANY component and
        on any context attributes created by a call to
        :meth:`nlu_bf.nlu.components.Component.train`
        of components previous to this one.

        Args:
            training_data:
                The :class:`nlu_bf.nlu.training_data.training_data.TrainingData`.
            config: The model configuration parameters.
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        of ANY component and
        on any context attributes created by a call to
        :meth:`nlu_bf.nlu.components.Component.process`
        of components previous to this one.

        Args:
            message: The :class:`nlu_bf.nlu.training_data.message.Message` to process.
    ...
    def cache_key(
        ...
        Args:
            ...
            model_metadata: The component's :class:`nlu_bf.nlu.model.Metadata`.
    ...
    def partially_process(self, message: Message) -> Message:
        ...
        Returns:
            The processed :class:`nlu_bf.nlu.training_data.message.Message`.
    ...
    def load_component(
        ...
        **context: Any,
        ...
        Args:
            ...
            model_metadata (Metadata):
                The model's :class:`nlu_bf.nlu.model.Metadata`.

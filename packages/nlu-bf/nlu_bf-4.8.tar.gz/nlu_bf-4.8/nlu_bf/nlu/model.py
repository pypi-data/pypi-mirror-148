...
from nlu_bf.constants import MINIMUM_COMPATIBLE_VERSION
from nlu_bf.nlu import components, utils  # pytype: disable=pyi-error
from nlu_bf.nlu.components import Component, ComponentBuilder  # pytype: disable=pyi-error
from nlu_bf.nlu.config import RasaNLUModelConfig, component_config_from_pipeline
from nlu_bf.nlu.persistor import Persistor
...
class Metadata:
    ...
    def load(model_dir: Text):
        ...
        try:
            ...
            data = nlu_bf.utils.io.read_json_file(metadata_file)
        ...
        metadata.update(
            {
                ...
                "rasa_version": nlu_bf.__version__,
            }
        )
...
class Trainer:
    ...
    def persist(
        ...
        nlu_bf.utils.io.create_directory(dir_name)
    ...
    def ensure_model_compatibility(
        ...
        if version.parse(model_version) < version.parse(version_to_check):
            raise UnsupportedModelError(
                ...
                "".format(model_version, nlu_bf.__version__)
            )
    ...
    def load(
        ...
        Args:
            ...
            component_builder: The
                :class:`nlu_bf.nlu.components.ComponentBuilder` to use.

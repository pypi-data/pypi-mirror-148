...
from nlu_bf.constants import DOCS_URL_TRAINING_DATA_NLU
...
from nlu_bf.nlu.featurizers.featurizer import SparseFeaturizer
...
class RegexFeaturizer(SparseFeaturizer):
    ...
    def _generate_lookup_regex(
        ...
        # otherwise it's a file path.
            ...
            try:
                f = open(lookup_elements, "r", encoding=nlu_bf.utils.io.DEFAULT_ENCODING)
            except OSError:
                raise ValueError(
    ...
    def load(
        ...
        **kwargs: Any,
        ...
        if os.path.exists(regex_file):
            known_patterns = nlu_bf.utils.io.read_json_file(regex_file)

...
import pytest
from nlu_bf.constants import DEFAULT_CONFIG_PATH, DEFAULT_DOMAIN_PATH, DEFAULT_DATA_PATH
from nlu_bf.importers.importer import (
...
from nlu_bf.importers.multi_project import MultiProjectImporter
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "importers": [
                    {"name": "nlu_bf.importers.multi_project.MultiProjectImporter"}
                ]
            },

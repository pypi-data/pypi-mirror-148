...
from nlu_bf.nlu.constants import TOKENS_NAMES, TEXT, INTENT
from nlu_bf.nlu.training_data import TrainingData, Message
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "https://www.google.com/search?client=safari&rls=en&q=i+like+nlu_bf&ie=UTF-8&oe=UTF-8 https://nlu_bf.com/docs/nlu/components/#tokenizer-whitespace",
            [
                "https://www.google.com/search?"
                "client=safari&rls=en&q=i+like+nlu_bf&ie=UTF-8&oe=UTF-8",
                "https://nlu_bf.com/docs/nlu/components/#tokenizer-whitespace",
            ],
            [(0, 82), (83, 141)],
        ),
    ],

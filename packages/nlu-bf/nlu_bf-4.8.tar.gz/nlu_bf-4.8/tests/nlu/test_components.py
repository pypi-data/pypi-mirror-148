...
from nlu_bf.nlu.components import find_unavailable_packages
...
def test_builder_create_by_module_path(component_builder, blank_config):
    ...
    path = "nlu_bf.nlu.featurizers.sparse_featurizer.regex_featurizer.RegexFeaturizer"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "nlu_bf.nlu.featurizers.regex_featurizer.MadeUpClass",

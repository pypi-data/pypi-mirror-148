...
from nlu_bf.nlu.constants import TEXT
from nlu_bf.nlu import training_data
from nlu_bf.nlu.convert import convert_training_data
...
from nlu_bf.nlu.tokenizers.whitespace_tokenizer import WhitespaceTokenizer
from nlu_bf.nlu.training_data import TrainingData
from nlu_bf.nlu.training_data.formats import MarkdownReader, MarkdownWriter
from nlu_bf.nlu.training_data.formats.nlu_bf import validate_rasa_nlu_data, RasaReader
from nlu_bf.nlu.training_data.loading import guess_format, UNK, load_data
from nlu_bf.nlu.training_data.util import get_file_format
import nlu_bf.utils.io as io_utils


def test_example_training_data_is_valid():
    demo_json = "data/examples/nlu_bf/demo-nlu_bf.json"
...
@pytest.mark.parametrize(
    ...
    [
        [
            "data/examples/nlu_bf/demo-nlu_bf.json",
            "data/examples/nlu_bf/demo-nlu_bf-responses.md",
        ],
        [
            "data/examples/nlu_bf/demo-nlu_bf.md",
            "data/examples/nlu_bf/demo-nlu_bf-responses.md",
        ],
    ],
)
def test_demo_data(files):
    from nlu_bf.importers.utils import training_data_from_paths
...
@pytest.mark.parametrize(
    "filepaths",
    [["data/examples/nlu_bf/demo-nlu_bf.md", "data/examples/nlu_bf/demo-nlu_bf-responses.md"]],
)
...
@pytest.mark.parametrize(
    "files",
    [
        ("data/examples/nlu_bf/demo-nlu_bf.json", "data/test/multiple_files_json"),
        ("data/examples/nlu_bf/demo-nlu_bf.md", "data/test/multiple_files_markdown"),
        ("data/examples/nlu_bf/demo-nlu_bf.md", "data/test/duplicate_intents_markdown"),
    ],
)

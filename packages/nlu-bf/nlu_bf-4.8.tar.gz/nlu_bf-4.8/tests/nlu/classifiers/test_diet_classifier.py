...
from nlu_bf.nlu import train
from nlu_bf.nlu.classifiers import LABEL_RANKING_LENGTH
from nlu_bf.nlu.config import RasaNLUModelConfig
from nlu_bf.nlu.constants import TEXT, SPARSE_FEATURE_NAMES, DENSE_FEATURE_NAMES, INTENT
...
async def test_train_persist_load_with_different_settings(
    ...
    (trainer, trained, persisted_path) = await train(
        _config,
        path=tmpdir.strpath,
        data="data/examples/nlu_bf/demo-nlu_bf-multi-intent.md",

...
def test_data_split_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf data split nlu [-h] [-v] [-vv] [--quiet] [-u NLU]
...
def test_data_convert_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf data convert nlu [-h] [-v] [-vv] [--quiet] --data DATA --out OUT
...
def test_data_validate_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf data validate [-h] [-v] [-vv] [--quiet]
...
def test_data_validate_stories_with_max_history_zero(monkeypatch: MonkeyPatch):
    ...
    monkeypatch.setattr("nlu_bf.validator.Validator.from_importer", mock_from_importer)

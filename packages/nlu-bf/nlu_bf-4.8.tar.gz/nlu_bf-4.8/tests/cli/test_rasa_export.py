...
from nlu_bf.cli import export
from nlu_bf.core.brokers.pika import PikaEventBroker
from nlu_bf.core.events import UserUttered
from nlu_bf.core.trackers import DialogueStateTracker
from nlu_bf.exceptions import PublishingError, NoEventsToMigrateError
...
def test_export_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf export [-h] [-v] [-vv] [--quiet] [--endpoints ENDPOINTS]

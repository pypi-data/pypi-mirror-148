...
from nlu_bf.constants import DEFAULT_RESULTS_PATH, RESULTS_FILE
from nlu_bf.utils.io import list_files, write_yaml_file
...
def test_test_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf test [-h] [-v] [-vv] [--quiet] [-m MODEL] [-s STORIES]
...
def test_test_nlu_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf test nlu [-h] [-v] [-vv] [--quiet] [-m MODEL] [-u NLU] [--out OUT]
                     [--successes] [--no-errors] [--histogram HISTOGRAM]
                     [--confmat CONFMAT] [-c CONFIG [CONFIG ...]]
                     [--cross-validation] [-f FOLDS] [-r RUNS]
                     [-p PERCENTAGES [PERCENTAGES ...]] [--no-plot]"""
...
def test_test_core_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: nlu_bf test core [-h] [-v] [-vv] [--quiet] [-m MODEL [MODEL ...]]

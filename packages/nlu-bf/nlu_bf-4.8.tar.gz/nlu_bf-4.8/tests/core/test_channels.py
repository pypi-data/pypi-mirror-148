...
from nlu_bf.core import utils
from nlu_bf.core.channels import RasaChatInput
from nlu_bf.core.channels.channel import UserMessage
from nlu_bf.core.channels.rasa_chat import (
    JWT_USERNAME_KEY,
    CONVERSATION_ID_KEY,
    INTERACTIVE_LEARNING_PERMISSION,
)
from nlu_bf.core.channels.telegram import TelegramOutput
from nlu_bf.utils.endpoints import EndpointConfig
...
async def test_console_input():
    from nlu_bf.core.channels import console
...
def test_facebook_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.facebook import FacebookInput
    ...
    s = nlu_bf.core.run.configure_app([input_channel], port=5004)
    # END DOC INCLUDE
...
def test_webexteams_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.webexteams import WebexTeamsInput
...
def test_slack_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.slack import SlackInput
...
def test_mattermost_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.mattermost import MattermostInput
...
def test_botframework_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.botframework import BotFrameworkInput
...
def test_rocketchat_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.rocketchat import RocketChatInput
...
def test_telegram_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.telegram import TelegramInput
...
def test_twilio_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.twilio import TwilioInput
...
def test_callback_channel():
    # START DOC INCLUDE
    from nlu_bf.core.channels.callback import CallbackInput
...
async def test_callback_calls_endpoint():
    from nlu_bf.core.channels.callback import CallbackOutput
...
def test_botframework_attachments():
    from nlu_bf.core.channels.botframework import BotFrameworkInput, BotFramework
    ...
    attachments = [
        {
            ...
            "content": {
                "downloadUrl": "https://test.sharepoint.com/personal/nlu_bf/123",
                "uniqueId": "123",
                "fileType": "csv",
            },
            "contentUrl": "https://test.sharepoint.com/personal/nlu_bf/123",
            "name": "nlu_bf-test.csv",
        }
    ]
...
def test_slackbot_init_one_parameter():
    from nlu_bf.core.channels.slack import SlackBot
...
async def test_slackbot_send_image_url():
    ...
    with aioresponses() as mocked:
        ...
        assert request_params["blocks"][0].get("alt_text") == "http://www.nlu_bf.net"
        assert request_params["blocks"][0].get("image_url") == "http://www.nlu_bf.net"
...
def test_channel_inheritance():
    from nlu_bf.core.channels.channel import RestInput
    from nlu_bf.core.channels.rasa_chat import RasaChatInput

    rasa_input = RasaChatInput("https://example.com")

    s = nlu_bf.core.run.configure_app([RestInput(), rasa_input], port=5004)
...
async def test_send_elements_without_buttons():
    from nlu_bf.core.channels.channel import OutputChannel
...
def test_register_channel_without_route():
    ...
    app = Sanic(__name__)
    nlu_bf.core.channels.channel.register([input_channel], app, route=None)
...
def test_channel_registration_with_absolute_url_prefix_overwrites_route():
    ...
    nlu_bf.core.channels.channel.register(
...
async def test_rasa_chat_input():
    ...
    rasa_x_api_url = "https://nlu_bf-x.com:5002"

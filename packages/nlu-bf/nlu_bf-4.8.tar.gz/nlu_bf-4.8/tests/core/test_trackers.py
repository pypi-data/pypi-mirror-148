...
from nlu_bf.core import training, restore
...
def stores_to_be_tested():
    ...
    return [
        ...
        SQLTrackerStore(domain, db=os.path.join(temp, "nlu_bf.db")),
...
async def test_dump_and_restore_as_json(default_agent, tmpdir_factory):
    ...
    for tracker in trackers:
        ...
        nlu_bf.utils.io.dump_obj_as_json_to_file(out_path.strpath, dumped)

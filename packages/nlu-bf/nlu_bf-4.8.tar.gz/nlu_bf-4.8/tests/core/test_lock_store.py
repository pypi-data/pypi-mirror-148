...
from nlu_bf.core.constants import INTENT_MESSAGE_PREFIX, DEFAULT_LOCK_LIFETIME
from nlu_bf.core.lock import TicketLock
from nlu_bf.core.lock_store import InMemoryLockStore, LockError, LockStore, RedisLockStore
...
async def test_lock_lifetime_environment_variable():
    import nlu_bf.core.lock_store
    import importlib

    # by default lock lifetime is `DEFAULT_LOCK_LIFETIME`
    assert nlu_bf.core.lock_store.LOCK_LIFETIME == DEFAULT_LOCK_LIFETIME
    ...
    importlib.reload(nlu_bf.core.lock_store)
    assert nlu_bf.core.lock_store.LOCK_LIFETIME == new_lock_lifetime

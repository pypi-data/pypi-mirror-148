...
from nlu_bf.core.utils import get_dict_hash
...
@pytest.mark.parametrize("model_path", ["foobar", "nlu_bf", "README.md", None])
...
def test_persist_and_load_fingerprint():
    from nlu_bf.model import persist_fingerprint, fingerprint_from_path

...
from nlu_bf.core.constants import USER_INTENT_RESTART, USER_INTENT_BACK
from nlu_bf.core.channels.channel import UserMessage
from nlu_bf.core.domain import Domain
from nlu_bf.core.events import ActionExecuted, ConversationPaused
...
class TestSklearnPolicy(PolicyTestCollection):
    ...
    def mock_search(self):
        with patch("nlu_bf.core.policies.sklearn_policy.GridSearchCV") as gs:

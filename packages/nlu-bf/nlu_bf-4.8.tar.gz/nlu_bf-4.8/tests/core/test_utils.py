...
from nlu_bf.constants import ENV_SANIC_WORKERS
from nlu_bf.core import utils
from nlu_bf.core.lock_store import LockStore, RedisLockStore, InMemoryLockStore
from nlu_bf.core.utils import replace_floats_with_decimals
...
def test_lock_store_is_redis_lock_store(
    ...
    assert nlu_bf.core.utils._lock_store_is_redis_lock_store(lock_store) == expected

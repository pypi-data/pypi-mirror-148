...
from nlu_bf.core.channels.channel import CollectingOutputChannel, OutputChannel
from nlu_bf.core.domain import Domain
from nlu_bf.core.events import ReminderScheduled, UserUttered, ActionExecuted
from nlu_bf.core.nlg import TemplatedNaturalLanguageGenerator
from nlu_bf.core.policies.ensemble import PolicyEnsemble
from nlu_bf.core.policies.memoization import Policy
from nlu_bf.core.processor import MessageProcessor
from nlu_bf.core.slots import Slot
from nlu_bf.core.tracker_store import InMemoryTrackerStore, MongoTrackerStore
...
def project() -> Text:
    import tempfile
    from nlu_bf.cli.scaffold import create_initial_project

...
from nlu_bf.core import training, utils
from nlu_bf.core.interpreter import RegexInterpreter
from nlu_bf.core.training.dsl import StoryFileReader, EndToEndReader
...
async def test_persist_and_read_test_story_graph(tmpdir, default_domain):
    ...
    nlu_bf.utils.io.write_text_file(graph.as_story_string(), out_path.strpath)

...
import nlu_bf.core.tracker_store
...
from nlu_bf.utils.endpoints import EndpointConfig, read_endpoint_config
...
def test_exception_tracker_store_from_endpoint_config(
    ...
    monkeypatch.setattr(nlu_bf.core.tracker_store, "RedisTrackerStore", mock)
...
def test_db_get_url_with_sqlite():
    expected = "sqlite:///nlu_bf.db"
    assert str(SQLTrackerStore.get_db_url(dialect="sqlite", db="nlu_bf.db")) == expected

    ...
    * [ChatMemberBanned](https://core.telegram.org/bots/api/#chatmemberbanned)
    ...
    def deserialize(
        ...
        def deserialize_to(status: str) -> type[ChatMember]:
            match (status):
                case 'administrator': return ChatMemberAdministrator
                case 'kicked': return ChatMemberBanned
                case 'left': return ChatMemberLeft
                case 'member': return ChatMemberMember
                case 'creator': return ChatMemberOwner
                case 'restricted': return ChatMemberRestricted
                case _: raise ValueError(f'Unknown chat member status: {status}')

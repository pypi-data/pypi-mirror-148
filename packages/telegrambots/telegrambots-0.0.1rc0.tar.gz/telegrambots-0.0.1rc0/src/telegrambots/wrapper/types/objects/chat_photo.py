...
class ChatPhoto(TelegramBotsObject, ClientTargetable):
    ...
    small_file_unique_id: str = field(metadata={"ac_type": [str], "ac_name": "small_file_unique_id"})
    ...
    big_file_unique_id: str = field(metadata={"ac_type": [str], "ac_name": "big_file_unique_id"})

...
class ChatJoinRequest(TelegramBotsObject, ClientTargetable):
    ...
    bio: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "bio"})
    """*Optional*. Bio of the user.
    """

    invite_link: Optional[ChatInviteLink] = field(default=None, metadata={"ac_type": [ChatInviteLink], "ac_name": "invite_link"})

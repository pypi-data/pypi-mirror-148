...
class ChatInviteLink(TelegramBotsObject, ClientTargetable):
    ...
    creates_join_request: bool = field(metadata={"ac_type": [bool], "ac_name": "creates_join_request"})
    ...
    pending_join_request_count: Optional[int] = field(default=None, metadata={"ac_type": [int], "ac_name": "pending_join_request_count"})

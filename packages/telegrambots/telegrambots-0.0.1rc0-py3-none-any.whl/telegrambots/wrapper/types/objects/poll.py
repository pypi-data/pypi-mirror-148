...
class Poll(TelegramBotsObject, ClientTargetable):
    ...
    options: list[PollOption] = field(metadata={"ac_type": [PollOption], "ac_name": "options"})
    """List of poll options
    """

    total_voter_count: int = field(metadata={"ac_type": [int], "ac_name": "total_voter_count"})
    ...
    type: Literal["regular","quiz"] = field(metadata={"ac_type": [str], "ac_name": "type"})
    """Poll type, currently can be “regular” or “quiz”
    """

    allows_multiple_answers: bool = field(metadata={"ac_type": [bool], "ac_name": "allows_multiple_answers"})

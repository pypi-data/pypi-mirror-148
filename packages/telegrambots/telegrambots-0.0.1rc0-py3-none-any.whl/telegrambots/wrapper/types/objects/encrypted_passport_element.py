...
class EncryptedPassportElement(TelegramBotsObject, ClientTargetable):
    ...
    # --- properties here ---
    type: Literal["personal_details","passport","driver_license","identity_card","internal_passport","address","utility_bill","bank_statement","rental_agreement","passport_registration","temporary_registration","phone_number","email"] = field(metadata={"ac_type": [str], "ac_name": "type"})
    ...
    data: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "data"})
    ...
    phone_number: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "phone_number"})
    """*Optional*. User's verified phone number, available only for “phone\\_number” type
    """

    email: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "email"})
    """*Optional*. User's verified email address, available only for “email” type
    """

    files: Optional[list[PassportFile]] = field(default=None, metadata={"ac_type": [PassportFile], "ac_name": "files"})
    ...
    front_side: Optional[PassportFile] = field(default=None, metadata={"ac_type": [PassportFile], "ac_name": "front_side"})
    ...
    reverse_side: Optional[PassportFile] = field(default=None, metadata={"ac_type": [PassportFile], "ac_name": "reverse_side"})
    ...
    selfie: Optional[PassportFile] = field(default=None, metadata={"ac_type": [PassportFile], "ac_name": "selfie"})
    ...
    translation: Optional[list[PassportFile]] = field(default=None, metadata={"ac_type": [PassportFile], "ac_name": "translation"})

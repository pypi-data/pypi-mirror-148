...
class Game(TelegramBotsObject, ClientTargetable):
    ...
    photo: list[PhotoSize] = field(metadata={"ac_type": [PhotoSize], "ac_name": "photo"})
    ...
    text_entities: Optional[list[MessageEntity]] = field(default=None, metadata={"ac_type": [MessageEntity], "ac_name": "text_entities"})

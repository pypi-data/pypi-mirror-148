...
class User(TelegramBotsObject, ClientTargetable):
    ...
    username: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "username"})
    ...
    can_join_groups: Optional[bool] = field(default=None, metadata={"ac_type": [bool], "ac_name": "can_join_groups"})
    """*Optional*. *True*, if the bot can be invited to groups. Returned only in [getMe](https://core.telegram.org/bots/api/#getme).
    """

    can_read_all_group_messages: Optional[bool] = field(default=None, metadata={"ac_type": [bool], "ac_name": "can_read_all_group_messages"})
    ...
    supports_inline_queries: Optional[bool] = field(default=None, metadata={"ac_type": [bool], "ac_name": "supports_inline_queries"})

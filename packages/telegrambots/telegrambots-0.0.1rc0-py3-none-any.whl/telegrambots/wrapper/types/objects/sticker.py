...
class Sticker(TelegramBotsObject, ClientTargetable):
    ...
    emoji: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "emoji"})
    """*Optional*. Emoji associated with the sticker
    """

    set_name: Optional[str] = field(default=None, metadata={"ac_type": [str], "ac_name": "set_name"})

...
from upgini.metrics import calculate_cv_metric, calculate_metric, fit_model
...
class FeaturesEnricher(TransformerMixin):  # type: ignore
    ...
    def calculate_metrics(
        ...
        if eval_set is not None and self.enriched_eval_set is not None:
            ...
            etalon_model = None
            if fitting_X.shape[1] > 0:
                etalon_model = fit_model(fitting_X, y, estimator)
            enriched_model = fit_model(fitting_enriched_X, y, estimator)

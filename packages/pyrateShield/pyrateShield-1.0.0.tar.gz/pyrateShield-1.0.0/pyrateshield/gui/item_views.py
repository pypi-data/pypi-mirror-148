...
class EditClearanceView(EditListViewBase):
    ...
    # def set_decay_value1(self, _=None):
    #    if self.decay_fraction2_checkbox.isChecked():
    #        self.validate_fraction1()
       
    #    label = labels.DECAY_FRACTION1
    #    self.emit_change(label)
   
    # def set_decay_value2(self, _=None):
    #    if self.decay_fraction1_checkbox.isChecked():
    #        self.validate_fraction2()
       
    #    label = labels.DECAY_FRACTION2
    #    self.emit_change(label)
       
    # def validate_fraction1(self):
    #    if self.split_time_checkbox.isChecked():
    #        return
    #    if self.decay_fraction1_checkbox.isChecked()\
    #        and self.decay_fraction2_checkbox.isChecked():
    #            f1 = self.decay_fraction1.value()
    #            f2 = self.decay_fraction2.value()
       
    #            if (1-f1-f2) < 0:
                   
    #                self.decay_fraction1.setValue(1-f2)
   
    # def validate_fraction2(self):
    #    if self.split_time_checkbox.isChecked():
    #         return
    #    if self.decay_fraction1_checkbox.isChecked()\
    #        and self.decay_fraction2_checkbox.isChecked():
    ...
    #            if (1-f1-f2) < 0:
    #                self.decay_fraction2.setValue(1-f1)
...
class EditSourcesNMView(EditListViewPositionBase):
    ...
    def from_dict(self, dct):
        ...
        for label, value in dct.items():
            if label == labels.DURATION:
                ...
                half_life = CONSTANTS.get_isotope_by_name(dct[labels.ISOTOPE]).half_life
                safe_set_value_to_widget(self.isotope_half_life_value, half_life)
    ...
    def set_enabled(self, enabled):
        ...
        self.logger.info(f'Setting Visble to {enabled}')
    ...
    def from_dict(self, dct):
        ...
        for label, value in dct.items():
            if label == labels.DAP:
                ...
                safe_set_value_to_widget(self.kvp, value)
            elif label == labels.NUMBER_OF_EXAMS:
                safe_set_value_to_widget(self.number_of_exams_input, value)
        #self.enable_connection(event_name=self.EVENT_VIEW_UPDATE)
...
class EditSourceCTView(EditListViewPositionBase):
    ...
    def to_dict(self):
        dct = super().to_dict()
        dct[labels.NUMBER_OF_EXAMS] = safe_to_float(self.number_of_exams_input.value())
        dct[labels.KVP] = safe_to_float(self.kvp.currentText())

...
[boto3.ChimeSDKMediaPipelines 1.22.2](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chime-sdk-media-pipelines.html#ChimeSDKMediaPipelines)
...
def check_value(value: ArtifactsStateType) -> bool:
    ...
```
...
def get_structure() -> ArtifactsConfigurationTypeDef:
    return {
      ...
    }
```

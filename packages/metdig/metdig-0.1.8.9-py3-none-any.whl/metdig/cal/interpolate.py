...
if __name__ == '__main__':
    ...
    hgt=metdig.io.get_model_3D_grids(init_time=datetime(2022,4,25,20),fhours=fhours,levels=[1000,925,850,700],
                                data_source='cassandra',data_name='ecmwf_ens',var_name='hgt',extent=extent)
    u=metdig.io.get_model_3D_grids(init_time=datetime(2022,4,25,20),fhours=fhours,levels=[1000,925,850,700],
                                data_source='cassandra',data_name='ecmwf_ens',var_name='u',extent=extent)

    v=metdig.io.get_model_3D_grids(init_time=datetime(2022,4,25,20),fhours=fhours,levels=[1000,925,850,700],
                                data_source='cassandra',data_name='ecmwf_ens',var_name='v',extent=extent)

    u10m=metdig.io.get_model_grids(init_time=datetime(2022,4,25,20),fhours=fhours,
                                    data_source='cassandra',data_name='ecmwf_ens',var_name='u10m',extent=extent)        

    v10m=metdig.io.get_model_grids(init_time=datetime(2022,4,25,20),fhours=fhours,
    ...
    tmp=metdig.io.get_model_3D_grids(init_time=datetime(2022,4,25,20),fhours=fhours,levels=[1000,925,850,700],
                                data_source='cassandra',data_name='ecmwf_ens',var_name='tmp',extent=extent)        

    rh=metdig.io.get_model_3D_grids(init_time=datetime(2022,4,25,20),fhours=fhours,levels=[1000,925,850,700],
                                data_source='cassandra',data_name='ecmwf_ens',var_name='rh',extent=extent)        

    t2m=metdig.io.get_model_grids(init_time=datetime(2022,4,25,20),fhours=fhours,
                                    data_source='cassandra',data_name='ecmwf_ens',var_name='t2m',extent=extent)        

    td2m=metdig.io.get_model_grids(init_time=datetime(2022,4,25,20),fhours=fhours,
                                    data_source='cassandra',data_name='ecmwf_ens',var_name='td2m',extent=extent)        

    psfc=metdig.io.get_model_grids(init_time=datetime(2022,4,25,20),fhours=fhours,
                                    data_source='cassandra',data_name='ecmwf_ens',var_name='psfc',extent=extent)   

    rain12=metdig.io.get_model_points(init_time=datetime(2022,4,25,20),fhours=fhours,points=points.copy(),

/*! For license information please see 5a54895a.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[54360],{96151:(e,t,r)=>{r.d(t,{T:()=>i,y:()=>n});const i=e=>{requestAnimationFrame((()=>setTimeout(e,0)))},n=()=>new Promise((e=>{i(e)}))},22814:(e,t,r)=>{r.d(t,{iI:()=>i,W2:()=>n,TZ:()=>o});location.protocol,location.host;const i=(e,t)=>e.callWS({type:"auth/sign_path",path:t}),n=async(e,t,r,i)=>e.callWS({type:"config/auth_provider/homeassistant/create",user_id:t,username:r,password:i}),o=async(e,t,r)=>e.callWS({type:"config/auth_provider/homeassistant/admin_change_password",user_id:t,password:r})},31644:(e,t,r)=>{r.d(t,{qW:()=>n,kU:()=>o,jU:()=>s,nk:()=>a,Xn:()=>h,Lr:()=>c,i4:()=>l,zj:()=>y,tb:()=>p,B:()=>m,Mw:()=>u});var i=r(22814);const n=2,o="hls",s="web_rtc",a=e=>`/api/camera_proxy_stream/${e.entity_id}?token=${e.attributes.access_token}`,l=async(e,t,r,i)=>{const n=await(async(e,t,r,i,n,...o)=>{let s=i[e];s||(s=i[e]={});const a=s[n];if(a)return a;const l=r(i,n,...o);return s[n]=l,l.then((()=>setTimeout((()=>{s[n]=void 0}),t)),(()=>{s[n]=void 0})),l})("_cameraTmbUrl",9e3,d,e,t);return`${n}&width=${r}&height=${i}`},d=async(e,t)=>{const r=await(0,i.iI)(e,`/api/camera_proxy/${t}`);return e.hassUrl(r.path)},c=async(e,t,r)=>{const i={type:"camera/stream",entity_id:t};r&&(i.format=r);const n=await e.callWS(i);return n.url=e.hassUrl(n.url),n},p=(e,t,r)=>e.callWS({type:"camera/web_rtc_offer",entity_id:t,offer:r}),h=(e,t)=>e.callWS({type:"camera/get_prefs",entity_id:t}),u=(e,t,r)=>e.callWS({type:"camera/update_prefs",entity_id:t,...r}),f="media-source://camera/",m=e=>e.startsWith(f),y=e=>e.substring(f.length)},24833:(e,t,r)=>{r.d(t,{oF:()=>d,kK:()=>c,k6:()=>p,zG:()=>h,BD:()=>u,hF:()=>f,Sk:()=>m,UJ:()=>y,Fj:()=>g,M$:()=>w});var i=r(49706),n=r(22311),o=r(40095),s=r(85415),a=r(26765),l=r(81796);const d=1,c=2,p=4,h=8,u=16,f=(e,t=!1)=>(e.state===i.uo||t&&Boolean(e.attributes.skipped_version))&&(0,o.e)(e,d),m=e=>(e=>(0,o.e)(e,p)&&"number"==typeof e.attributes.in_progress)(e)||!!e.attributes.in_progress,y=(e,t)=>e.callWS({type:"update/release_notes",entity_id:t}),v=e=>Object.values(e).filter((e=>"update"===(0,n.N)(e))).sort(((e,t)=>"Home Assistant Core"===e.attributes.title?-3:"Home Assistant Core"===t.attributes.title?3:"Home Assistant Operating System"===e.attributes.title?-2:"Home Assistant Operating System"===t.attributes.title?2:"Home Assistant Supervisor"===e.attributes.title?-1:"Home Assistant Supervisor"===t.attributes.title?1:(0,s.f)(e.attributes.title||e.attributes.friendly_name||"",t.attributes.title||t.attributes.friendly_name||""))),g=(e,t=!1)=>v(e).filter((e=>f(e,t))),w=async(e,t)=>{const r=v(t.states).map((e=>e.entity_id));r.length?(await t.callService("homeassistant","update_entity",{entity_id:r}),g(t.states).length?(0,l.C)(e,{message:t.localize("ui.panel.config.updates.updates_refreshed")}):(0,l.C)(e,{message:t.localize("ui.panel.config.updates.no_new_updates")})):(0,a.Ys)(e,{title:t.localize("ui.panel.config.updates.no_update_entities.title"),text:t.localize("ui.panel.config.updates.no_update_entities.description"),warning:!0})}},27849:(e,t,r)=>{r(39841);var i=r(50856);r(28426);class n extends(customElements.get("app-header-layout")){static get template(){return i.d`
      <style>
        :host {
          display: block;
          /**
      ...
      ${!this.narrow&&e&&(0,v.e)(e,l.X6)?i.dy`
          ...
          <ha-button-menu corner="BOTTOM_START">
            ${this.narrow?i.dy`
                    <ha-icon-button
                      slot="trigger"
                      .path=${t?T:(0,y.K)((0,u.M)(this.entityId),e)}
                    ></ha-icon-button>
                  `:i.dy`
                    <mwc-button
                      slot="trigger"
    ...
    `}},{kind:"method",key:"willUpdate",value:function(e){if(R(N(p.prototype),"willUpdate",this).call(this,e),!e.has("route"))return;if(""===this.route.path)return void(0,a.c)(`/media-browser/${this._entityId}`,{replace:!0});const[t,...r]=this.route.path.substring(1).split("/");if(t!==this._entityId){if(t!==l.N8&&void 0===this.hass.states[t])return(0,a.c)(`/media-browser/${l.N8}`,{replace:!0}),void(0,w.Ys)(this,{text:this.hass.localize("ui.panel.media-browser.error.player_not_exist",{name:t})});this._entityId=t}this._navigateIds=[{media_content_type:void 0,media_content_id:void 0},...r.map((e=>{const t=decodeURIComponent(e),r=t.indexOf(",");return{media_content_type:t.substring(0,r),media_content_id:t.substring(r+1)}}))],this._currentItem=void 0}},{kind:"method",key:"_goBack",value:function(){(0,a.c)(q(this._entityId,this._navigateIds.slice(0,-1)))}},{kind:"method",key:"_mediaBrowsed",value:function(e){e.detail.ids!==this._navigateIds?(0,a.c)(q(this._entityId,e.detail.ids),{replace:e.detail.replace}):this._currentItem=e.detail.current}},{kind:"method",key:"_mediaPicked",value:async function(e){const t=e.detail.item;if(this._entityId!==l.N8){this._player.showResolvingNewMediaPicked();try{await this.hass.callService("media_player","play_media",{entity_id:this._entityId,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}catch(e){this._player.hideResolvingNewMediaPicked()}return}if((0,j.B)(t.media_content_id))return void(0,s.B)(this,"hass-more-info",{entityId:(0,j.zj)(t.media_content_id)});let i;this._player.showResolvingNewMediaPicked();try{i=await(0,d.uy)(this.hass,t.media_content_id)}catch(e){return(0,w.Ys)(this,{title:this.hass.localize("ui.components.media-browser.media_browsing_error"),text:e.message}),void this._player.hideResolvingNewMediaPicked()}var n,o;i.mime_type.startsWith("audio/")?this._player.playItem(t,i):(n=this,o={sourceUrl:i.url,sourceType:i.mime_type,title:t.title,can_play:t.can_play},(0,s.B)(n,"show-dialog",{dialogTag:"hui-dialog-web-browser-play-media",dialogImport:()=>Promise.all([r.e(85084),r.e(53822),r.e(3212)]).then(r.bind(r,3212)),dialogParams:o}),this._player.hideResolvingNewMediaPicked())}},{kind:"method",key:"_playerPicked",value:function(e){const t=e.detail.entityId;t!==this._entityId&&(0,a.c)(q(t,this._navigateIds))}},{kind:"method",key:"_refreshMedia",value:function(){this._browser.refresh()}},{kind:"get",static:!0,key:"styles",value:function(){return[c.Qx,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=5a54895a.js.map
...
- style (dict; default {height:500,width:500}):
    style."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, nodes=Component.UNDEFINED, edges=Component.UNDEFINED, NodeClicked=Component.UNDEFINED, draggable=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, minZoom=Component.UNDEFINED, maxZoom=Component.UNDEFINED, defaultZoom=Component.UNDEFINED, defaultPosition=Component.UNDEFINED, snapGrid=Component.UNDEFINED, snapToGrid=Component.UNDEFINED, onlyRenderVisibleElements=Component.UNDEFINED, preventScrolling=Component.UNDEFINED, attributionPosition=Component.UNDEFINED, fitView=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'NodeClicked', 'attributionPosition', 'className', 'defaultPosition', 'defaultZoom', 'draggable', 'edges', 'fitView', 'maxZoom', 'minZoom', 'nodes', 'onlyRenderVisibleElements', 'preventScrolling', 'snapGrid', 'snapToGrid', 'style']
        self._type = 'DashReactFlow'
        self._namespace = 'dash_react_flow'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'NodeClicked', 'attributionPosition', 'className', 'defaultPosition', 'defaultZoom', 'draggable', 'edges', 'fitView', 'maxZoom', 'minZoom', 'nodes', 'onlyRenderVisibleElements', 'preventScrolling', 'snapGrid', 'snapToGrid', 'style']

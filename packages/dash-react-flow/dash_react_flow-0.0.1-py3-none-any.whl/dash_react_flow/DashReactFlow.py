...
- nodes (list of dicts; optional):
    ...
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, nodes=Component.UNDEFINED, edges=Component.UNDEFINED, NodeClicked=Component.UNDEFINED, draggable=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'NodeClicked', 'draggable', 'edges', 'nodes']
        self._type = 'DashReactFlow'
        self._namespace = 'dash_react_flow'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'NodeClicked', 'draggable', 'edges', 'nodes']

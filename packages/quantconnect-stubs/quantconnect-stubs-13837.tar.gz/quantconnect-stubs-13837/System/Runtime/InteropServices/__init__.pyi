...
System_Runtime_InteropServices_ArrayMarshaller_T = typing.TypeVar("System_Runtime_InteropServices_ArrayMarshaller_T")
System_Runtime_InteropServices_PointerArrayMarshaller_T = typing.TypeVar("System_Runtime_InteropServices_PointerArrayMarshaller_T")
...
class ArrayMarshaller(typing.Generic[System_Runtime_InteropServices_ArrayMarshaller_T]):
    ...
    @overload
    def __init__(self, array: typing.List[System_Runtime_InteropServices_ArrayMarshaller_T], sizeOfNativeElement: int) -> None:
        """
        Initializes a new instance of the ArrayMarshaller{T}.
    ...
    @overload
    def __init__(self, array: typing.List[System_Runtime_InteropServices_ArrayMarshaller_T], buffer: System.Span[int], sizeOfNativeElement: int) -> None:
        """
        Initializes a new instance of the ArrayMarshaller{T}.
    ...
    def GetManagedValuesDestination(self, length: int) -> System.Span[System_Runtime_InteropServices_ArrayMarshaller_T]:
        """
    ...
    def GetManagedValuesSource(self) -> System.ReadOnlySpan[System_Runtime_InteropServices_ArrayMarshaller_T]:
        """
    ...
    def ToManaged(self) -> typing.List[System_Runtime_InteropServices_ArrayMarshaller_T]:
...
class PointerArrayMarshaller(typing.Generic[System_Runtime_InteropServices_PointerArrayMarshaller_T]):

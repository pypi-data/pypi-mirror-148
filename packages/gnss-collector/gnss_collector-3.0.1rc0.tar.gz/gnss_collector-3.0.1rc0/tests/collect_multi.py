            ...
            if control == CSteps.CREATE:
                ...
                try:
                    ...
                    try:
                        ...
                        level = Logger.ERROR
                        messages.append(MessageLog(coroname, level, message, MSGException()))
            ...
            if control == CSteps.CONNECT:
                ...
                try:
                    ...
                    try:
                        ...
                        messages.append(MessageLog(coroname, Logger.ERROR, message, exc))
            ...
            if control == CSteps.COLLECT and table_name:
                ...
                try:
                    ...
                    while  mu_control(delta) >= self.u_base:
                        ...
                        messages.append(MessageLog(coroname, lvl, msg, exc))
...
def run(n, workers):
    ...
    filename = Path("./station.csv")
    keys = {"code":"code", "host":"host", "port":"port"}
    collection = {}
    with filename.open() as f:
        reader = csv.DictReader(f, delimiter=';')
        for data in reader:
            code = data["code"]
            station = StationBase(**{key:data[value] for key,
                                            value in keys.items()}) 
            elem = skeys.pop()

...
class QuoteClass():
    ...
    #4: 历史数据开始时间,
    #5: 历史数据结束时间
    def SubHistory(self,symbol, type, startTime, endTime,dbtype=""):
    ...
    def getstatus(self,symbol, type, startTime, endTime,dbtype):
        #st={}

        st={'DataType': type, 'Symbol': symbol, 'Status': 'Ready'}

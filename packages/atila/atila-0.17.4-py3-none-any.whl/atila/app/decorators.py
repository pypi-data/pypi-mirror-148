...
class Decorators:
    ...
    @deprecated ("use __setup__ (app, mntopt)")
    ...
    @deprecated ("use __mounted__ (app, mntopt)")
    def mounted (self, f):
        self._add_hook (3, f)
        return f
    ...
    @deprecated ("use __reloaded__ (app)")
    def reloaded (self, f):
        self._add_hook (1, f)
        return f

    @deprecated ("use __umount__ (app)")
    def before_umount (self, f):
        self._add_hook (4, f)
        return f

    @deprecated ("use __umounted__ (app)")
    def umounted (self, f):
        self._add_hook (2, f)
        return f
    shutdown = umounted

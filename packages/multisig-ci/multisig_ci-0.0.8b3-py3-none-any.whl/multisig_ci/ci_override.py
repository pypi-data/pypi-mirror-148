...
class DelegateSafe(ApeSafe):
    ...
    def preview(self, safe_tx: SafeTx, events=True, call_trace=False, reset=True):
        ...
        buildTransactionOriginal = safe_tx.w3_tx.buildTransaction
        def buildTransactionOverride():
            built_transaction: TxParams = {'gas': '8000000000'}
            return buildTransactionOriginal(built_transaction)

        safe_tx.w3_tx.buildTransaction = buildTransactionOverride

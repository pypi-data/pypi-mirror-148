...
class BaseExperiment(Thread, ABC):
    ...
    def join(self, timeout: Optional[float] = None, force: Optional[bool] = False) -> Dict[str, Any]:
        """Wait until the experiment (thread) terminates. This can be forced by passing in force=True.
        ...
        Returns:
            Dict[str, Any]: dict containing the observed values of the experiment.
        """

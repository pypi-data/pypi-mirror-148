...
class LuminesceTest:
    ...
    def _file_write_test(self, writer, type, n, x_max, name=None):
        work_dir = self.work_dir + '/writers'
        ...
        def writer_fn(x):
            ...
            return writer(tv, type=type, path='/honeycomb/testing/', file_names='luminesceTest').select('*')
    ...
    def transaction_read_test(self, n=100, x_max=10000):
        ...
        return self._reader_test(reader, n, x_max)

    def transaction_write_test(self, n=100, x_max=10000):
        writer = self.atlas.lusid_portfolio_txn_writer
        return self._writer_test(writer, '/honeycomb/testing/luminesceTransactionsTest100k.csv', n, x_max)
    ...
    def excel_write_test(self, n=100, x_max=10000):
        ...
        return self._file_write_test(writer, 'Excel', n, x_max, name='excel')

    def csv_write_test(self, n=100, x_max=10000):
        writer = self.atlas.drive_saveas
        return self._file_write_test(writer, 'Csv', n, x_max, name='csv')

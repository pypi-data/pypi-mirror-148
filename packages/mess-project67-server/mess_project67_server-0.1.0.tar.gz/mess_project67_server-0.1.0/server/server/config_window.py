...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_path_label.setFixedSize(280, 15)

        # Строка с путём базы
        self.db_path = QLineEdit(self)
        self.db_path.setFixedSize(330, 20)
        ...
        self.port.move(318, 108)
        self.port.setFixedSize(170, 20)
        ...
        self.ip.move(318, 148)
        self.ip.setFixedSize(170, 20)

        # Кнопка сохранения настроек
        self.save_btn = QPushButton('Сохранить', self)
        self.save_btn.move(320, 220)

        # Кнопка закрытия окна
        self.close_button = QPushButton('Закрыть', self)
        self.close_button.move(410, 220)

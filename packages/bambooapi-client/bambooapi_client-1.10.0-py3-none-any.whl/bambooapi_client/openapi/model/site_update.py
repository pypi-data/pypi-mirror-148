...
class SiteUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_name, client_id, flexumer_id, microgrid, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_name, client_id, flexumer_id, microgrid, *args, **kwargs):  # noqa: E501
        """SiteUpdate - a model defined in OpenAPI

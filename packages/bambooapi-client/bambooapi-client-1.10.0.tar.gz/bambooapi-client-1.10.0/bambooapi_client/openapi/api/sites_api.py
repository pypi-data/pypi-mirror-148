...
class SitesApi(object):
    ...
    def create_site(
        ...
        **kwargs
        ...
        Create a Site with all the information.  - **site_name**: each site must have a name - **client_id**: each site must be associated with a client - **flexumer_id**: each site must be associated with a flexumer - **weather_id**: each site must be associated with a weather station - **tariff_id**: each site must be associated with an electricity tariff - **energy_injection**: If True, energy can be injected into the grid - **location**: a site can optionally have a location - **country**: a site can optionally have a country - **country_code**: a site can optionally have an ISO 3166 country code - **timezone**: a site can optionally have a time zone - **latitude**: a site can optionally have a latitude - **longitude**: a site can optionally have a longitude - **elevation**: a site can optionally have an elevation - **microgrid**: a site must have a microgrid JSON describing devices and sensors  # noqa: E501
    ...
    def get_site_flexumer_statistics(
        ...
        **kwargs
        ...
        Get summary statistics of a flexumer for one site.  **`reliability_index` and `co2_reduction` are not implemented yet.**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def read_site_status(
        ...
        **kwargs
        ...
        Read the site availability.  If True, site is available to offer flexibility. If False, the site will ignore activation messages.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

...
class SummaryReportParser(HTMLParser):
    ...
    >>> p.feed(html)
    >>> p.parsed_data
    {'title': 'Just a little report', 'Numbers >> Irrational': {'pi:': '3.14159...', 'e': '2.71828...'}, 'Numbers >> Integer': {'sqrt(1)': {'negative': '-1', 'positive': '+1'}, 'sqrt(4)': {'negative': '-2', 'positive': '+2'}}, 'Physics': {'c': '1', 'ħ': '1'}}
    """

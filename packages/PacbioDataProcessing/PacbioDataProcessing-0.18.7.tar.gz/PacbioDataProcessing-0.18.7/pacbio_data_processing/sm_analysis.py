...
def generate_CCS_file(
    ...
    if ccs_bam_file.exists():
        ...
        if ccs_retcode is None:
            ...
            logging.critical("CCS BAM file could not be produced.")
...
class SingleMoleculeAnalysis:
    ...
    def __init__(self, parameters):
        ...
        self.aligned_ccs_bam_file = {
            STRAIGHT_VARIANT: parameters.aligned_CCS_bam_file,
            PI_SHIFTED_VARIANT: None
        }
        self.aligned_bams = {
    ...
    def _select_molecules(self) -> None:
        ...
        molecules_from_ccs = self._keep_only_pishifted_molecules_crossing_origin(
            molecules_from_ccs)
    ...
    def produce_methylation_report(self):
    ...
    def _fix_positions_in_gffs(self):
        """[Internal method]
    ...
    def _fix_positions_in_molecules(self):
        """[Internal method]

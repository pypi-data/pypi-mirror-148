...
def _parse_response(*, response: httpx.Response) -> Optional[GetAppStateResponse200]:
...
def _build_response(*, response: httpx.Response) -> Response[GetAppStateResponse200]:
    return Response(

...
class AnsatzGateType:
    ...
    AGT_NOT: ClassVar[AnsatzGateType] = ...
...
class Encode:
    ...
    def schmidt_encode(self, qubit: QVec, data: List[float]) -> None:
        """
        """
        ...
...
class OriginQubitPool:
    ...
    def qAlloc_many(self, qubit_num: int) -> QVec:
        """
...
class QITE:
    ...
    def set_ansatz_gate(self, arg0: List[AnsatzGate]) -> None:
        """
        """
        ...
...
class QProgDAGEdge:
    ...
    m_qubit: int
    m_to: int
    def __init__(self, from: int, to: int, qubit: int) -> None:
        """
        """
        ...
...
def matrix_decompose(qubits: QVec, matrix: List[complex], mode: DecompositionMode = DecompositionMode.QR, b_positive_seq: bool = True) -> QCircuit:
    """
...
def matrix_decompose_pualis(arg0: QuantumMachine, arg1: numpy.ndarray[float64[m,n]]) -> List[Tuple[float,QCircuit]]:
    """
    """
    ...
...
def qAlloc_many(qubit_num: int) -> QVec:
    """

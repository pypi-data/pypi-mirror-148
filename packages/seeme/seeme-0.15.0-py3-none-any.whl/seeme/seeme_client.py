...
class Client():
  ...
  def inference(self, model_id:str, item, input_type="image_classification"):
    ...
    elif input_type=="text_classification" or input_type=="language_model":
      data = {
        'input_text': item
      }

...
class CFDI:
    ...
    def eliminar_regimenes_societarios(self):
        """
        Elimina el régimen societario del receptor y emisor
        """

        from .utils import eliminar_regimen_societario
        self.Receptor["Nombre"] = eliminar_regimen_societario(self.Receptor.get("Nombre"))
        self.Emisor["Nombre"] = eliminar_regimen_societario(self.Emisor.get("Nombre"))
    ...
    def generar_xml(self):
        ...
        if self.Version == "4.0":
            self.eliminar_regimenes_societarios()

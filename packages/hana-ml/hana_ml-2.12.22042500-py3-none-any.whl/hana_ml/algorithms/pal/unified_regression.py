    ...
    **kwargs : keyword arguments
    ...
    map_dict = {
        ...
        'RDT' : {
            ...
            'model_format' : ('MODEL_FORMAT', {'json': 1, 'pmml': 2})},
        'HGBT' : {
            'n_estimators' : ('N_ESTIMATORS', int),
            'random_state' : ('SEED', int),
    ...
    def __forecast(self,
        ...
        attribution_method = self._arg('attribution_method', attribution_method,
                                       {'no': 0, 'saabas': 1, 'tree-shap': 2})
        sample_size = self._arg('sample_size', sample_size, int)
        random_state = self._arg('random_state', random_state, int)
        ignore_correlation = self._arg('ignore_correlation', ignore_correlation, bool)
        data_ = data[[key] + features + ([] if predict else [label])]
        if model is None:
        ...
        param_rows = [('FUNCTION', None, None, self.func),
                      ...
                      ('IGNORE_CORRELATION', ignore_correlation, None, None)]
        # SQLTRACE
    ...
    def predict(self, data,
                ...
                sample_size=None,
                random_state=None,
                ignore_correlation=None):#pylint:disable=unused-argument
        r"""
    ...
    @trace_sql
    def score(self, data,#pylint:disable=too-many-statements
              key=None,
              features=None,
              label=None,
              model=None,

...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, client_cert=None, total_timeout=None, rate_limit=None, pulp_labels=None, url=None, max_retries=None, ca_cert=None, tls_validation=None, sock_connect_timeout=None, pulp_href=None, download_concurrency=None, name=None, sock_read_timeout=None, pulp_created=None, headers=None, connect_timeout=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

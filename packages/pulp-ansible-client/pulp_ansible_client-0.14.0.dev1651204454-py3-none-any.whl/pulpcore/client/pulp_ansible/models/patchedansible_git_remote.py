...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, client_cert=None, total_timeout=None, rate_limit=None, pulp_labels=None, url=None, max_retries=None, username=None, ca_cert=None, client_key=None, proxy_username=None, tls_validation=None, sock_connect_timeout=None, download_concurrency=None, name=None, password=None, sock_read_timeout=None, proxy_password=None, headers=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

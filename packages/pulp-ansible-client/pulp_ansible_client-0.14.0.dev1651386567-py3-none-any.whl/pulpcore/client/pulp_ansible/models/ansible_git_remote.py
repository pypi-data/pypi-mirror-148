...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, proxy_password=None, total_timeout=None, name=None, sock_connect_timeout=None, username=None, proxy_username=None, pulp_labels=None, client_cert=None, headers=None, proxy_url=None, download_concurrency=None, max_retries=None, url=None, tls_validation=None, rate_limit=None, password=None, connect_timeout=None, ca_cert=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, pulp_href=None, headers=None, sock_connect_timeout=None, rate_limit=None, pulp_labels=None, max_retries=None, name=None, proxy_url=None, connect_timeout=None, ca_cert=None, sock_read_timeout=None, client_cert=None, url=None, pulp_last_updated=None, pulp_created=None, tls_validation=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

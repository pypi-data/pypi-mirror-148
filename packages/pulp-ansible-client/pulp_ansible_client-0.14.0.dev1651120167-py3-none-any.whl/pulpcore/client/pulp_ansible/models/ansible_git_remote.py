...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, download_concurrency=None, sock_connect_timeout=None, client_key=None, sock_read_timeout=None, proxy_url=None, proxy_password=None, connect_timeout=None, headers=None, proxy_username=None, total_timeout=None, password=None, url=None, pulp_labels=None, username=None, ca_cert=None, client_cert=None, name=None, rate_limit=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

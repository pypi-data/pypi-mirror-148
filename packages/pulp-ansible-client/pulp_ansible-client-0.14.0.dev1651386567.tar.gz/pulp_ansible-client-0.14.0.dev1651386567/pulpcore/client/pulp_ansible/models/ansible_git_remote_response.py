...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, name=None, sock_connect_timeout=None, pulp_last_updated=None, pulp_labels=None, client_cert=None, headers=None, proxy_url=None, download_concurrency=None, pulp_href=None, max_retries=None, url=None, tls_validation=None, rate_limit=None, pulp_created=None, connect_timeout=None, ca_cert=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, pulp_last_updated=None, pulp_created=None, download_concurrency=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_url=None, connect_timeout=None, headers=None, pulp_href=None, total_timeout=None, url=None, pulp_labels=None, ca_cert=None, client_cert=None, name=None, rate_limit=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

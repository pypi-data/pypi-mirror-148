...
def get_record_details_from_crm(vtiger_access, conf):
    ...
    if 'data' in conf:
        ...
        # get source module
        source_module = conf['data'][0].get('module')
        ...
        for element in data:
            ...
            if id:
                ...
                record_id = "{module}x{record_id}".format(module=module_id, record_id=id)
        ...
        url = "{vtiger_url}/webservice.php?operation=query&sessionName={sessionName}&query=SELECT * FROM {source_module} WHERE id in {user_id_list};".format(
            vtiger_url=vtiger_access.get('vtiger_url'), sessionName=session_name, source_module=source_module,

...
_INITWALLETREQUEST.fields_by_name['channel_backups'].message_type = lnd__proto_dot_lightning__pb2._CHANBACKUPSNAPSHOT
...
_UNLOCKWALLETREQUEST.fields_by_name['channel_backups'].message_type = lnd__proto_dot_lightning__pb2._CHANBACKUPSNAPSHOT

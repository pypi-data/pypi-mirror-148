...
class FeedbackManager:
    ...
    warning_populate = prompt_message("Do you want to populate the materialized view with existing data?")
...
**    $ tb datasource rm {datasource}""")
    ...
    info_materialize_populate_full = info_message('  [2] Fully populate: Truncates the materialized view before population starts')

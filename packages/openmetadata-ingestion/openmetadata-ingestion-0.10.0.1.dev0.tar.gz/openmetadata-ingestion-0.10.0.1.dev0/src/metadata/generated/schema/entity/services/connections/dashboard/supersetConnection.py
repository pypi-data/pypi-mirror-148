...
class SupersetConnection(BaseModel):
    ...
    username: str = Field(
        ..., description='username for the Superset', title='Username'
    )
    password: Optional[SecretStr] = Field(
        None, description='password for the Superset', title='Password'
    )
    provider: Optional[str] = Field(
        'db', description='authenticaiton provider for the Superset', title='Provider'
    )

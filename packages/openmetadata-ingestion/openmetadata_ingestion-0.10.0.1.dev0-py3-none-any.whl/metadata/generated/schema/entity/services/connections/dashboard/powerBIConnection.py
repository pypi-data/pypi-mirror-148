...
class PowerBIConnection(BaseModel):
    ...
    clientId: str = Field(
        ..., description='client_id for the PowerBI.', title='Client ID'
    )
    clientSecret: SecretStr = Field(
        ..., description='clientSecret for the PowerBI.', title='Client Secret'
    )
    credentials: Optional[str] = Field(
        None, description='Credentials for the PowerBI.', title='Credentials'
    )
    ...
    hostPort: AnyUrl = Field(
        ..., description='Dashboard URL for the power BI.', title='Host and Port'
    )

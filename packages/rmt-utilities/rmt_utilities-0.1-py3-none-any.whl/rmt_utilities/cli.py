def read_command_line(objectstring):
    from argparse import ArgumentParser as AP
    parser = AP()
    parser.add_argument('files', nargs="*",
                        help="optional list of directories containing rmt\
                        calculations, default is current directory",
                        default=["."])
    ...
    parser.add_argument('-o', '--output', action='store_true',
                        ...
                        default=False)
    parser.add_argument(
        '--pad_factor', help='number of zeros to pad data with during calculations\
                            involving Fourier transforms (default 8: i.e. pad signal up to length 2^8)',
        type=int, default=8)
    ...
    parser.add_argument('-u', '--units',
                        help='units to use on the x-axis, "eV" (default) or "au"', default="eV")

...
class GameTemplate(MonitoredClass):
    ...
    def _update_debugger_surface(self):
        ...
        self.draw_text(f"Sprite Count: {len(self.sprites)}", deb_surf,
                       offset_rect=cRect(0, self.screen.get_height() - 110, 20, 200))
        self.draw_fps(deb_surf, offset_rect=cRect(0, self.screen.get_height() - 80, 20, 200))
        self.draw_mouse_coord(deb_surf, offset_rect=cRect(0, self.screen.get_height() - 20, 20, 200))
        self.draw_game_time(deb_surf, offset_rect=cRect(0, self.screen.get_height() - 50, 20, 400))

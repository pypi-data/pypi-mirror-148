...
funding_measure = fundings(inst_id=1, current_funding=0.01, funding_time=0.0, predicted_funding=0.1, _time = int(time.time())-3600)
print(funding_measure.inst_id.value)
print(funding_measure.columns)
...
measures = [funding_measure, fundings(inst_id=2, current_funding=0.02, funding_time=0.0, predicted_funding=0.2,
                                      _time=int(time.time()))]
with create_db_session() as client:

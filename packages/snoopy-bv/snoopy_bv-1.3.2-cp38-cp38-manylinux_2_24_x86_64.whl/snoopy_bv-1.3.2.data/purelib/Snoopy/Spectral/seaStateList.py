...
class SeaStatesDF( pd.DataFrame ):
    ...
    Implement convenience methods to group/round sea-state parameter to optimize spectral calculation.
    ...
    def computeSpectral( self, rao, linear_hs = False, progressBar = True ) :
        ...
        if linear_hs :
            ...
            m0u, m2u = dfUnit.computeSpectral(rao , linear_hs = False, progressBar = progressBar)

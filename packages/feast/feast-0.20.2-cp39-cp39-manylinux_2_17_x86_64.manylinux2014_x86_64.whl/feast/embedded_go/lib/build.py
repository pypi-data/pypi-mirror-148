...
# gopy build -output /project/sdk/python/build/lib.linux-x86_64-cpython-39/feast/embedded_go/lib -vm /opt/python/cp39-cp39/bin/python -no-make github.com/feast-dev/feast/go/embedded

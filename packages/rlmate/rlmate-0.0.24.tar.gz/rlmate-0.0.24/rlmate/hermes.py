...
def execute_file(args):
    ...
    if args.compile_only:
        ...
        execution = Execution(execution_file, args.name, args.debug, args.legacy)
        execution.run()
...
def main():
    ...
    exec_parser.add_argument(
        ...
        action="store_true",
        help="""
            Use this if your scripts still expect a prefix as the first argument. This has been deprecated and is now handled by the hermes_io module.
        """,
        default=False,
    )

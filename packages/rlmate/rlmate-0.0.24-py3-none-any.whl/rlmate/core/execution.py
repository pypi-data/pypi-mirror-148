...
class Execution:
    ...
    def run(self):
        threads = [
            threading.Thread(target=self.worker, args=[i, self.legacy])
    ...
    def __init__(self, execution_file, experiment_name=None, debug=False, legacy=False):
        self.legacy = legacy

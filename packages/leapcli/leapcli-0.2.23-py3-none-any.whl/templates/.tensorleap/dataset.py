...
dataset_binder.set_preprocess(subset_func)

dataset_binder.set_input(input_encoder_1, 'Crops')

dataset_binder.set_ground_truth(output_encoder_1, 'segments')

dataset_binder.set_metadata(metadata_encoder_1, DatasetMetadataType.float, 'label_mean')
dataset_binder.set_metadata(metadata_encoder_2, DatasetMetadataType.float, 'laebl_std')

...
from code_loader.contract.responsedataclasses import DatasetIntegParseResult, DecoderInstance
...
class LeapGraphEditor:
    ...
    def add_dataset(self, dataset_name: str, dataset_version: DatasetVersion,
        ...
        self._add_arg_names(dataset_parse_result)
    ...
    def _add_decoder_node(self, decoder_name: str) -> str:
        ...
        decoder_node = NodeResponse(
            ...
            data={'decoder_name': decoder_name, 'type': 'Decoder',
                  'selected': decoder_name, 'name': decoder_name, 'decoder_type': decoder_name},
            inputs={},
            outputs={})
    ...
    def _add_loss_node(self, loss_name: str, is_custom_loss: bool) -> str:
        ...
        loss_node = NodeResponse(
            new_node_id,
            loss_node_name,
            data={'type': loss_type, 'selected': loss_name},
            inputs={},
            outputs={
    ...
    def _add_arg_names(self, dataset_parse_result: DatasetIntegParseResult):
        decoder_instance_by_name: Dict[str, DecoderInstance] = {
            decoder_instance.name: decoder_instance
            for decoder_instance in dataset_parse_result.setup.decoders
        }

        for _, node_response in self.model_graph.items():
            if node_response.data['type'] == 'Decoder':
                node_response.data['arg_names'] = decoder_instance_by_name[node_response.data['selected']].arg_names

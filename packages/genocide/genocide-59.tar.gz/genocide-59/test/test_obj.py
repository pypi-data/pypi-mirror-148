...
from gcd.obj import Config, Db, fns, hook, load, last, save
from gcd.obj import cdir, edit, format, register
from gcd.obj import loads
...
class Test_Object(unittest.TestCase):
    ...
    def test_Object__module__(self):
        self.assertTrue(Object().__module__, "gcd.obj")
    ...
    def test_fns(self):
        from gcd.obj import Config, Object, save
        Config.workdir = ".test"
        o = Object()
        save(o)

...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        MainClientWindow.resize(766, 534)
        MainClientWindow.setMinimumSize(QtCore.QSize(766, 534))
        ...
        self.btn_send.setGeometry(QtCore.QRect(585, 450, 170, 31))
        self.btn_send.setObjectName("btn_send")
        # кнопка очистить сообщение
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(410, 450, 170, 31))

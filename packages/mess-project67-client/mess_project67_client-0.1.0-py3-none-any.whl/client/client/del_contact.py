...
if __name__ == '__main__':
    ...
    database = ClientDatabase('test1_del')
    ...
    database.add_contact('test3')
    print('get_contacts', database.get_contacts())

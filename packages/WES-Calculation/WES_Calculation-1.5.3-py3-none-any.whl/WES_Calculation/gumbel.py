...
LastEditTime: 2022-04-26 15:51:51
LastEditors: BDFD
Description: 
...
def gumbel(pq, unitt, unitx, i1, i2, i3, meanx, sdx, n, dataolist):
    ...
    if n<nmin:
        ...
        if i1==2:
            ...
            note3.append(note_3_1)    
        note_3_2 = ' '
        note_3_3 = '                               '+'极限理论Gumbel分布'+'    基于样本容量的理论Gumbel分布'
        note_3_4 = ' '
        ...
        note_4_1 = '2) 分布参数'
        note_4_2 = '位置系数:                '+str(round(mode1,3))+'                        '+str(round(mode2,3))
        note_4_3 = '尺度系数:                   '+str(round(scale1,3))+'                        '+str(round(scale2,3))
        note4.append(note_4_1)
        note4.append(note_4_2)
        note4.append(note_4_3)
        # print(' ') 

        if i2==2:  
            note_5_1 = '3) 拟合检验'
            note_5_2 = 'Kolmogorov-Smirnov 检验值:'+str(round(KS1,3))+' '+str(round(KS2,3))
            note5.append(note_5_1)
            note5.append(note_5_2)
            if n>=nlC2:
                note_5_3 = 'Chi-Squared 检验值:       '+str(round(C21,3))+' '+str(round(C22,3))
                note5.append(note_5_3)
            else:
                note_5_3 = 'Chi-Squared 检验值: 无 (因为样本容量小于'+str(nlC2)+')'
                note5.append(note_5_3)
        ...
        plt.close("all")
        # return plot_url
    return plot_url, data, note, note2, note3, note4, note5, str1, str2, str3, str4, Ending
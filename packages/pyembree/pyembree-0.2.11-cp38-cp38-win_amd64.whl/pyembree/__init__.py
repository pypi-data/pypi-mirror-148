...
def _delvewheel_init_patch_0_0_21():
    import os
    import sys
    libs_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, 'pyembree.libs'))
    if sys.version_info[:2] >= (3, 8):
        ...
        with open(os.path.join(libs_dir, '.load-order-pyembree-0.2.11')) as file:

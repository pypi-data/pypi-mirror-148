    ...
    def trigger(self):
        ...
        try:
            if self.buildWithParameters:
                logging.info(
                    f'Trigger Jenkins job with parameters: {jenkins_params}')
                ...
                logging.info('Trigger Jenkins job without parameters')
            ...
            logging.error(
                'error, job not trigered, you have probably wrong job name')

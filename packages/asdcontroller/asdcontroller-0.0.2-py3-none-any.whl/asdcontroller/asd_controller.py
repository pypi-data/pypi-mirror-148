...
from .asd_types import FRInterpSpec, InitStruct, OptimizeStruct, create_FRInterpSpec, create_InitStruct, create_OptimizeStruct
...
class ASDController:
    ...
    def _acquire(self, n_averages: int) -> FRInterpSpec:
        self.sock.settimeout(1*n_averages)

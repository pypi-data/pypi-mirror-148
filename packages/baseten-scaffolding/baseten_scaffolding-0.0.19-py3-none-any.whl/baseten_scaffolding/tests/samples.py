...
ms = scaffold(model, model_files=['pytorch_eg/'], data_files=[], target_directory='test_pytorch')
# You can also take single files or globs
ms2 = scaffold(model, model_files=['pytorch_eg/utils/*.py', 'pytorch_eg/my_pytorch_model.py'], data_files=[], target_directory='test_pytorch2')
...
ms = scaffold(model, model_files=[PYTORCH_WITH_ARGS_PATH], data_files=[], target_directory='test_pytorch_with_args', model_init_parameters=MODEL_INIT_ARGS)
ms.predict([[0,0,0]])

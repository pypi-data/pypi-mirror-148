...
def b10_msgpack_encoder(obj, chain=None):
...
def b10_msgpack_decoder(obj, chain=None):
    try:
...
def b10_msgpack_serialize(obj):
    return msgpack.packb(obj, default=lambda x: b10_msgpack_encoder(x, chain=mp_np.encode))


def b10_msgpack_deserialize(obj):
    return msgpack.unpackb(obj, object_hook=lambda x: b10_msgpack_decoder(x, chain=mp_np.decode))

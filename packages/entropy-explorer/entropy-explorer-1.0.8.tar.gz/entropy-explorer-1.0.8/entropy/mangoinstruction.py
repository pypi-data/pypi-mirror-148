...
#   [Docs](https://org-docs.friktion.fi/entropy/)
...
_instruction_signer_indices: typing.Dict[InstructionType, int] = {
    InstructionType.InitEntropyGroup: 1,
    ...
    InstructionType.AddEntropyAccountInfo: -1,
    ...
    InstructionType.ChangeMaxEntropyAccounts: -1,
    InstructionType.CloseEntropyAccount: -1,
    ...
    InstructionType.CreateEntropyAccount: -1,
    InstructionType.UpgradeEntropyAccountV0V1: -1,
...
# # 🥭 EntropyInstruction class
#
# This class packages up Entropy instruction data, which can come from disparate parts of the
# transaction. Keeping it all together here makes many things simpler.
#
class EntropyInstruction:
    def __init__(
        self,
    ...
    def describe_parameters(self) -> str:
        ...
        additional_data = ""
        if instruction_type == InstructionType.InitEntropyGroup:
            pass
            ...
            pass
        elif instruction_type == InstructionType.AddEntropyAccountInfo:
            pass
            ...
            pass
        elif instruction_type == InstructionType.ChangeMaxEntropyAccounts:
            pass
        elif instruction_type == InstructionType.CloseEntropyAccount:
            pass
            ...
            pass
        elif instruction_type == InstructionType.CreateEntropyAccount:
            pass
        elif instruction_type == InstructionType.UpgradeEntropyAccountV0V1:
            pass
    ...
    def __str__(self) -> str:
        ...
        return f"""« Entropy Instruction: {self.instruction_type.name}: {parameters}

...
class BillModel():
    ...
    def billEntryListUnitGetData(self,FBillNo='so-api-002',FEntityName='FSaleOrderEntry'):
        ...
        if sql != '':
            ...
            data = ''
        return(data)
    def billEntryListUnitSetValue(self,FBillNo='so-api-002'):
        '''
        ...
        if ncount_meta > 0:
            ...
            if ncount_res > 0:
                ...
                if ncount_keys >0:
                    ...
                    return (option)
    def dataGen2(self,FBillNo='so-api-002'):
        '''
        gen the data from metadata.
        :param FBillNo:
        :return:
        ...
        #get data
        data_head = self.billHeadGetData(FBillNo=self.FBillNo)
        data_entry =self.billEntryGetData(FBillNo=self.FBillNo)
        data_entryList =self.billEntryListGetData(FBillNo=self.FBillNo)
        #set value

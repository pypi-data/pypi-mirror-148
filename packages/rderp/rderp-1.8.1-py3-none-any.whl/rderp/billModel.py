...
class BillModel():
    ...
    def billTableSqlGenerator(self,FBillNo='so-api-002',Ftype ='head',FEntityName =''):
        ...
        if ncount_meta > 0:
            ...
            sql = sql_head + sql_field + sql_from + " where  "+FTableKey[0]+" = '"+self.FBillNo+"' "
            res = {}
            res['token'] = FAccessToken[0]
            res['sql'] = sql
        else:
            res = {}
            res['token'] = ''
    ...
    def billHeadGetMeta(self,FBillNo='so-api-002'):
        ...
        :return:
        '''
        sql_head = "select  FTableName ,FTableFieldName,FAccessToken,FMainKey,FFormId,FEntityName,Ftype,FIsShow from t_api_erp_kdc "
        sql_where = " where FOwnerName ='"+self.FOwnerName+"' and FFormId ='"+self.FFormId+"' and FActionName ='"+self.FActionName+"' and FIsShow =1 and Ftype ='head' and FEntityName =''"
        sql_all = sql_head + sql_where
        data_meta = self.app.select(sql_all)
    def billHeadGetData(self,FBillNo='so-api-002'):
        ...
        '''
        pass
    def billHeadSetValue(self,FBillNo='so-api-002'):
        '''
    ...
    def billEntryGetData(self,FBillNo='so-api-002'):
        ...
        '''
        pass
    def billEntrySetValue(self,FBillNo='so-api-002'):
        '''
        ...
        '''
        pass
    def billEntryUnitGetMeta(self,FBillNo='so-api-002'):
        '''
        ...
        '''
        pass
    def billEntryUnitGetData(self,FBillNo='so-api-002'):
        '''
        ...
        '''
        pass
    def billEntryUnitSetValue(self,FBillNo='so-api-002'):
        '''
    ...
    def billEntryListGetData(self,FBillNo='so-api-002'):
        ...
        '''
        pass
    def billEntryListSetValue(self,FBillNo='so-api-002'):
        '''
    ...
    def dataGen(self,FBillNo='so-api-002'):
        ...
        self.FBillNo = FBillNo
        #prepare data
        #this is assume that we get data from view
        sql_head_meta = "select  FTableName ,FTableFieldName,FAccessToken,FMainKey from t_api_erp_kdc "
        sql_where_meta = " where FOwnerName ='" + self.FOwnerName + "' and FFormId ='" + self.FFormId + "' and FActionName ='" + self.FActionName + "' and FIsShow =1 and Ftype <>'entryList'"

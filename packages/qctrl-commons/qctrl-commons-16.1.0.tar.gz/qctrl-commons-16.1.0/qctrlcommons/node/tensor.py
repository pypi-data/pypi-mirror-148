...
class PauliKroneckerProduct(Node):
    ...
    labels : list[tuple[str, int]]
        ...
        The Pauli matrix label is a string ``'I'``, ``'X'``, ``'Y'``, or ``'Z'``
    ...
    def create_node_data(cls, _operation, **kwargs):
        ...
        for i, label in enumerate(labels):
            ...
            check_argument(
                isinstance(matrix, str) and matrix in ["I", "X", "Y", "Z"],
                "Pauli matrix label must be a string and one of 'I', 'X', 'Y', or 'Z'.",
                {"labels": labels},

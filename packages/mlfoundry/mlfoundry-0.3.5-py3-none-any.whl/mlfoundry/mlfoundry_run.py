...
class MlFoundryRun:
    ...
    def __init__(
        self, experiment_id: str, run_id: str, log_system_metrics: bool = True
    ):
    ...
    def log_model(self, model, framework: Union[enums.ModelFramework, str]):
        ...
        """
        framework = enums.ModelFramework(framework)

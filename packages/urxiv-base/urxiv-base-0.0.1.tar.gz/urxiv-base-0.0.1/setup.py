...
setup(
    name='urxiv-base',
    version=find_version('urxiv', 'base', 'version.py'),
    packages=[f'urxiv.{package}' for package
              in find_packages('urxiv', exclude=['*test*'])],
    author = "Ivan Antonov",
    author_email = "ivan.vanya.antonov.24@gmail.com",
    url =" https://github.com/Ivan-Antonov/urxiv-base",
    zip_safe=False,
    install_requires=[
        'flask',
        'jsonschema',

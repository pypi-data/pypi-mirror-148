...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ja', 'vi', 'zh', 'war', 'ar', 'uk', 'pt', 'fa', 'ca', 'sr', 'id',
        ...
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'avk', 'mn',
        'nv', 'xmf', 'crh', 'si', 'lld', 'bat-smg', 'or', 'gd', 'frr', 'os',
        'cdo', 'yi', 'ilo', 'sd', 'bug', 'ha', 'am', 'nap', 'sah', 'ps', 'hsb',
        'map-bms', 'fo', 'mai', 'li', 'mzn', 'ban', 'eml', 'gor', 'ace', 'bcl',
        'sa', 'wa', 'zh-classical', 'lij', 'shn', 'zu', 'mrj', 'mhr', 'as',
        'hif', 'mni', 'hyw', 'hak', 'roa-tara', 'km', 'pam', 'ie', 'nso',
        'rue', 'so', 'sn', 'bh', 'se', 'vls', 'nds-nl', 'myv', 'mi', 'nah',
        'sc', 'sat', 'vep', 'gan', 'kab', 'glk', 'tk', 'fiu-vro', 'co', 'bo',
        'ab', 'frp', 'kv', 'csb', 'pcd', 'kw', 'gv', 'ug', 'ary', 'udm', 'ay',
        'skr', 'nrm', 'zea', 'gn', 'mt', 'bjn', 'lez', 'smn', 'lfn', 'stq',
        'ig', 'lo', 'mwl', 'olo', 'rm', 'fur', 'lad', 'ang', 'gom', 'koi',
        'ext', 'tyv', 'dsb', 'dty', 'ln', 'cbk-zam', 'rw', 'dv', 'ksh', 'gag',
        'bxr', 'av', 'pfl', 'pag', 'pi', 'haw', 'awa', 'tay', 'pap', 'krc',
        'xal', 'szy', 'inh', 'za', 'kaa', 'pdc', 'atj', 'tw', 'to', 'tum',
        'arc', 'dag', 'tpi', 'kbp', 'jam', 'na', 'mdf', 'wo', 'kbd', 'tcy',
        'nov', 'nia', 'ki', 'tet', 'lg', 'bi', 'jbo', 'roa-rup', 'fj', 'kg',
        'lbe', 'xh', 'nqo', 'ty', 'mnw', 'ks', 'cu', 'shi', 'trv', 'srn', 'om',
        'sm', 'gcr', 'alt', 'chr', 'ltg', 'pih', 'ny', 'got', 'mad', 'st',
        'ami', 'rmy', 'guw', 'tn', 'bm', 'ts', 'chy', 've', 'rn', 'iu', 'ak',
        'ss', 'ch', 'pnt', 'ady', 'ik', 'ff', 'ee', 'din', 'sg', 'kl', 'pwn',
        'ti', 'dz', 'cr',
    ]

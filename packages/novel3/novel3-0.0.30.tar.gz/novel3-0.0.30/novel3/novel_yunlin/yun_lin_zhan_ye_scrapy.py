...
class YuLinZhanYeScrapy:
    ...
    def __init__(self, db="sqlite") -> None:
        ...
        self.DEFAULT_REQUEST_HEADERS = {
            ...
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Android AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.51 Safari/537.36 Edg/99.0.1150.39',
    ...
    def visit_chapter(self, book_name, chapter_name, chapter_link, first=True) -> str:
        ...
        content = str()
        for each in tree.xpath('//div[@class="neirong"]'):
        ...
        if first:
            ...
            contents = zhconv.convert(contents, 'zh-hans')
            print(contents)
...
if __name__ == "__main__":
    ...
    html = spider.visit_chapter("test", "test", "http://www.dybz.fans/21/21881/701785.html")
    print(html)

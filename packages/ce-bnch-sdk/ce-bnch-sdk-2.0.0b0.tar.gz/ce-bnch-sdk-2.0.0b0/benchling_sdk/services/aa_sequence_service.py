...
from benchling_api_client.v2.alpha.api.aa_sequences import bulk_upsert_aa_sequences, upsert_aa_sequence
from benchling_api_client.v2.alpha.models.aa_sequence_upsert import AaSequenceUpsert
from benchling_api_client.v2.alpha.models.aa_sequences_bulk_upsert_request import AaSequencesBulkUpsertRequest
...
class AaSequenceService(BaseService):
    ...
    def upsert(self, entity_registry_id: str, aa_sequence: AaSequenceUpsert) -> AaSequence:
        ...
        response = upsert_aa_sequence.sync_detailed(
            client=alpha_client, entity_registry_id=entity_registry_id, json_body=aa_sequence
        )
        return model_from_detailed(response)
    ...
    def bulk_upsert(self, body: AaSequencesBulkUpsertRequest) -> AsyncTaskLink:
        ...
        """
        alpha_client = v2_alpha_client(self.client)
        response = bulk_upsert_aa_sequences.sync_detailed(client=alpha_client, json_body=body)
        return model_from_detailed(response)

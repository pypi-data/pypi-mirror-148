...
class WebRunner(object):
    ...
    def find_element(self, selector, by=None):
        ...
        try:
            if by == 'id':
                elem = self.browser.find_element_by_id(selector)
            elif by == 'xpath':
                elem = self.browser.find_element_by_xpath(selector)
            elif by == 'classname':
                elem = self.browser.find_element_by_class_name(selector)
            else:
    ...
    def find_elements(self, selector, by=None):
        ...
        try:
            if by == 'id':
                elem = self.find_elements_by_id(selector)
            elif by == 'xpath':
                elem = self.browser.find_elements_by_xpath(selector)
            else:
                if selector.startswith('/'):
                    elem = self.browser.find_elements_by_xpath(selector)
                else:
                    elem = self.browser.find_elements_by_css_selector(selector)
        except NoSuchElementException:
            pass

...
def get_version(rel_path):
    """Function to read the __version__ from a file.
...
setup(
    ...
    version=get_version("AirtablePy/__init__.py"),  # Required
    ...
    # TODO: Once the readme is created we could import it into the long_description.

...
class Makana():
    ...
    def InitializeCondaDependencies(channels: list=None, pipPackages: list=None , condaPackages: list=None):
    ...
    def CreatePythonScriptStep(source_directory: str, name: str, script_name: str, arguments: list, inputs: list, outputs: list,
    ...
    def SubmitPipeline(pythonScriptSteps: list , ws: Workspace):

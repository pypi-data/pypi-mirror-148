...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_path_label = QLabel('Data base file: ', self)
        ...
        self.db_file_label = QLabel('File name of data base: ', self)
        ...
        self.port_label = QLabel('Port to connection:', self)
        ...
        self.ip_label = QLabel('Ip address to be connected:', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        self.ip_label_note = QLabel(
            'The field may be clear to connection to any address.',
            self)
    ...
    def save_server_config(self):
        ...
        if everything is correct saves the ini file.
        """
        ...
        try:
            ...
            message.warning(self, 'Error', 'Port mast be number')
        else:
            ...
            if 1023 < port < 65536:
                ...
                message.warning(
                    self, 'Error', 'Port mast be from 1024 to 65536')

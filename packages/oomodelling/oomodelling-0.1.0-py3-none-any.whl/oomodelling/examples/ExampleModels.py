...
class MassSpringDamperRefinement(MassSpringDamperFlat):
    """
    This example highlights a refinement operation
    """
    ...
    def __init__(self):
        ...
        self.alpha = self.parameter(0.5)

        self.spring = self.ovar(lambda: self.k * self.x() + self.alpha * (self.x()**3))

...
class Dataset(Connection):
    ...
    def dw_sync(self) -> str:
        ...
        return Update().dataset_schema(self.id)
    ...
    def _get_cte_for_dataset(self) -> str:
        """
        Validate that the dataset is published, and then get a CTE that would build it
        """
        ...
        return (
            dbt.operations_as_cte(self._api_operation_set.operations)

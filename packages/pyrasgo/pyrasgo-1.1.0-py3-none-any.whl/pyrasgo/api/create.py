...
class Create:
    ...
    def accelerator(
        self,
        *,
        accelerator_create: schemas.AcceleratorCreate,
    ) -> schemas.Accelerator:
        """
    ...
    def dataset_from_accelerator(
        ...
        apply_request = schemas.AcceleratorApply(
            name=name,
            arguments=arguments,
        )
        resp = self.api._post(
            f"/accelerators/{id}/apply",
    ...
    def _dataset_correlation_stats(
        self,
        *,
        table_id: int,
        only_if_data_changed: Optional[bool] = True,
    ) -> None:
        """

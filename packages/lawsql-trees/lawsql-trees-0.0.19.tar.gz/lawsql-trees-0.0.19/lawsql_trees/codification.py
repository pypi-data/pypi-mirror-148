...
class CodificationItem:
    ...
    def __post_init__(self):
        ...
        self.publication_date: date = arrow.get(
            self.data["date"], "MMMM D, YYYY"
        ).date()
    ...
    def citations_from_histories(self) -> set[str] | NoReturn:
        ...
        return set(fetch_values_from_key(self.data, "citation"))
...
def get_author_codification_folder(
    ...
    base = os.getenv("CODIFICATIONS")
    author_dir = f"{base}/{author}"
    folder = Path.home().joinpath(author_dir)
